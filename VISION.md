...
Recall is the AI that actually does things.
...
Recall started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> Recall.
...
Security in Recall is a deliberate tradeoff: strong defaults without killing capability.
...
Recall has an extensive plugin API.
...
- Code plugins run Recall plugin code and are appropriate for deeper runtime extension.
...
Recall docs should document core extension points; plugin promotion belongs in ClawHub, preferably under vetted org publishers for official plugins.
...
Recall supports MCP as both a server and a runtime integration surface.
...
Recall is currently terminal-first by design.
...
Recall is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep Recall hackable by default.
