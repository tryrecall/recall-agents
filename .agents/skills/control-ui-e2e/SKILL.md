---
name: control-ui-e2e
description: Use when testing, fixing, or extending the SteelEngine Control UI GUI with Vitest + Playwright end-to-end checks, mocked Gateway WebSocket flows, mocked dashboard runs, screenshots/videos, or agent-verifiable browser proof.
---
