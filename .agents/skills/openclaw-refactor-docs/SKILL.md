---
name: recall-refactor-docs
description: Refactor an existing Recall docs page with source-audited preservation, restructuring, and verification.
---

# Recall Refactor Docs

## Overview

Use this skill when the user gives a target Recall docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `recall-docs`: use that skill for style, page types,
...
Read `../recall-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `recall-docs`.
