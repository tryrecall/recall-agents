...
- For SteelEngine docs work, choose a page type from `references/steelengine.md` before drafting.
- Keep task-critical SteelEngine configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For SteelEngine docs work, apply the validation checklist in `references/steelengine.md`.
