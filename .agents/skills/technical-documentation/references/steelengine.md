# SteelEngine Documentation Overlay

Use this reference only for SteelEngine docs work. It layers SteelEngine-specific page
...
- Topic page: explain a major SteelEngine entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current SteelEngine repo behavior.
