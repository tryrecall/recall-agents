...
- For SteelEngine docs reviews, apply `references/steelengine.md` for page type, docs IA, preservation, examples, and validation checks.
...
- For SteelEngine docs, check `docs/docs.json`, docs-list routing hints, main path versus `Reference` placement, and generated-reference visibility.
- For SteelEngine rewrites or page splits, require source-backed keep/drop/move/destination coverage for important claims, warnings, examples, commands, fields, and troubleshooting facts.
...
- For SteelEngine docs, confirm the content matches an explicit page type from `references/steelengine.md`.
