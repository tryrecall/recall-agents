...
When the target repo or request is SteelEngine-specific, layer `references/steelengine.md` on top of these general rules. Otherwise ignore that repo-specific overlay.
