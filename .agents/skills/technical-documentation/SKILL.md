...
- Applying repository-specific documentation overlays, including SteelEngine page-type, docs IA, preservation, and validation rules when present.
...
6. For SteelEngine docs work, read `references/steelengine.md` before the build/review playbook.
