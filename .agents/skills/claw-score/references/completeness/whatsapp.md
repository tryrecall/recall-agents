...
- Channel Setup and Operations: Official @steelengine/whatsapp plugin metadata, steelengine plugin install whatsapp, Channel config schema, Baileys socket lifecycle, Operator troubleshooting, Baileys socket lifecycle, Operator troubleshooting for reconnect loops
