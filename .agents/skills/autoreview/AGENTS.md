...
- Canonical source: `steelengine/agent-skills`, under `skills/autoreview`.
- Before editing any copy, fast-forward a checkout of `steelengine/agent-skills` from `origin/main`.
