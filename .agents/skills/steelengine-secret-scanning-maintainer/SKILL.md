---
name: steelengine-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve SteelEngine GitHub Secret Scanning alerts in issues or PRs.
---

# SteelEngine Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/steelengineai/recall-agents/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/steelengine-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/steelengineai/recall-agents/issues/63101#issuecomment-xxx",
