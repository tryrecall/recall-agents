...
metadata:
  steelengine:
    homepage: https://github.com/steelengine/discrawl
    requires:
      bins:
        - discrawl
    install:
      - kind: go
        module: github.com/steelengine/discrawl/cmd/discrawl@latest
        bins:
          - discrawl
---
...
- Repo: `steelengine/discrawl`; use `~/GIT/_Perso/discrawl` only after verifying
  its remote targets `steelengine/discrawl`, otherwise use a fresh checkout
...
`steelengine/discrawl` checkout before concluding the feature is missing.
...
This reader imports `https://github.com/steelengine/discord-store.git` into
