---
name: steelengine-refactor-docs
description: Refactor an existing SteelEngine docs page with source-audited preservation, restructuring, and verification.
---

# SteelEngine Refactor Docs

## Overview

Use this skill when the user gives a target SteelEngine docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `steelengine-docs`: use that skill for style, page types,
...
Read `../steelengine-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `steelengine-docs`.
