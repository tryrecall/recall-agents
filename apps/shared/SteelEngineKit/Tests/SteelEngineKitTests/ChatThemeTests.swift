...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SteelEngineChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SteelEngineChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
