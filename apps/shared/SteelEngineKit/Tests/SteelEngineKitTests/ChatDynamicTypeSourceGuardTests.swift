...
struct ChatDynamicTypeSourceGuardTests {
        ...
        composer: String)
    {
        ...
        return try (
            messageViews: String(
                contentsOf: root.appendingPathComponent("Sources/SteelEngineChatUI/ChatMessageViews.swift"),
                encoding: .utf8),
            chatView: String(
                contentsOf: root.appendingPathComponent("Sources/SteelEngineChatUI/ChatView.swift"),
                encoding: .utf8),
            composer: String(
                contentsOf: root.appendingPathComponent("Sources/SteelEngineChatUI/ChatComposer.swift"),
                encoding: .utf8))
    }
}
