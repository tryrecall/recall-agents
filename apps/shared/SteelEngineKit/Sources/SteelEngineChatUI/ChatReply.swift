...
public struct SteelEngineChatReplyTarget: Equatable, Sendable {
...
enum ChatReplyQuote {
    ...
    static func prepend(message: String, replyTarget: SteelEngineChatReplyTarget) -> String {
...
extension SteelEngineChatViewModel {
    ...
    func setReplyTarget(messageID: UUID, text: String, senderLabel: String) {
        ...
        self.replyTarget = SteelEngineChatReplyTarget(
            messageID: messageID,
            text: text,
    ...
    func consumeReplyTarget(_ target: SteelEngineChatReplyTarget?) {
