...
public enum SteelEngineChatTransportEvent: Sendable {
    case health(ok: Bool)
    case tick
    case sessionsChanged(SteelEngineChatSessionsChangedEvent)
    case chat(SteelEngineChatEventPayload)
    case sessionMessage(SteelEngineSessionMessageEventPayload)
    case agent(SteelEngineAgentEventPayload)
    case questionRequested(QuestionRecord)
    case questionResolved(SteelEngineQuestionResolvedEvent)
    case seqGap
}

public struct SteelEngineQuestionResolvedEvent: Codable, Sendable {
...
public struct SteelEngineChatSessionsChangedEvent: Codable, Sendable, Equatable {
...
public struct SteelEngineChatTransportRouteLease: Sendable {
    public typealias SendMessage = @Sendable (
        _ sessionKey: String,
        _ message: String,
        _ thinking: String,
        _ idempotencyKey: String,
        _ attachments: [SteelEngineChatAttachmentPayload]) async throws -> SteelEngineChatSendResponse
    public typealias RequestHistory = @Sendable (String) async throws -> SteelEngineChatHistoryPayload
    ...
    public typealias RequestTargetedHistory = @Sendable (
        _ sessionKey: String,
        _ agentID: String?) async throws -> SteelEngineChatHistoryPayload
    ...
    public func requestHistory(
        sessionKey: String,
        agentID: String? = nil) async throws -> SteelEngineChatHistoryPayload
    {
        try await self.requestTargetedHistoryImpl(sessionKey, agentID)
    }
}

public enum SteelEngineChatTransportRouteLeaseResult: Sendable {
    case available(SteelEngineChatTransportRouteLease)
...
public struct SteelEngineChatSessionSettingsRouteLease: Sendable {
    public typealias PatchSessionSettings = @Sendable (
        _ sessionKey: String,
        _ agentID: String?,
        _ patch: SteelEngineChatSessionSettingsPatch) async throws -> SteelEngineChatModelPatchResult?
...
public struct SteelEngineChatSessionMutationRouteLease: Sendable {
...
public enum SteelEngineChatTransportSendError: Error, Sendable {
    case notDispatched
}

public enum SteelEngineChatTransportUpgradeMessage {
...
public enum SteelEngineChatRunTerminalState: Sendable, Equatable {
    case completed
    case failed(message: String)
}

public enum SteelEngineChatRunObservation: Sendable, Equatable {
    case terminal(SteelEngineChatRunTerminalState)
    case checkAgain
    case unavailable
...
public protocol SteelEngineChatTransport: Sendable {
    func createSession(
        key: String,
        label: String?,
    ...
    func waitForRunCompletion(runId: String, timeoutMs: Int) async -> SteelEngineChatRunObservation
...
extension SteelEngineChatTransport {
    ...
    public func requestFullMessage(sessionKey _: String, messageID _: String) async throws -> SteelEngineChatMessage? {
        nil
    }
        ...
        replacing failedResource: SteelEngineChatWidgetResource?) async -> SteelEngineChatWidgetResource?
    {
        ...
        return SteelEngineChatWidgetResource(url: url)
    }
    ...
    public func acquireOutboxRouteLease() async -> SteelEngineChatTransportRouteLeaseResult {
        let transport = self
    ...
    public func acquireSessionSettingsRouteLease() async -> SteelEngineChatSessionSettingsRouteLease? {
        let transport = self
    ...
    public func acquireSessionMutationRouteLease() async -> SteelEngineChatSessionMutationRouteLease? {
        let transport = self
    ...
    public func waitForRunCompletion(runId _: String, timeoutMs _: Int) async -> SteelEngineChatRunObservation {
        .unavailable
    }
    ...
    public func listSessions(limit: Int?) async throws -> SteelEngineChatSessionsListResponse {
        try await self.listSessions(limit: limit, search: nil, archived: false)
    }

    public func listSessions(limit: Int?, archived: Bool) async throws -> SteelEngineChatSessionsListResponse {
    ...
    public func listModels() async throws -> [SteelEngineChatModelChoice] {
        throw NSError(
            domain: "SteelEngineChatTransport",
            code: 0,
    ...
    public func listCommands(sessionKey _: String) async throws -> [SteelEngineChatCommandChoice] {
        []
    }
...
public enum SteelEngineChatSessionRoutingContract {
