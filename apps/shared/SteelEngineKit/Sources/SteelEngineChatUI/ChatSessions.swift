...
public struct SteelEngineChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public enum SteelEngineChatFastMode: Sendable, Equatable, Hashable, Codable {
    case off
    case on
    case automatic
...
public struct SteelEngineChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct SteelEngineChatSessionSettingsPatch: Sendable, Equatable {
    /// Outer optional means unchanged; inner optional clears the override.
    public let model: String??
    public let thinkingLevel: String??
    public let fastMode: SteelEngineChatFastMode??
...
public struct SteelEngineChatModelPatchResult: Decodable, Sendable, Equatable {
    public let key: String?
    public let modelProvider: String?
    public let model: String?
    public let thinkingLevel: String?
    public let thinkingLevels: [SteelEngineChatThinkingLevelOption]?
    public let fastMode: SteelEngineChatFastMode?
    public let effectiveFastMode: SteelEngineChatFastMode?
    public let verboseLevel: String?
    ...
    public init(from decoder: Decoder) throws {
        ...
        let entryFastMode = try entry.decodeIfPresent(SteelEngineChatFastMode.self, forKey: .fastMode)
        let entryEffectiveFastMode = try entry.decodeIfPresent(
            SteelEngineChatFastMode.self,
        ...
        if container.contains(.resolved) {
            ...
            self.thinkingLevels = try resolved.decodeIfPresent(
                [SteelEngineChatThinkingLevelOption].self,
                forKey: .thinkingLevels)
            self.fastMode = try resolved.decodeIfPresent(SteelEngineChatFastMode.self, forKey: .fastMode)
                ?? entryFastMode
...
public struct SteelEngineChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
...
public struct SteelEngineChatSessionWorktree: Codable, Sendable, Hashable {
    public let id: String?
    public let branch: String?
    public let repoRoot: String?
}

public struct SteelEngineChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
    ...
    public var worktree: SteelEngineChatSessionWorktree?

    public var systemSent: Bool?
    public var abortedLastRun: Bool?
    public var thinkingLevel: String?
    public var verboseLevel: String?
    public var fastMode: SteelEngineChatFastMode?
    public var effectiveFastMode: SteelEngineChatFastMode?
    ...
    public var thinkingLevels: [SteelEngineChatThinkingLevelOption]?
    ...
    public init(
        ...
        worktree: SteelEngineChatSessionWorktree? = nil,
        fastMode: SteelEngineChatFastMode? = nil,
        effectiveFastMode: SteelEngineChatFastMode? = nil)
    {
        self.key = key
...
public enum SteelEngineChatSessionListOrganizer {
    public static func organize(_ sessions: [SteelEngineChatSessionEntry]) -> [SteelEngineChatSessionEntry] {
    ...
    public static func filter(
        _ sessions: [SteelEngineChatSessionEntry],
        search: String) -> [SteelEngineChatSessionEntry]
    {
...
public struct SteelEngineChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: SteelEngineChatSessionsDefaults?
    public let sessions: [SteelEngineChatSessionEntry]
