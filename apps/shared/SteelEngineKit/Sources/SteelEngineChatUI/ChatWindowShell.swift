...
/// panel keeps using `SteelEngineChatView` directly; this shell is the full
/// window experience.
@MainActor
public struct SteelEngineChatWindowShell: View {
    public nonisolated static let assistantTraceDefaultsKey = "steelengine.webchat.showAssistantTrace"
    public nonisolated static let assistantReasoningDefaultsKey = "steelengine.webchat.showAssistantReasoning"
    public nonisolated static let assistantToolActivityDefaultsKey = "steelengine.webchat.showAssistantToolActivity"
    ...
    private let emptyAssistantPrompts: [SteelEngineChatView.StarterPrompt]
    ...
    public init(
        ...
        emptyAssistantPrompts: [SteelEngineChatView.StarterPrompt] = [],
    ...
    private var activeSessionEntry: SteelEngineChatSessionEntry? {
...
private struct ChatContextUsageMenu: View {
    let usage: SteelEngineChatContextUsage
    let onCompact: () -> Void

    var body: some View {
        Menu {
            Text(self.tokensLine)
                .font(SteelEngineChatTypography.body(size: 13, weight: .regular, relativeTo: .body))
