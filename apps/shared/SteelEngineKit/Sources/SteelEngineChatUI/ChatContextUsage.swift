...
public struct SteelEngineChatContextUsage: Equatable, Sendable {
...
enum ChatContextUsageCalculator {
    ...
    static func usage(
        ...
        sessionEntry: SteelEngineChatSessionEntry?,
        defaults: SteelEngineChatSessionsDefaults?,
        modelContextWindow: Int?) -> SteelEngineChatContextUsage?
    {
        ...
        return SteelEngineChatContextUsage(
    ...
    private static func latestRunTokens(in messages: [SteelEngineChatMessage]) -> Int? {
    ...
    private static func totalCost(in messages: [SteelEngineChatMessage]) -> Double? {
...
extension SteelEngineChatViewModel {
    public var contextUsage: SteelEngineChatContextUsage? {
    ...
    private func selectedModelContextWindow(sessionEntry: SteelEngineChatSessionEntry?) -> Int? {
