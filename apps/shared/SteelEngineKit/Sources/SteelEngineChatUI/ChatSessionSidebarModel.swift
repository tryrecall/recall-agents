...
enum ChatSessionSidebarModel {
    ...
    struct Section: Identifiable, Equatable {
        ...
        var sessions: [SteelEngineChatSessionEntry] {
    ...
    static func tree(from sessions: [SteelEngineChatSessionEntry]) -> [Node] {
        ...
        var entriesByKey: [String: SteelEngineChatSessionEntry] = [:]
        ...
        var childrenByParent: [String: [SteelEngineChatSessionEntry]] = [:]
        for session in sessions {
        ...
        func build(_ session: SteelEngineChatSessionEntry, ancestors: Set<String>) -> Node {
    ...
    private static func node(session: SteelEngineChatSessionEntry, children: [Node]) -> Node {
    ...
    static func displayName(for session: SteelEngineChatSessionEntry) -> String {
    ...
    private static func visibleSessions(
        ...
        query: String) -> [SteelEngineChatSessionEntry]
    {
    ...
    private static func placeholder(key: String) -> SteelEngineChatSessionEntry {
