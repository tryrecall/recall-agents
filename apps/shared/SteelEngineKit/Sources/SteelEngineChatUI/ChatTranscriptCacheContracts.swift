...
public protocol SteelEngineChatTranscriptCache: Sendable {
    func loadSessions() async -> [SteelEngineChatSessionEntry]
    func loadTranscript(sessionKey: String) async -> [SteelEngineChatMessage]
    func loadTranscript(sessionKey: String, agentID: String?) async -> [SteelEngineChatMessage]
    func storeSessions(_ sessions: [SteelEngineChatSessionEntry]) async
    func storeTranscript(sessionKey: String, messages: [SteelEngineChatMessage]) async
    func storeTranscript(sessionKey: String, agentID: String?, messages: [SteelEngineChatMessage]) async
...
extension SteelEngineChatTranscriptCache {
...
protocol SteelEngineChatCanonicalTranscriptMerging: SteelEngineChatTranscriptCache {
...
public struct SteelEngineChatOutboxAttachment: Codable, Hashable, Sendable {
...
public struct SteelEngineChatOutboxCommand: Hashable, Sendable, Identifiable {
    ...
    public let attachments: [SteelEngineChatOutboxAttachment]
...
public enum SteelEngineChatOutboxUpdateResult: Equatable, Sendable {
    case updated
    case confirmed
    case missing
    case unavailable
...
public enum SteelEngineChatOutboxChange: Equatable, Sendable {
...
public protocol SteelEngineChatCommandOutbox: Sendable {
    ...
    func changes() -> AsyncStream<SteelEngineChatOutboxChange>
}

public struct SteelEngineChatSessionRoutingIdentity: Equatable, Sendable {
    ...
    public init?(contract: String?) {
        guard let components = SteelEngineChatSessionRoutingContract.parse(contract) else { return nil }
    ...
    public init?(scope: String?, mainSessionKey: String?, defaultAgentID: String?) {
        guard let contract = SteelEngineChatSessionRoutingContract.make(
            scope: scope,
