...
public enum ChatTranscriptExporter {
    ...
    public static func markdown(
        sessionTitle: String?,
        sessionKey: String,
        messages: [SteelEngineChatMessage]) -> String
    {
    ...
    private static func shouldExport(_ message: SteelEngineChatMessage) -> Bool {
    ...
    private static func body(for message: SteelEngineChatMessage) -> String {
        var parts: [String] = []
        let text = self.visibleText(in: message)
        if !text.isEmpty {
            parts.append(text)
    ...
    private static func visibleText(in message: SteelEngineChatMessage) -> String {
        ChatMessageVisibleText.visibleText(in: message)
    }

    private static func attachments(in message: SteelEngineChatMessage) -> [SteelEngineChatMessageContent] {
