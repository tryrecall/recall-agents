...
public struct ArtifactBuildInfo: Equatable, Sendable {
        ...
        versionKeys: [String] = ["CFBundleShortVersionString"])
    {
        ...
        self.gitCommit = Self.validGitCommit(Self.nonEmptyString(infoDictionary["SteelEngineGitCommit"]))
        let buildTimestamp = Self.nonEmptyString(infoDictionary["SteelEngineBuildTimestamp"])
