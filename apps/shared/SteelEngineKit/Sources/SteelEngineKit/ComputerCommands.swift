...
public enum SteelEngineComputerCommand: String, Codable, Sendable {
...
public enum SteelEngineComputerAction: String, Codable, Sendable {
...
public enum SteelEngineComputerScrollDirection: String, Codable, Sendable {
    case up
    case down
    case left
    case right
...
public struct SteelEngineComputerActParams: Codable, Sendable, Equatable {
    public var action: SteelEngineComputerAction
    ...
    public var scrollDirection: SteelEngineComputerScrollDirection?
    ...
    public init(
        ...
        scrollDirection: SteelEngineComputerScrollDirection? = nil,
...
public struct SteelEngineComputerActResult: Codable, Sendable, Equatable {
    public var ok: Bool
