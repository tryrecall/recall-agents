...
public enum SteelEngineWatchCommand: String, Codable, Sendable {
    case status = "watch.status"
    case notify = "watch.notify"
}

public enum SteelEngineWatchPayloadType: String, Codable, Sendable, Equatable {
    case notify = "watch.notify"
...
public enum SteelEngineWatchRisk: String, Codable, Sendable, Equatable {
    case low
    case medium
    case high
}

public enum SteelEngineWatchExecApprovalDecision: String, Codable, Sendable, Equatable {
    case allowOnce = "allow-once"
    case deny
}

public enum SteelEngineWatchExecApprovalCloseReason: String, Codable, Sendable, Equatable {
    case expired
...
public struct SteelEngineWatchAction: Codable, Sendable, Equatable, Identifiable {
...
public struct SteelEngineWatchExecApprovalItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
    ...
    public var allowedDecisions: [SteelEngineWatchExecApprovalDecision]
    public var risk: SteelEngineWatchRisk?
    ...
    public init(
        ...
        allowedDecisions: [SteelEngineWatchExecApprovalDecision] = [],
        risk: SteelEngineWatchRisk? = nil)
    {
        self.id = id
...
public struct SteelEngineWatchExecApprovalPromptMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
    public var approval: SteelEngineWatchExecApprovalItem
    public var sentAtMs: Int64?
    public var resetResolutionAttemptId: String?

    public init(
        approval: SteelEngineWatchExecApprovalItem,
        sentAtMs: Int64? = nil,
...
public struct SteelEngineWatchExecApprovalResolveMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: SteelEngineWatchExecApprovalDecision
...
public enum SteelEngineWatchExecApprovalOutcome: String, Codable, Sendable, Equatable {
    case allowedOnce
    case allowedAlways
    case denied
}

public struct SteelEngineWatchExecApprovalResolvedMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: SteelEngineWatchExecApprovalDecision?
    public var outcome: SteelEngineWatchExecApprovalOutcome?
    ...
    public init(
        approvalId: String,
        gatewayStableID: String? = nil,
        decision: SteelEngineWatchExecApprovalDecision? = nil,
        outcome: SteelEngineWatchExecApprovalOutcome? = nil,
...
public struct SteelEngineWatchExecApprovalExpiredMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var reason: SteelEngineWatchExecApprovalCloseReason
...
public struct SteelEngineWatchExecApprovalSnapshotMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
    public var approvals: [SteelEngineWatchExecApprovalItem]
    public var gatewayStableID: String?
    public var sentAtMs: Int64?
    ...
    public init(
        approvals: [SteelEngineWatchExecApprovalItem],
        gatewayStableID: String? = nil,
        sentAtMs: Int64? = nil,
...
public struct SteelEngineWatchExecApprovalSnapshotRequestItem: Codable, Sendable, Equatable {
    public var approvalId: String
...
public struct SteelEngineWatchExecApprovalSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
    public var gatewayStableID: String?
    public var heldApprovals: [SteelEngineWatchExecApprovalSnapshotRequestItem]

    public init(
        requestId: String,
        sentAtMs: Int64? = nil,
        gatewayStableID: String? = nil,
        heldApprovals: [SteelEngineWatchExecApprovalSnapshotRequestItem] = [])
    {
...
public struct SteelEngineWatchChatItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
...
public struct SteelEngineWatchChatCompletionMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
...
public enum SteelEngineWatchAppStatusCode: String, Codable, Sendable, Equatable {
...
public struct SteelEngineWatchAppStatus: Codable, Sendable, Equatable {
    public var code: SteelEngineWatchAppStatusCode
    public var localizationKey: String?
    public var arguments: [String]
    public var verbatim: String?

    public init(
        code: SteelEngineWatchAppStatusCode,
...
public struct SteelEngineWatchAppSnapshotMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
    public var gatewayStatus: SteelEngineWatchAppStatus
    ...
    public var gatewayStableID: String?
    public var talkStatus: SteelEngineWatchAppStatus
    ...
    public var chatItems: [SteelEngineWatchChatItem]?
    public var chatStatus: SteelEngineWatchAppStatus?
    public var chatStatusText: String?
    public var sentAtMs: Int64?
    public var snapshotId: String?

    public init(
        gatewayStatus: SteelEngineWatchAppStatus,
        ...
        sessionKey: String,
        gatewayStableID: String? = nil,
        talkStatus: SteelEngineWatchAppStatus,
        talkStatusText: String,
        talkEnabled: Bool,
        talkListening: Bool,
        talkSpeaking: Bool,
        pendingApprovalCount: Int,
        chatItems: [SteelEngineWatchChatItem]? = nil,
        chatStatus: SteelEngineWatchAppStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(SteelEngineWatchPayloadType.self, forKey: .type)
        ...
        self.chatItems = try container.decodeIfPresent([SteelEngineWatchChatItem].self, forKey: .chatItems)
        ...
        if let gatewayStatus = try? container.decode(
            SteelEngineWatchAppStatus.self,
        ...
        {
            self.gatewayStatus = SteelEngineWatchAppStatus(
                code: .legacy,
        ...
        {
            self.talkStatus = SteelEngineWatchAppStatus(
                code: .legacy,
    ...
    private static func decodeLegacyGatewayStatus(
        text: String?,
        connected: Bool) -> SteelEngineWatchAppStatus
    {
        if connected {
        ...
        return SteelEngineWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    private static func decodeLegacyTalkStatus(
        ...
        enabled: Bool,
        listening: Bool,
        speaking: Bool) -> SteelEngineWatchAppStatus
    {
        if speaking {
        ...
        guard let text, !text.isEmpty else {
            return SteelEngineWatchAppStatus(code: .talkReady)
        }
        return SteelEngineWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    private static func decodeLegacyChatStatus(
        code: String?,
        text: String?) -> SteelEngineWatchAppStatus?
    {
        let statusCode: SteelEngineWatchAppStatusCode? = switch code {
        case "connectIPhone":
            SteelEngineWatchAppStatusCode.chatConnectIPhone
        case "noMessages":
            SteelEngineWatchAppStatusCode.chatNoMessages
        case "unavailable":
            SteelEngineWatchAppStatusCode.chatUnavailable
        default:
            nil
        }
        if let statusCode {
            return SteelEngineWatchAppStatus(code: statusCode)
        }
        guard let text, !text.isEmpty else { return nil }
        return SteelEngineWatchAppStatus(code: .legacy, verbatim: text)
    }

    private static func legacyText(for status: SteelEngineWatchAppStatus) -> String {
    ...
    private static func legacyGatewayText(for code: SteelEngineWatchAppStatusCode) -> String {
        switch code {
    ...
    private static func legacyTalkText(for code: SteelEngineWatchAppStatusCode) -> String {
        switch code {
        case .talkOff: "Off"
    ...
    private static func legacyChatText(for code: SteelEngineWatchAppStatusCode) -> String {
        switch code {
...
public struct SteelEngineWatchAppSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
...
public enum SteelEngineWatchAppCommand: String, Codable, Sendable, Equatable {
    case refresh
...
public struct SteelEngineWatchAppCommandMessage: Codable, Sendable, Equatable {
    public var type: SteelEngineWatchPayloadType
    public var command: SteelEngineWatchAppCommand
    public var commandId: String
    public var sessionKey: String?
    public var gatewayStableID: String?
    public var text: String?
    ...
    public init(
        command: SteelEngineWatchAppCommand,
        commandId: String,
...
public struct SteelEngineWatchStatusPayload: Codable, Sendable, Equatable {
...
public struct SteelEngineWatchNotifyParams: Codable, Sendable, Equatable {
    ...
    public var expiresAtMs: Int64?
    public var risk: SteelEngineWatchRisk?
    public var actions: [SteelEngineWatchAction]?
    ...
    public init(
        ...
        expiresAtMs: Int64? = nil,
        risk: SteelEngineWatchRisk? = nil,
        actions: [SteelEngineWatchAction]? = nil)
    {
        self.title = title
        self.body = body
...
public struct SteelEngineWatchNotifyPayload: Codable, Sendable, Equatable {
