...
public struct SkillStatusConfigCheck: Codable, Identifiable, Sendable {
    ...
    public let value: SteelEngineProtocol.AnyCodable?
    ...
    public init(path: String, value: SteelEngineProtocol.AnyCodable?, satisfied: Bool) {
        self.path = path
        self.value = value
...
public struct SkillUpdateResult: Codable, Sendable {
    public let ok: Bool
    public let skillKey: String
    public let config: [String: SteelEngineProtocol.AnyCodable]?
}
