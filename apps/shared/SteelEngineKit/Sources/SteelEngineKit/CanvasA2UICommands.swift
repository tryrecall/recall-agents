...
public enum SteelEngineCanvasA2UICommand: String, Codable, Sendable {
...
public struct SteelEngineCanvasA2UIPushParams: Codable, Sendable, Equatable {
    public var messages: [AnyCodable]
}

public struct SteelEngineCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
