...
public struct SteelEngineComputerDisplayGeometry: Sendable, Equatable {
...
public enum SteelEngineComputerInputGeometry {
    ...
    public static func displayFrameId(
        ...
        sourceHeight: Double,
        referenceWidth: Int,
        display: SteelEngineComputerDisplayGeometry) -> String
    {
        let descriptor = [
            String(displayID),
    ...
    public static func isValidMappingGeometry(
        sourceWidth: Double,
        sourceHeight: Double,
        display: SteelEngineComputerDisplayGeometry) -> Bool
    {
    ...
    public static func mapReferencePointToGlobal(
        ...
        display: SteelEngineComputerDisplayGeometry) -> (x: Double, y: Double)
    {
