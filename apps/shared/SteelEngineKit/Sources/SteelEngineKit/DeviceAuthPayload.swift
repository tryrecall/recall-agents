...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int64,
        nonce: String) -> [String: SteelEngineProtocol.AnyCodable]?
    {
        ...
        return [
            "id": SteelEngineProtocol.AnyCodable(identity.deviceId),
            "publicKey": SteelEngineProtocol.AnyCodable(publicKey),
            "signature": SteelEngineProtocol.AnyCodable(signature),
            "signedAt": SteelEngineProtocol.AnyCodable(signedAtMs),
            "nonce": SteelEngineProtocol.AnyCodable(nonce),
        ]
    }
}
