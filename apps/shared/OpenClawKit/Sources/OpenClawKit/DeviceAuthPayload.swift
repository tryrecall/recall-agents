...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: RecallProtocol.AnyCodable]?
    {
        ...
        return [
            "id": RecallProtocol.AnyCodable(identity.deviceId),
            "publicKey": RecallProtocol.AnyCodable(publicKey),
            "signature": RecallProtocol.AnyCodable(signature),
            "signedAt": RecallProtocol.AnyCodable(signedAtMs),
            "nonce": RecallProtocol.AnyCodable(nonce),
        ]
    }
}
