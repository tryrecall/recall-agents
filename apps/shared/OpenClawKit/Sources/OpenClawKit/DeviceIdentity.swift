...
enum DeviceIdentityPaths {
    private static let stateDirEnv = ["RECALL_STATE_DIR"]
    ...
    static func stateDirURL() -> URL {
        ...
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            return appSupport.appendingPathComponent("Recall", isDirectory: true)
        }

        return FileManager.default.temporaryDirectory.appendingPathComponent("recall", isDirectory: true)
    }
}
