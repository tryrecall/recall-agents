...
public enum RecallCanvasA2UICommand: String, Codable, Sendable {
...
public struct RecallCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct RecallCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
