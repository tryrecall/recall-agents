...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.recall", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.recall", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: RecallProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
