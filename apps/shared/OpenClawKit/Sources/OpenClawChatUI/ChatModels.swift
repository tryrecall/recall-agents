...
public typealias RecallPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias RecallPlatformImage = UIImage
#endif

public struct RecallChatUsageCost: Codable, Hashable, Sendable {
...
public struct RecallChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: RecallChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(RecallChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct RecallChatMessageContent: Codable, Hashable, Sendable {
...
public struct RecallChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [RecallChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: RecallChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [RecallChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: RecallChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(RecallChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([RecallChatMessageContent].self, forKey: .content) {
...
public struct RecallChatHistoryPayload: Codable, Sendable {
...
public struct RecallSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct RecallSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [RecallSessionPreviewItem]
}

public struct RecallSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [RecallSessionPreviewEntry]

    public init(ts: Int, previews: [RecallSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct RecallChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct RecallChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct RecallAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct RecallChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct RecallGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct RecallPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: RecallPlatformImage?
...
public struct RecallChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
