...
public struct RecallChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct RecallChatSessionsDefaults: Codable, Sendable {
...
public struct RecallChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct RecallChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: RecallChatSessionsDefaults?
    public let sessions: [RecallChatSessionEntry]
    ...
    public init(
        ...
        sessions: [RecallChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
