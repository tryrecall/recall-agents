...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = RecallChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = RecallChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
