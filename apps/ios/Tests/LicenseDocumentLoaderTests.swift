...
struct LicenseDocumentLoaderTests {
    ...
    @Test func `derives readable titles from license filenames`() {
        ...
        #expect(LicenseDocumentLoader.title(from: "steelengine_plugin_sdk.txt") == "steelengine plugin sdk")
    ...
    private static func makeTemporaryDirectory() throws -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("SteelEngineLicenseDocumentLoaderTests-\(UUID().uuidString)", isDirectory: true)
