...
struct PushBuildConfig {
    ...
    static let steelEngineHostedRelayHost = "ios-push-relay.steelengine.ai"
    static let steelEngineSandboxRelayHost = "ios-push-relay-sandbox.steelengine.ai"

    var usesSteelEngineHostedRelay: Bool {
        ...
        return components.scheme?.lowercased() == "https"
            && [Self.steelEngineHostedRelayHost, Self.steelEngineSandboxRelayHost]
    ...
    private init(readValue: (String) -> Any?) {
        ...
        case .appStore:
            ...
            self.relayBaseURL = URL(string: "https://\(Self.steelEngineHostedRelayHost)")!
            self.apnsEnvironment = .production
            self.relayProfile = .production
            self.proofPolicy = .appleStrict
        case .deviceSandbox:
            ...
            self.relayBaseURL = relayBaseURLOverride
                ?? URL(string: "https://\(Self.steelEngineSandboxRelayHost)")!
            self.apnsEnvironment = .sandbox
            self.relayProfile = .deviceSandbox
            self.proofPolicy = .appleDevelopment
        case .simulatorSandbox:
