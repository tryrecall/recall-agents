...
struct BackgroundTasksScreen: View {
            ...
            Group {
                if self.loading, self.tasks.isEmpty {
                    ...
                    ContentUnavailableView(
                        ...
                        description: Text(errorMessage).font(SteelEngineType.body))
                    ...
                    List {
                        ...
                        Section {
                            ...
                            Text("Running").font(SteelEngineType.captionMedium)
                        }
                        Section {
                            ...
                            Text("Finished").font(SteelEngineType.captionMedium)
                        }
                    }
            ...
            .toolbar {
                ToolbarItem(placement: .topBarTrailing) {
                    Button {
                        ...
                        Label {
                            Text("Refresh").font(SteelEngineType.body)
                        } icon: {
    ...
    private func statusColor(_ task: MobileBackgroundTask) -> Color {
        switch task.status {
        case "completed": SteelEngineBrand.ok
        case "failed", "timed_out": SteelEngineBrand.warn
        case "queued", "running": SteelEngineBrand.accent
        default: .secondary
        }
    }
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 18) {
                VStack(alignment: .leading, spacing: 7) {
                    ...
                    HStack(spacing: 8) {
                        Text(self.task.statusLabel).font(SteelEngineType.captionMedium)
