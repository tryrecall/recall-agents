...
struct SettingsViewSmokeTests {
    @Test func `cron settings builds body`() {
        ...
        store.schedulerStorePath = "/tmp/steelengine-cron-store.json"
    ...
    @Test func `SteelEngine settings require configured inference`() {
    ...
    @Test func `SteelEngine preserves same route and resets for gateway changes`() {
        let stateDir = URL(fileURLWithPath: "/Users/tester/.steelengine")
