...
struct OnboardingMascotMoodTests {
    private func mood(_ snapshot: OnboardingView.MascotMoodSnapshot) -> SteelEngineMascotMood {
        OnboardingView.mascotMood(for: snapshot)
    }

    private func accessory(_ page: OnboardingView.MascotPage) -> SteelEngineMascotAccessory {
