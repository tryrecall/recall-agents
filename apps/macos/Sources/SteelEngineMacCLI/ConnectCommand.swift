...
struct ConnectOptions {
    ...
    var clientId: String = "steelengine-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: steelengine-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "SteelEngine macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("SteelEngine macOS Gateway Connect")
...
func gatewayURLDeviceAuthOwner(_ url: URL, mode: String) -> String {
    ...
    return "steelengine-mac-cli:route:\(fingerprint)"
}
