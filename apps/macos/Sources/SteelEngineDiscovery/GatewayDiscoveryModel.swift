...
public final class GatewayDiscoveryModel {
    ...
    private let logger = Logger(subsystem: "ai.steelengine", category: "gateway-discovery")
    ...
    public func start() {
        ...
        for domain in SteelEngineBonjour.gatewayServiceDomains {
            let browser = GatewayDiscoveryBrowserSupport.makeBrowser(
                ...
                domain: domain,
                queueLabelPrefix: "ai.steelengine.macos.gateway-discovery",
    ...
    public func refreshWideAreaFallbackNow(timeoutSeconds: TimeInterval = 5.0) {
        guard let domain = SteelEngineBonjour.wideAreaGatewayServiceDomain else { return }
    ...
    private func updateGateways(for domain: String) {
        ...
        if let wideAreaDomain = SteelEngineBonjour.wideAreaGatewayServiceDomain,
    ...
    private var hasUsableWideAreaResults: Bool {
        guard let domain = SteelEngineBonjour.wideAreaGatewayServiceDomain else { return false }
