...
final class QuickChatModel {
    private struct RetryIdentity {
        ...
        let sessionKey: String
        let agentID: String?
        let attachments: [SteelEngineChatAttachmentPayload]
    ...
    typealias SendProvider = @MainActor (
        ...
        String,
        String,
        [SteelEngineChatAttachmentPayload]) async throws -> String
    ...
    var connectionStatusMessage: String? {
        ...
        case .paused: "SteelEngine is paused"
