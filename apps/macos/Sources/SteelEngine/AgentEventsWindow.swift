...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: SteelEngineProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": SteelEngineProtocol.AnyCodable("start"),
                "name": SteelEngineProtocol.AnyCodable("bash"),
            ],
            summary: nil)
