...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            // Hero treatment from steelengine.ai: coral silhouette glow at 10% of
            ...
            SteelEngineMascotView(interactive: true)
                .frame(width: 160, height: 160)
                .shadow(
                    color: SteelEngineMascotView.heroGlowColor(
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(icon: "globe", title: "Website", url: "https://steelengine.ai")
                AboutLinkRow(icon: "book", title: "Docs", url: "https://docs.steelengine.ai")
                AboutLinkRow(
                    icon: "chevron.left.slash.chevron.right",
                    title: "GitHub",
                    url: "https://github.com/steelengineai/recall-agents")
                AboutLinkRow(
