...
let dashboardWindowLogger = Logger(subsystem: "ai.steelengine", category: "DashboardWindow")
...
enum DashboardWindowLayout {
    ...
    static let linkBrowserWidthDefaultsKey = "SteelEngineDashboardLinkBrowserWidth"
    static let windowFrameAutosaveName = "SteelEngineDashboardWindow"
...
enum DashboardNativeCommand: String {
    case newSession = "steelengine:native-new-session"
    case commandPalette = "steelengine:native-toggle-search"
    ...
    var legacyFallbackEventName: String? {
        switch self {
        case .newSession: nil
        case .commandPalette: "steelengine:native-open-search"
        }
    }
}
