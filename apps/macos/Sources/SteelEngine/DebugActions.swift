...
enum DebugActions {
    private static let verboseDefaultsKey = "steelengine.debug.verboseMain"
    private static let onboardingSeenKey = "steelengine.onboardingSeen"
    ...
    static func openConfigFolder() {
        let url = SteelEnginePaths.stateDirURL
        NSWorkspace.shared.activateFileViewerSelecting([url])
    }
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "SteelEngine", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = SteelEnginePaths.configURL
        guard
    ...
    static func showPairingPanelDemo() {
        ...
        PairingApprovalCenter.shared.injectDemoCards([
            ...
            PairingApprovalCenter.Card(
                ...
                displayName: "SteelEngine iPhone",
                platform: "ios 26.4",
                deviceFamily: nil,
                modelIdentifier: nil,
                version: nil,
