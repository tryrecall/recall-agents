...
enum ConfigStore {
    ...
    static func load() async -> [String: Any] {
        ...
        return SteelEngineConfigFile.loadDict()
    }
        ...
        if await self.isRemoteMode() {
            ...
            if let override = overrides.saveLocal {
                ...
                do {
                    ...
                    guard SteelEngineConfigFile.saveDict(
                        root,
...
extension Notification.Name {
    static let steelengineConfigDidChange = Notification.Name("steelengine.config.did-change")
}
