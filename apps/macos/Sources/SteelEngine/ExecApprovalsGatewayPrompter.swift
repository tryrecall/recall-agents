...
final class ExecApprovalsGatewayPrompter {
    ...
    private let logger = Logger(subsystem: "ai.steelengine", category: "exec-approvals.gateway")
    ...
    private func handle(push: GatewayPush) async {
        ...
        guard evt.event == "exec.approval.requested" || evt.event == "steelengine.approval.requested" else { return }
        ...
        do {
            ...
            if evt.event == "steelengine.approval.requested" {
