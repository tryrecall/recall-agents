...
enum LaunchAgentManager {
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/ai.steelengine.mac.plist")
    }
    ...
    static func plistContents(bundlePath: String) -> String {
        ...
        <dict>
          <key>Label</key>
          <string>ai.steelengine.mac</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/SteelEngine</string>
          </array>
