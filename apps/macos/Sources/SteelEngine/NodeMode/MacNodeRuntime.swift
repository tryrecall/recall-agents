...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case SteelEngineLocationCommand.get.rawValue:
            ...
            case SteelEngineComputerCommand.act.rawValue:
...
extension MacNodeRuntime {
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case SteelEngineCanvasA2UICommand.push.rawValue,
             SteelEngineCanvasA2UICommand.pushJSONL.rawValue:
...
extension MacNodeRuntime {
    ...
    private func handleComputerActInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        do {
            params = try Self.decodeParams(SteelEngineComputerActParams.self, from: req.paramsJSON)
        } catch {
            return Self.errorResponse(
                req,
                code: .invalidRequest,
        ...
        do {
            ...
            case .accessibilityNotTrusted:
                return Self.errorResponse(
                    req,
                    code: .unavailable,
                    message: "ACCESSIBILITY_REQUIRED: grant Accessibility permission to SteelEngine")
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> SteelEngineLocationMode {
    ...
    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: SteelEngineCanvasSnapshotFormat,
        maxWidth: Int?,
