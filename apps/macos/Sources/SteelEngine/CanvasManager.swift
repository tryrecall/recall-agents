...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.steelengine", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SteelEngine/canvas", isDirectory: true)
    }()
