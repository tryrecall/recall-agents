...
enum GatewayLaunchAgentManager {
    ...
    private static let logger = Logger(subsystem: "ai.steelengine", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".steelengine/disable-launchagent"
    ...
    private static var generatedEnvironmentDirectoryURL: URL {
        SteelEnginePaths.stateDirURL.appendingPathComponent("service-env", isDirectory: true)
    }
...
extension GatewayLaunchAgentManager {
    ...
    private static func gatewayPort(from service: [String: Any]) -> Int? {
        ...
        return self.validGatewayPort(environment?["STEELENGINE_GATEWAY_PORT"] as? String)
    }
