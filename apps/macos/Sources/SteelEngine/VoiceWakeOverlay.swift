...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.steelengine", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SteelEngine windows, but below the system’s pop-up menus.
