...
extension OnboardingView {
    /// The inference-first flow has no full-page chat; SteelEngine opens in its own sheet.
    ...
    func resetGatewayBoundAIState() {
        ...
        aiSetup.resetForGatewayChange(clearPendingHandoff: false)
        memoryImport.reset()
        // SteelEngine sessions belong to one Gateway. Dismiss and replace the chat so
