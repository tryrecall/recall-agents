...
struct ExecApprovalPolicySnapshot: Sendable, Equatable {
    ...
    init(portable: SteelEngineSystemRunApprovalPolicySnapshot) {
        self.init(
    ...
    var portable: SteelEngineSystemRunApprovalPolicySnapshot {
        SteelEngineSystemRunApprovalPolicySnapshot(
