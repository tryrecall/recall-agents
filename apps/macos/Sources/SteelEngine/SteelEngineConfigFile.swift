...
enum SteelEngineConfigFile {
    private static let logger = Logger(subsystem: "ai.steelengine", category: "config")
    ...
    static func url() -> URL {
        SteelEnginePaths.configURL
    }

    static func stateDirURL() -> URL {
        SteelEnginePaths.stateDirURL
    }
...
extension SteelEngineConfigFile {
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-steelengine-config-file",
            "event": "config.write",
