...
enum CanvasHostedURLResolver {
    private static let canvasPath = "/__steelengine__/canvas"
    private static let a2uiPath = "/__steelengine__/a2ui"
    private static let capabilityMarker = "/__steelengine__/cap/"
