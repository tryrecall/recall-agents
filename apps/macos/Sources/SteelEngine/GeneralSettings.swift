...
struct GeneralSettings: View {
    ...
    private var generalPage: some View {
        VStack(alignment: .leading, spacing: 20) {
            SettingsPageHeader(
                title: "General",
                subtitle: "Everyday SteelEngine app behavior.")

            self.steelEngineStatusPanel

            SettingsCardGroup("App") {
                SettingsCardToggleRow(
                    title: "Launch at login",
                    subtitle: self.state.bundleLocationAllowsPersistentIntegration
                        ? "Automatically start SteelEngine after you sign in."
                        : "Move SteelEngine to Applications before enabling launch at login.",
                ...
                SettingsCardToggleRow(
                    ...
                    subtitle: """
                    Keep SteelEngine visible in the Dock. When off, windows still show the Dock icon while open.
                    """,
    ...
    private var steelEngineStatusPanel: some View {
        HStack(alignment: .center, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text(self.state.isPaused ? "SteelEngine paused" : "SteelEngine active")
                    .font(.headline)
            ...
            Toggle("SteelEngine active", isOn: self.activeBinding)
                .labelsHidden()
                .toggleStyle(.switch)
        }
    ...
    private var connectionStatusSubtitle: String {
        switch self.state.connectionMode {
        case .local:
            return "SteelEngine starts and monitors the Gateway on this Mac."
        case .remote:
        ...
        SettingsCardGroup("Advanced") {
            DisclosureGroup(isExpanded: self.$showRemoteAdvanced) {
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    self.advancedTextField(
                        "Project root",
                        placeholder: "/home/you/Projects/steelengine",
                        text: self.$state.remoteProjectRoot)
                    self.advancedTextField(
                        "CLI path",
                        placeholder: "/Applications/SteelEngine.app/.../steelengine",
...
extension GeneralSettings {
    ...
    private func revealLogs() {
        ...
        Looked for steelengine logs in /tmp/steelengine/.
...
extension GeneralSettings {
    static func exerciseForTesting() {
        ...
        state.remoteProjectRoot = "/tmp/steelengine"
        state.remoteCliPath = "/tmp/steelengine"
