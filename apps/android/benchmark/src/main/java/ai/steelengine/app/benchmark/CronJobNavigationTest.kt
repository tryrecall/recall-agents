package ai.steelengine.app.benchmark
...
class CronJobNavigationTest {
  ...
  fun setUp() {
    ...
    device.executeShellCommand(
      "am start -W -n $packageName/.MainActivity " +
        "--ez steelengine.screenshotMode true --es steelengine.screenshotScene settings",
    )
  ...
  private companion object {
    const val packageName = "ai.steelengine.app"
