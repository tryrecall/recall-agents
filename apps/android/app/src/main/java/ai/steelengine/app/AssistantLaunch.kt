...
const val actionAskSteelEngine = "ai.steelengine.app.action.ASK_STEELENGINE"

/** Debug action that opens the Voice tab directly for Android E2E automation. */
const val actionOpenVoiceE2e = "ai.steelengine.app.debug.OPEN_VOICE_E2E"
...
private fun sharedImageUris(
  ...
  // prevents an external intent from turning SteelEngine into a reader for its own private files.
  val validUris =
    (streamUris + clipUris)
