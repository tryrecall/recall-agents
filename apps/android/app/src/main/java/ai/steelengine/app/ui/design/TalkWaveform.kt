...
/**
 * Universal SteelEngine talk animation: Compose port of the shared Siri-style
 * waveform in `apps/shared/SteelEngineKit/Sources/SteelEngineChatUI/TalkWaveformView.swift`.
...
internal fun TalkWaveform(
  ...
  // "remove animations" setting explicitly (same pattern as SteelEngineMascot).
