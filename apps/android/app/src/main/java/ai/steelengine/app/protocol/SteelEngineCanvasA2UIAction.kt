...
object SteelEngineCanvasA2UIAction {
  ...
  fun jsDispatchA2UIActionStatus(
    ...
    return "window.dispatchEvent(new CustomEvent('steelengine:a2ui-action-status', { detail: { id: $idLiteral, ok: $okLiteral, error: $err } }));"
  }
