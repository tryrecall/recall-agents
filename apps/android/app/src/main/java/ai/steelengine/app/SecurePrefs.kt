...
import ai.steelengine.app.gateway.GatewayCustomHeaders
import ai.steelengine.app.gateway.GatewayRegistryStore
import ai.steelengine.app.gateway.GatewayStoreMigration
...
class SecurePrefs(
  ...
  companion object {
    ...
    private const val plainPrefsName = "steelengine.node"
    private const val securePrefsName = "steelengine.node.secure"
  ...
  internal fun getNotificationForwardingPolicy(appPackageName: String): NotificationForwardingPolicy {
    ...
    // Always block SteelEngine's own notifications in blocklist mode to prevent forwarding loops.
