...
enum class GatewayMethod(
  ...
  OpenclawChat("steelengine.chat"),
  OpenclawApprovalList("steelengine.approval.list"),
  OpenclawSetupDetect("steelengine.setup.detect"),
  OpenclawSetupActivate("steelengine.setup.activate"),
  OpenclawSetupAuthStart("steelengine.setup.auth.start"),
  OpenclawSetupPrepareStart("steelengine.setup.prepare.start"),
  ...
  OpenclawSetupVerify("steelengine.setup.verify"),
...
enum class GatewayEvent(
  ...
  OpenclawApprovalRequested("steelengine.approval.requested"),
  OpenclawApprovalResolved("steelengine.approval.resolved"),
