...
class NodeForegroundService : Service() {
  ...
  override fun onCreate() {
    ...
    val initial =
      buildNotification(
        title = nativeString("SteelEngine Node"),
    ...
    runtimeRestoreJob =
      scope.launch(Dispatchers.Default) {
        try {
          ...
          Log.e("SteelEngineNodeService", "Failed to restore node runtime", err)
          withContext(Dispatchers.Main) {
            runtimeRestoreJob = null
          ...
          val title =
            when {
              state.connected && state.mode == VoiceCaptureMode.TalkMode ->
                nativeString("SteelEngine Node · Talk")
              state.connected -> nativeString("SteelEngine Node · Connected")
              else -> nativeString("SteelEngine Node")
            }
  ...
  private fun ensureChannel() {
    ...
    val channel =
      NotificationChannel(
        ...
        description = nativeString("SteelEngine node connection status")
        setShowBadge(false)
      }
  ...
  companion object {
    ...
    private const val ACTION_STOP = "ai.steelengine.app.action.STOP"
    private const val ACTION_RESUME = "ai.steelengine.app.action.RESUME"
    private const val ACTION_SET_VOICE_CAPTURE_MODE = "ai.steelengine.app.action.SET_VOICE_CAPTURE_MODE"
    private const val EXTRA_VOICE_CAPTURE_MODE = "ai.steelengine.app.extra.VOICE_CAPTURE_MODE"
