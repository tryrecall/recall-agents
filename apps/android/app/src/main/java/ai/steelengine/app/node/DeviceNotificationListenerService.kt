...
import ai.steelengine.app.NotificationBurstLimiter
import ai.steelengine.app.SecurePrefs
import ai.steelengine.app.allowsPackage
import ai.steelengine.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("steelengine.secure", Context.MODE_PRIVATE)
