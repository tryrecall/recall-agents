...
import ai.steelengine.app.gateway.GatewayClientInfo
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "SteelEngineAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "steelengine-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(
    ...
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "steelengine-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
