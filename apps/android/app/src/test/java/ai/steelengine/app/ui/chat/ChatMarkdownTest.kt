...
class ChatMarkdownTest {
  ...
  fun markdownLinksUseLabelTextAndDestinationUrl() {
    val annotated = buildChatInlineMarkdown("Open [docs](https://docs.steelengine.ai/help/testing) now")
    ...
    assertEquals("https://docs.steelengine.ai/help/testing", (links.single().item as LinkAnnotation.Url).url)
  }

  @Test
  fun markdownLinksDropUnsafeDestinations() {
    listOf(
      "intent://example/#Intent;scheme=steelengine;end",
