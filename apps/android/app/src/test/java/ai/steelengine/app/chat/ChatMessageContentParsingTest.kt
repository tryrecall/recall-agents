package ai.steelengine.app.chat

import ai.steelengine.app.ui.chat.readBoundedWidgetDocument
...
class ChatMessageContentParsingTest {
  ...
  fun parsesCapabilityGatedCanvasWidgets() {
    val content =
      Json.parseToJsonElement(
        """{"type":"canvas","preview":{"kind":"canvas","surface":"assistant_message","render":"url","title":"Status","preferredHeight":240,"url":"/__steelengine__/canvas/documents/widget-1/index.html","sandbox":"scripts"}}""",
      )
    ...
    assertEquals(
      ChatMessageContent(
        ...
        widget =
          ChatWidgetPreview(
            title = "Status",
            path = "/__steelengine__/canvas/documents/widget-1/index.html",
            preferredHeight = 240,
            sandbox = "scripts",
          ),
      ),
  ...
  fun dropsCanvasBlocksWithoutWidgetSandbox() {
    val content =
      Json.parseToJsonElement(
        """{"type":"canvas","preview":{"kind":"canvas","surface":"assistant_message","render":"url","url":"/__steelengine__/canvas/documents/widget-1/index.html"}}""",
      )
  ...
  fun resolvesOnlyCapabilityScopedWidgetDocuments() {
    val surface = "https://gateway.example/__steelengine__/cap/token"

    assertEquals(
      "https://gateway.example/__steelengine__/cap/token/__steelengine__/canvas/documents/widget-1/index.html",
      ChatWidgetUrlResolver.resolve(surface, "/__steelengine__/canvas/documents/widget-1/index.html"),
    )
    assertEquals(
      "https://gateway.example/__steelengine__/cap/token/__steelengine__/canvas/documents/widget-1/index.html",
      ChatWidgetUrlResolver.resolve(
        "HTTPS://gateway.example/__steelengine__/cap/token",
        "/__steelengine__/canvas/documents/widget-1/index.html",
      ),
    )
    assertNull(ChatWidgetUrlResolver.resolve("https://gateway.example", "/__steelengine__/canvas/documents/widget-1/index.html"))
    assertNull(ChatWidgetUrlResolver.resolve(surface, "https://attacker.example/widget.html"))
    assertNull(ChatWidgetUrlResolver.resolve(surface, "/__steelengine__/a2ui/index.html"))
    assertNull(ChatWidgetUrlResolver.resolve(surface, "/__steelengine__/canvas/documents/%252e%252e/index.html"))
  }

  @Test
  fun initialResolutionUsesOperatorFallbackWhenNodeUnavailable() {
    val target = "/__steelengine__/canvas/documents/widget-1/index.html"
    val fallbackSurface = "https://operator.example/__steelengine__/cap/fallback"
    val surfaces =
  ...
  fun usesReplacementRouteAfterCapabilityRefreshLosesItsLease() =
    runTest {
      val target = "/__steelengine__/canvas/documents/widget-1/index.html"
      val oldSurface = "https://gateway.example/__steelengine__/cap/old"
      val newSurface = "https://gateway.example/__steelengine__/cap/new"
  ...
  fun refreshesOperatorCapabilityWhenNodeUnavailable() =
    runTest {
      val target = "/__steelengine__/canvas/documents/widget-1/index.html"
      val oldSurface = "https://operator.example/__steelengine__/cap/old"
      val newSurface = "https://operator.example/__steelengine__/cap/new"
      val failedResource =
        ChatWidgetResource(
