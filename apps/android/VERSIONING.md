# SteelEngine Android Versioning
...
```text
refs/steelengine/mobile-releases/android/<versionName>-<versionCode>
```

Example:

```text
refs/steelengine/mobile-releases/android/2026.6.10-2026061008
```
...
If `MATCH_PASSWORD` is not set, the existing manual Gradle-property signing path still works: provide `STEELENGINE_ANDROID_STORE_FILE`, `STEELENGINE_ANDROID_STORE_PASSWORD`, `STEELENGINE_ANDROID_KEY_ALIAS`, and `STEELENGINE_ANDROID_KEY_PASSWORD` through your local Gradle user properties before running release tasks.
