...
`precise.yml` is SteelEngine's shipped precise OpenGrep rulepack. Each rule is tied
...
Some SteelEngine paths are excluded by `.gitignore` for build reasons even though
