...
// Summarizes SteelEngine performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/steelengine-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes SteelEngine-native performance probe artifacts for CI reports.`);
}
...
export function buildMarkdown(sourceDir, baselineSourceDir) {
  ...
  const lines = [
    "# SteelEngine Source Performance",
    "",
