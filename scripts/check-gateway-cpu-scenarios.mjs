  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          STEELENGINE_HOME: qaState.home,
          STEELENGINE_STATE_DIR: qaState.stateDir,
          STEELENGINE_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    STEELENGINE_BUILD_PRIVATE_QA: "1",
    STEELENGINE_ENABLE_PRIVATE_QA_CLI: "1",
    STEELENGINE_RUN_NODE_SKIP_DTS_BUILD: env.STEELENGINE_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    STEELENGINE_TEST_DISABLE_UPDATE_CHECK: env.STEELENGINE_TEST_DISABLE_UPDATE_CHECK ?? "1",
