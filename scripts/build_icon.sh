...
# Defaults target the Recall assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Recall/Resources/Recall.icns"}
