...
function ensureSteelEngineExtensionAlias(params) {
  ...
  const aliasDir = path.join(params.distExtensionsRoot, "node_modules", "steelengine");
...
function shouldCopyRuntimeFile(relativePath) {
  return (
    ...
    isPathOrNestedPath(relativePath, "steelengine.plugin.json") ||
...
export function stageBundledPluginRuntime(params = {}) {
  ...
  ensureSteelEngineExtensionAlias({ repoRoot, distExtensionsRoot });
