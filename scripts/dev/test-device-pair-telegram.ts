// Test Device Pair Telegram script supports SteelEngine repository automation.
...
import { loadSteelEnginePlugins } from "../../src/plugins/loader.js";
...
type DevicePairTelegramDeps = {
  ...
  loadSteelEnginePlugins: typeof loadSteelEnginePlugins;
...
async function runDevicePairTelegram(
  ...
  deps.loadSteelEnginePlugins({ config: cfg });
