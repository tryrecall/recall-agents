...
- RECALL_IOS_VERSION = exact canonical iOS version
- RECALL_MARKETING_VERSION = short iOS/App Store version
- RECALL_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
RECALL_IOS_VERSION = ${IOS_VERSION}
RECALL_MARKETING_VERSION = ${MARKETING_VERSION}
RECALL_BUILD_VERSION = ${BUILD_NUMBER}
EOF
