...
RECALL_APP_BUNDLE_ID = ai.recall.client
RECALL_SHARE_BUNDLE_ID = ai.recall.client.share
RECALL_ACTIVITY_WIDGET_BUNDLE_ID = ai.recall.client.activitywidget
RECALL_WATCH_APP_BUNDLE_ID = ai.recall.client.watchkitapp
RECALL_WATCH_EXTENSION_BUNDLE_ID = ai.recall.client.watchkitapp.extension
RECALL_APP_PROFILE =
