...
const DEFAULT_REPO = process.env.STEELENGINE_RELEASE_REPO || "steelengine/steelengine";
const RELEASE_EVIDENCE_SCHEMA = "steelengine.release-validation-evidence/v3";
...
function downloadParentManifestEvidence(runId, runAttempt, repository, manifestPath) {
  ...
  const downloadDir = mkdtempSync(join(tmpdir(), "steelengine-release-ci-summary-"));
  try {
