...
const DEFAULT_CLAWHUB_SOURCE_REPO = "steelengine/clawhub";
const CLAWHUB_DOCS_TARGET_DIR = "clawhub";
const CLAWHUB_REPO_ENV = "STEELENGINE_DOCS_SYNC_CLAWHUB_REPO";
...
const SYNC_SUPPORT_FILES = [
  {
    ...
    target: path.join(".steelengine-sync", "check-docs-mdx.mjs"),
  },
  {
    source: path.join(ROOT, "scripts", "lib", "mintlify-accordion.mjs"),
    target: path.join(".steelengine-sync", "lib", "mintlify-accordion.mjs"),
  },
  {
    source: path.join(ROOT, ".github", "codex", "prompts", "docs-mdx-repair.md"),
    target: path.join(".steelengine-sync", "docs-mdx-repair.md"),
  },
];
...
export function parseArgs(argv) {
  const args = {
    ...
    clawhubSourceRepo:
      process.env.STEELENGINE_DOCS_SYNC_CLAWHUB_SOURCE_REPO || DEFAULT_CLAWHUB_SOURCE_REPO,
    clawhubSourceSha: process.env.STEELENGINE_DOCS_SYNC_CLAWHUB_SOURCE_SHA || "",
  };
...
function writeSyncMetadata(targetRoot, args, sources) {
  ...
  writeJson(path.join(targetRoot, ".steelengine-sync", "source.json"), metadata);
}
