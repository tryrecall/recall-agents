...
IMAGE_NAME="$(docker_e2e_resolve_image "steelengine-release-media-memory-e2e" STEELENGINE_RELEASE_MEDIA_MEMORY_E2E_IMAGE)"
SKIP_BUILD="${STEELENGINE_RELEASE_MEDIA_MEMORY_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-media-memory "${STEELENGINE_CURRENT_PACKAGE_TGZ:-}")"
...
STEELENGINE_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-media-memory empty)"
