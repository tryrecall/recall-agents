...
IMAGE_NAME="$(docker_e2e_resolve_image "steelengine-session-runtime-context-e2e" STEELENGINE_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="steelengine-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t steelengine-session-runtime-context-log.XXXXXX)"
