...
IMAGE_NAME="$(docker_e2e_resolve_image "recall-session-runtime-context-e2e" RECALL_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="recall-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t recall-session-runtime-context-log.XXXXXX)"
