...
IMAGE_NAME="$(docker_e2e_resolve_image "recall-crestodian-rescue-e2e" RECALL_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="recall-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t recall-crestodian-rescue-log.XXXXXX)"
...
RECALL_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-rescue empty)"
