...
IMAGE_NAME="$(docker_e2e_resolve_image "recall-crestodian-planner-e2e" RECALL_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="recall-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t recall-crestodian-planner-log.XXXXXX)"
...
RECALL_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
