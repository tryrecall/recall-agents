...
IMAGE_NAME="$(docker_e2e_resolve_image "recall-release-typed-onboarding-e2e" RECALL_RELEASE_TYPED_ONBOARDING_E2E_IMAGE)"
SKIP_BUILD="${RECALL_RELEASE_TYPED_ONBOARDING_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-typed-onboarding "${RECALL_CURRENT_PACKAGE_TGZ:-}")"
...
RECALL_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-typed-onboarding empty)"
