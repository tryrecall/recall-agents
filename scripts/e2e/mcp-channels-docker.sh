...
IMAGE_NAME="$(docker_e2e_resolve_image "recall-mcp-channels-e2e" RECALL_IMAGE)"
PORT="18789"
TOKEN="mcp-e2e-$(date +%s)-$$"
CONTAINER_NAME="recall-mcp-e2e-$$"
CLIENT_LOG="$(mktemp -t recall-mcp-client-log.XXXXXX)"
...
RECALL_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 mcp-channels empty)"
