...
const pluginRecordSnapshot = () => {
  const config = readJson(steelenginePath("steelengine.json"));
...
function steelenginePath(...parts) {
  return path.join(home, ".steelengine", ...parts);
}
...
function seedInstallState() {
  writeJson(steelenginePath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.STEELENGINE_CONFIG_PATH, { plugins: {} });
  writePluginInstallIndexForE2E({
    version: 1,
    warning: "DO NOT EDIT. This file is generated by SteelEngine plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("SteelEngine will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  const expectedFragments = disabledAfterFailure
    ? [
        ...
        "SteelEngine will continue without it",
