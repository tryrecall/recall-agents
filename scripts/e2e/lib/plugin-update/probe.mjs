...
const pluginRecordSnapshot = () => {
  const config = readJson(openclawPath("recall.json"));
...
function seedInstallState() {
  ...
  writeJson(process.env.RECALL_CONFIG_PATH, { plugins: {} });
  writeJson(openclawPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by Recall plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("Recall will continue without it")
  );
}
