...
export OPENAI_API_KEY="sk-steelengine-release-user-journey"
export STEELENGINE_GATEWAY_TOKEN="release-user-journey-token"
export CLICKCLACK_BOT_TOKEN="clickclack-release-token"

PORT="18789"
MOCK_PORT="44180"
CLICKCLACK_PORT="44181"
SUCCESS_MARKER="STEELENGINE_E2E_OK_RELEASE_USER_JOURNEY"
...
steelengine_e2e_install_package "$INSTALL_LOG"
...
steelengine plugins install "$plugin_a_dir" --force >"$PLUGIN_A_INSTALL_LOG" 2>&1
node scripts/e2e/lib/release-user-journey/assertions.mjs \
  ...
  "$plugin_a_dir"
steelengine journey-a ping >"$PLUGIN_A_CLI_LOG" 2>&1
...
steelengine plugins uninstall journey-plugin-a --force >"$PLUGIN_A_UNINSTALL_LOG" 2>&1
node scripts/e2e/lib/release-user-journey/assertions.mjs \
...
steelengine plugins install "$plugin_b_dir" --force >"$PLUGIN_B_INSTALL_LOG" 2>&1
steelengine journey-b ping >"$PLUGIN_B_CLI_LOG" 2>&1
...
steelengine plugins inspect journey-plugin-b --runtime --json >"$PLUGIN_B_AFTER_RESTART_JSON" 2>&1
steelengine channels status --json >"$STATUS_AFTER_RESTART_JSON" 2>"$STATUS_AFTER_RESTART_ERR"
...
steelengine doctor --repair --non-interactive >"$DOCTOR_LOG" 2>&1
