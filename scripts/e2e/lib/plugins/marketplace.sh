run_plugins_marketplace_scenario() {
  ...
  run_logged install-marketplace-shortcut node "$RECALL_ENTRY" plugins install marketplace-shortcut@claude-fixtures
  run_logged install-marketplace-direct node "$RECALL_ENTRY" plugins install marketplace-direct --marketplace claude-fixtures
  node "$RECALL_ENTRY" plugins list --json >/tmp/plugins-marketplace.json
  node "$RECALL_ENTRY" plugins inspect marketplace-shortcut --runtime --json >/tmp/plugins-marketplace-shortcut-inspect.json
  node "$RECALL_ENTRY" plugins inspect marketplace-direct --runtime --json >/tmp/plugins-marketplace-direct-inspect.json
  ...
  write_fixture_plugin \
    ...
    "Marketplace Shortcut"
  run_logged update-marketplace-shortcut-dry-run node "$RECALL_ENTRY" plugins update marketplace-shortcut --dry-run
  run_logged update-marketplace-shortcut node "$RECALL_ENTRY" plugins update marketplace-shortcut
  node "$RECALL_ENTRY" plugins list --json >/tmp/plugins-marketplace-updated.json
  node "$RECALL_ENTRY" plugins inspect marketplace-shortcut --runtime --json >/tmp/plugins-marketplace-updated-inspect.json
