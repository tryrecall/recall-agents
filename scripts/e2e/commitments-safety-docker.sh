...
IMAGE_NAME="$(docker_e2e_resolve_image "recall-commitments-safety-e2e" RECALL_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="recall-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t recall-commitments-safety-log.XXXXXX)"
