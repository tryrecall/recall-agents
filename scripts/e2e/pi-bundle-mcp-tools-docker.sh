...
IMAGE_NAME="$(docker_e2e_resolve_image "recall-pi-bundle-mcp-tools-e2e" RECALL_IMAGE)"
CONTAINER_NAME="recall-pi-bundle-mcp-tools-e2e-$$"
RUN_LOG="$(mktemp -t recall-pi-bundle-mcp-tools-log.XXXXXX)"
...
RECALL_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 pi-bundle-mcp-tools empty)"
