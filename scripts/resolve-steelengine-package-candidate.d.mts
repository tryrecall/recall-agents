...
export function validateSteelEnginePackageSpec(spec: unknown): void;
...
export const STEELENGINE_PACKAGE_SPEC_RE: RegExp;
...
export function cleanPackedSteelEngineTarballsForTest(outputDir: unknown): Promise<void>;
