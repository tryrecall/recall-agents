...
const rules = [
  ...
  },
  {
    ...
    moduleSpecifiers: [
      "recall/plugin-sdk/agent-dir-compat",
      "recall/plugin-sdk/channel-config-schema-legacy",
      "recall/plugin-sdk/channel-reply-pipeline",
      "recall/plugin-sdk/channel-runtime",
      "recall/plugin-sdk/compat",
      "recall/plugin-sdk/discord",
      "recall/plugin-sdk/infra-runtime",
      "recall/plugin-sdk/mattermost",
      "recall/plugin-sdk/matrix",
      "recall/plugin-sdk/telegram-account",
      "recall/plugin-sdk/testing",
      "recall/plugin-sdk/test-utils",
      "recall/plugin-sdk/zalouser",
    ],
