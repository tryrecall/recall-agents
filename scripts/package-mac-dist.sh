...
# Output:
# - dist/Recall.app
# - dist/Recall-<version>.zip
# - dist/Recall-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.tryrecall.mac}"
...
ZIP="$ROOT_DIR/dist/Recall-$VERSION.zip"
DMG="$ROOT_DIR/dist/Recall-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Recall-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Recall-$VERSION.dSYM.zip"
