...
export function buildTimedWatchCommand(
  ...
  | {
      ...
      args: unknown[];
      env: {
        STEELENGINE_DISABLE_BONJOUR: string;
        STEELENGINE_SKIP_ACPX_RUNTIME: string;
        STEELENGINE_SKIP_ACPX_RUNTIME_PROBE: string;
        STEELENGINE_SKIP_BROWSER_CONTROL_SERVER: string;
        STEELENGINE_SKIP_CANVAS_HOST: string;
        STEELENGINE_SKIP_CHANNELS: string;
        STEELENGINE_SKIP_CRON: string;
        STEELENGINE_SKIP_GMAIL_WATCHER: string;
        STEELENGINE_RUNTIME_POSTBUILD_STATIC_ASSETS: string;
        STEELENGINE_TEST_MINIMAL_GATEWAY: string;
        NODE_ENV: string;
        STEELENGINE_WATCH_PID_FILE: unknown;
        HOME: unknown;
        STEELENGINE_HOME: unknown;
