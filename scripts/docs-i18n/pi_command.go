...
const (
	envDocsPiExecutable     = "RECALL_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "RECALL_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "RECALL_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "recall", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
