...
- Keep product names in English: Recall, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Recall Gateway, use “Gateway 网关”.
