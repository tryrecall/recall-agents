...
if [[ -z "$version_content" ]]; then
  echo "<h2>SteelEngine $VERSION</h2>"
  echo "<p>Latest SteelEngine update.</p>"
  echo "<p><a href=\"https://github.com/steelengineai/recall-agents/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
