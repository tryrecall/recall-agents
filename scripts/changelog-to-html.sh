...
if [[ -z "$version_content" ]]; then
  echo "<h2>Recall $VERSION</h2>"
  echo "<p>Latest Recall update.</p>"
  echo "<p><a href=\"https://github.com/tryrecall/recall-agents/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
