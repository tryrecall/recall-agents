...
async function main() {
  ...
  if (violations.length === 0) {
    console.log("OK: all referenced steelengine/plugin-sdk/<subpath> imports are exported.");
    return;
  }

  console.error(
    "Rule: every referenced steelengine/plugin-sdk/<subpath> must exist in the public package exports.",
  );
