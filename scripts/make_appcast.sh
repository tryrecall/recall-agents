...
FEED_URL=${2:-"https://raw.githubusercontent.com/recall/recall/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/recall/recall/releases/download/v${VERSION}/"}
