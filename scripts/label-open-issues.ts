...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "recall", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Recall. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Recall Issue Label Audit");
