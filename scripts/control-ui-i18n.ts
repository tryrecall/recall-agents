// Control Ui I18N script supports SteelEngine repository automation.
...
import { completeSimple, type AssistantMessage, type Model } from "steelengine/plugin-sdk/llm";
...
const ENV_PROVIDER = "STEELENGINE_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "STEELENGINE_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "STEELENGINE_CONTROL_UI_I18N_THINKING";
const ENV_BATCH_CHAR_BUDGET = "STEELENGINE_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "STEELENGINE_CONTROL_UI_I18N_PROMPT_TIMEOUT";
const ENV_AUTH_OPTIONAL = "STEELENGINE_CONTROL_UI_I18N_AUTH_OPTIONAL";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "SteelEngine", target: "SteelEngine" },
