...
show_usage() {
    cat << EOF
clawlog - SteelEngine Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View SteelEngine logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    SteelEngine logs flow through the macOS unified log (subsystem: ai.steelengine).
