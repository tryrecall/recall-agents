...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  ...
  },
  {
    ...
    hint: "Use recall/plugin-sdk/testing for the public extension test surface.",
  },
  {
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or recall/plugin-sdk/testing for public surfaces.",
  },
  {
