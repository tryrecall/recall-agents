...
// macOS, so the iOS coverage owner lives in SteelEngineChatUI.
const IOS_SCAN_ROOTS = ["apps/ios/Sources", "apps/shared/SteelEngineKit/Sources"];
const IOS_SENTINEL_FILE =
  "apps/shared/SteelEngineKit/Sources/SteelEngineChatUI/ChatGatewayPayloadCodec.swift";
const ANDROID_SCAN_ROOT = "apps/android/app/src/main/java/ai/steelengine/app";
const ANDROID_SENTINEL_FILES = [
  "apps/android/app/src/main/java/ai/steelengine/app/gateway/GatewaySession.kt",
  "apps/android/app/src/main/java/ai/steelengine/app/chat/ChatController.kt",
];
