...
/**
 * Parses STEELENGINE_EXTENSIONS into the bundled plugin ids that Docker should keep.
 */
...
export function pruneDockerPluginDist(params = {}) {
  ...
  const bundledPluginDir = env.STEELENGINE_BUNDLED_PLUGIN_DIR ?? "extensions";
  const keepPluginIds = parseDockerPluginKeepList(env.STEELENGINE_EXTENSIONS);
