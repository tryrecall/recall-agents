...
function printHelp() {
  console.log(`Usage: node scripts/recall-performance-source-summary.mjs --source-dir <dir> [--output <summary.md>]

Summarizes Recall-native performance probe artifacts for CI reports.`);
}
