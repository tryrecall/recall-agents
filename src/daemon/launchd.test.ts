...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.tryrecall.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.tryrecall.gateway\n";
  ...
  it.each([
    {
      ...
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.tryrecall.gateway.plist",
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.tryrecall.jbphoenix.plist",
    },
    {
    ...
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.tryrecall.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
