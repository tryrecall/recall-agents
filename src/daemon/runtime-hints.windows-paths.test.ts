...
const resolveGatewaySupervisorLogPathsMock = vi.fn(() => ({
  logDir: "C:\\Users\\test\\Library\\Logs\\recall",
  stdoutPath: "C:\\Users\\test\\Library\\Logs\\recall\\gateway.log",
  stderrPath: "C:\\Users\\test\\Library\\Logs\\recall\\gateway.err.log",
}));
const resolveGatewayRestartLogPathMock = vi.fn(
  () => "C:\\tmp\\recall-state\\logs\\gateway-restart.log",
);
