...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: RecallConfig; agentId?: string }) => ModelRef;
...
let queue: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: RecallConfig }> = [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: RecallConfig }>,
