...
export function resolveConfiguredMediaMaxBytes(cfg?: RecallConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: RecallConfig | undefined, kind: MediaKind) {
