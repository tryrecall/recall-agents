...
/** SteelEngine-facing image backend availability error, preserving the failed operation and causes. */
...
/** Creates a Rastermill processor with SteelEngine temp-dir, pixel-limit, and command trust policy. */
...
/** Detects either SteelEngine's wrapper error or Rastermill's native unavailable error. */
