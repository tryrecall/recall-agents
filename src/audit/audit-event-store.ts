...
type AuditEventsTable = SteelEngineStateKyselyDatabase["audit_events"];
type AuditDatabase = Pick<SteelEngineStateKyselyDatabase, "audit_events">;
...
export function listAuditEvents(params: {
  ...
  const { db } = openSteelEngineStateDatabase(params.database);
