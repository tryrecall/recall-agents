...
export type SteelEngineHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "steelengine-bundled" | "steelengine-managed" | "steelengine-workspace" | "steelengine-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: SteelEngineHookMetadata;
