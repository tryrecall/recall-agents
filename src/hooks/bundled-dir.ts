...
export function resolveBundledHooksDir(): string | undefined {
  const override = process.env.STEELENGINE_BUNDLED_HOOKS_DIR?.trim();
  if (override) {
    return override;
  }
  ...
  // This path works when installed via npm: node_modules/steelengine/dist/hooks/bundled-dir.js
  try {
