...
const HOOK_SOURCE_POLICIES: Record<HookSource, HookSourcePolicy> = {
  "steelengine-bundled": {
    ...
    canOverride: ["steelengine-bundled"],
    canBeOverriddenBy: ["steelengine-managed", "steelengine-plugin"],
  },
  "steelengine-plugin": {
    precedence: 20,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["steelengine-bundled", "steelengine-plugin"],
    canBeOverriddenBy: ["steelengine-managed"],
  },
  "steelengine-managed": {
    precedence: 30,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["steelengine-bundled", "steelengine-managed", "steelengine-plugin"],
    canBeOverriddenBy: ["steelengine-managed"],
  },
  "steelengine-workspace": {
    ...
    canOverride: ["steelengine-workspace"],
    canBeOverriddenBy: ["steelengine-workspace"],
  },
};
...
export function resolveHookEnableState(params: {
  ...
  if (entry.hook.source === "steelengine-plugin") {
    return { enabled: true };
  }
