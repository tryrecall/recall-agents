/**
 * Hook system for SteelEngine agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("steelengine.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("steelengine.internalHooksEnabled");
