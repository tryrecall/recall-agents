/**
 * Hook system for Recall agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("recall.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("recall.internalHooksEnabled");
