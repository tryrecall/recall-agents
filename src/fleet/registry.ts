...
type FleetCellsTable = SteelEngineStateKyselyDatabase["fleet_cells"];
type FleetCellRow = Selectable<FleetCellsTable>;
type FleetRegistryDatabase = Pick<SteelEngineStateKyselyDatabase, "fleet_cells" | "state_leases">;
