...
export const A2UI_PATH = "/__recall__/a2ui";

export const CANVAS_HOST_PATH = "/__recall__/canvas";

export const CANVAS_WS_PATH = "/__recall__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.recallCanvasA2UIAction.postMessage(...)
  // - Android: window.recallCanvasA2UIAction.postMessage(...)
  const handlerNames = ["recallCanvasA2UIAction"];
  ...
  globalThis.recallPostMessage = postToNode;
  globalThis.recallSendUserAction = sendUserAction;
