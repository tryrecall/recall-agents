...
function resolveAcpStreamCoalesceIdleMs(cfg: RecallConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: RecallConfig): number {
...
export function resolveAcpProjectionSettings(cfg: RecallConfig): AcpProjectionSettings {
