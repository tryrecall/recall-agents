...
const emptyCfg = {} as RecallConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as RecallConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as RecallConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
