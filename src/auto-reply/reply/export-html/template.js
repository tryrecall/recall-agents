...
(function () {
  ...
  const injectedParams = document.querySelector('meta[name="steelengine-url-params"]');
  ...
  function buildShareUrl(entryId) {
    ...
    const baseUrlMeta = document.querySelector('meta[name="steelengine-share-base-url"]');
