...
import { toAcpRuntimeErrorText } from "@steelengine/acp-core/runtime/error-text";
...
export function resolveAcpHelpText(): string {
  return [
    ...
    "",
    "Notes:",
    "- /acp spawn harness-id is an ACP runtime harness alias (for example codex), not an SteelEngine agents.list id.",
