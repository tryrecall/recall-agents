...
const acpMocks = vi.hoisted(() => ({
  ...
  readAcpSessionEntry: vi.fn<(params: { sessionKey: string; cfg?: SteelEngineConfig }) => unknown>(
    () => null,
  ),
  readAcpSessionMeta: vi.fn<(params: { sessionKey: string; cfg?: SteelEngineConfig }) => unknown>(
    () => null,
  ),
...
vi.mock("../../tts/tts.js", () => ({
  ...
  resolveTtsConfig: (cfg: SteelEngineConfig) => ttsMocks.resolveTtsConfig(cfg),
}));
...
vi.mock("../../tts/tts-config.js", () => ({
  normalizeTtsAutoMode: (value: unknown) => ttsMocks.normalizeTtsAutoMode(value),
  resolveConfiguredTtsMode: (cfg: SteelEngineConfig) => ttsMocks.resolveTtsConfig(cfg).mode,
...
export const emptyConfig = {} as SteelEngineConfig;
