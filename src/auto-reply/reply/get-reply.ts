...
import { type SteelEngineConfig, getRuntimeConfig } from "../../config/config.js";
...
function resolveHeartbeatAckMaxChars(cfg: SteelEngineConfig, agentId: string): number {
...
function hasExplicitAudioUnderstandingConfig(cfg: SteelEngineConfig): boolean {
