...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bsteelengine\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "SteelEngine" },
        expected: "[SteelEngine]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "SteelEngine",
          provider: "anthropic",
          model: "claude-opus-4-6",
          thinkingLevel: "high",
        },
        expected: "[SteelEngine] anthropic/claude-opus-4-6 (think:high)",
      },
    ] as const;
