// Projects ACP runtime events into SteelEngine-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@steelengine/acp-core/runtime/types";
import {
