...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@recall", { botUsername: "recall" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@recall args", {
        botUsername: "recall",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "recall" })).toBe(
      "/help@otherbot",
    );
  });
