...
export function resolveSkillsInstallPreferences(config?: SteelEngineConfig): SkillsInstallPreferences {
...
const BUNDLED_SOURCES = new Set(["steelengine-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: SteelEngineConfig): ReadonlySet<string> | undefined {
