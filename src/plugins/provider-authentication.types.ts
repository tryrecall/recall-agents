...
export type ProviderAuthResult = {
   ...
   */
  configPatch?: Partial<SteelEngineConfig>;
  defaultModel?: string;
  notes?: string[];
  /**
...
export type ProviderAuthMethod = {
   ...
   * key + OAuth, or region-specific login flows). SteelEngine uses this to expose
...
export type ProviderOAuthProfileIdRepair = {
   ...
   *
   * When omitted, SteelEngine falls back to `<provider>:default`.
   */
