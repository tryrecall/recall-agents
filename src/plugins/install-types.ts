...
export const PLUGIN_INSTALL_ERROR_CODE = {
  ...
  MISSING_STEELENGINE_EXTENSIONS: "missing_steelengine_extensions",
  MISSING_PLUGIN_MANIFEST: "missing_plugin_manifest",
  EMPTY_STEELENGINE_EXTENSIONS: "empty_steelengine_extensions",
  INVALID_STEELENGINE_EXTENSIONS: "invalid_steelengine_extensions",
