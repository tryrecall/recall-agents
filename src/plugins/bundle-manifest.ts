/** Reads Codex/Claude/Cursor bundle manifests into SteelEngine plugin manifest metadata. */
...
type BundlePluginManifest = {
  ...
  // Only include hook roots that SteelEngine can execute via HOOK.md + handler files.
  hooks: string[];
