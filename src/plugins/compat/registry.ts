...
const CHANNEL_RUNTIME_SDK_SURFACE = ["steelengine/plugin-sdk/channel", "runtime"].join("-");
...
const DEPRECATED_PLUGIN_SDK_SUBPATH_SEEDS = [
  {
    ...
    replacement: "`steelengine/plugin-sdk/provider-setup`",
  },
  {
    ...
    owner: "sdk",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/runtime`",
  },
  {
    ...
    owner: "sdk",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/runtime` and `steelengine/plugin-sdk/secret-ref-runtime`",
  },
  {
    ...
    owner: "setup",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/setup-runtime`",
  },
  {
    ...
    replacement: "`steelengine/plugin-sdk/channel-outbound`",
  },
  {
    ...
    replacement:
      "`steelengine/plugin-sdk/plugin-config-runtime`, `steelengine/plugin-sdk/config-mutation`, `steelengine/plugin-sdk/runtime-config-snapshot`, and `steelengine/plugin-sdk/config-contracts`",
  },
  {
    ...
    owner: "config",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/config-contracts`",
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "plugin-local schemas with `steelengine/plugin-sdk/json-schema-runtime` for JSON Schema validation",
  },
  {
    ...
    owner: "channel",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/reply-runtime`",
  },
  {
    ...
    owner: "channel",
    removeAfter: "2026-08-15",
    replacement: "`steelengine/plugin-sdk/channel-inbound` and `steelengine/plugin-sdk/channel-outbound`",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-09-01",
    replacement:
      "focused subpaths including `steelengine/plugin-sdk/delivery-queue-runtime`, `steelengine/plugin-sdk/diagnostic-runtime`, `steelengine/plugin-sdk/error-runtime`, `steelengine/plugin-sdk/exec-approvals-runtime`, `steelengine/plugin-sdk/fetch-runtime`, and `steelengine/plugin-sdk/ssrf-runtime`",
  },
  {
    ...
    removeAfter: "2026-08-15",
    replacement:
      "`steelengine/plugin-sdk/logging-core`, `steelengine/plugin-sdk/text-chunking`, `steelengine/plugin-sdk/text-utility-runtime`, and `steelengine/plugin-sdk/string-coerce-runtime`",
  },
  {
    ...
    removeAfter: "2026-08-15",
    replacement:
      "`steelengine/plugin-sdk/channel-secret-basic-runtime` and `steelengine/plugin-sdk/channel-secret-tts-runtime`",
  },
  {
    ...
    owner: "config",
    removeAfter: "2026-08-15",
    replacement: "`steelengine/plugin-sdk/channel-config-schema`",
  },
  {
    ...
    owner: "channel",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/channel-inbound`",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "`steelengine/plugin-sdk/command-auth`, `steelengine/plugin-sdk/channel-plugin-common`, and `steelengine/plugin-sdk/reply-history`",
  },
  {
    ...
    owner: "channel",
    removeAfter: "2026-08-15",
    replacement: "`steelengine/plugin-sdk/run-command`",
  },
  {
  ...
  },
  {
    ...
    owner: "channel",
    removeAfter: "2026-09-01",
    replacement: "`steelengine/plugin-sdk/channel-outbound` and `steelengine/plugin-sdk/channel-inbound`",
  },
  {
  ...
  },
  {
    ...
    owner: "channel",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/channel-pairing`",
  },
  {
    ...
    owner: "channel",
    removeAfter: "2026-08-15",
    replacement: "`steelengine/plugin-sdk/channel-ingress-runtime`",
  },
  {
    ...
    owner: "provider",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/media-generation-runtime`",
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "`steelengine/plugin-sdk/music-generation` for public types and assets; plugin-owned provider runtime helpers for provider registration",
  },
  {
    ...
    owner: "sdk",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/memory-host-core`",
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "`steelengine/plugin-sdk/memory-host-search` for active search-manager lifecycle operations",
  },
  {
    ...
    owner: "sdk",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/memory-core-host-engine-embeddings`",
  },
  {
    ...
    owner: "sdk",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/memory-core-host-engine-qmd`",
  },
  {
    ...
    owner: "sdk",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/memory-host-events`",
  },
  {
    ...
    owner: "sdk",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/memory-core-host-runtime-files`",
  },
  {
    ...
    owner: "sdk",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/memory-core-host-status`",
  },
  {
    ...
    owner: "provider",
    removeAfter: "2026-07-30",
    replacement: "provider auth hooks built with `steelengine/plugin-sdk/provider-auth`",
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "plugin-owned endpoint detection using `steelengine/plugin-sdk/provider-http` for generic transport helpers",
  },
  {
  ...
  },
  {
    ...
    owner: "channel",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/webhook-ingress`",
  },
  {
    ...
    owner: "channel",
    removeAfter: "2026-07-30",
    replacement: "`steelengine/plugin-sdk/command-auth`",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-07-30",
    replacement:
      "`resolveAgentDir` or `resolveDefaultAgentDir` from `steelengine/plugin-sdk/agent-harness-runtime`",
  },
...
const DEPRECATED_PLUGIN_SDK_SUBPATH_RECORDS = DEPRECATED_PLUGIN_SDK_SUBPATH_SEEDS.map(
  ({ code, subpath, owner, removeAfter, replacement }) => ({
    ...
    surfaces: [`steelengine/plugin-sdk/${subpath}`],
    diagnostics: [
...
const UNUSED_PUBLIC_PLUGIN_SDK_SUBPATH_RECORDS = UNUSED_PUBLIC_PLUGIN_SDK_SUBPATHS.map(
  (subpath) => ({
    ...
    tests: ["src/plugins/compat/registry.test.ts"],
    releaseNote: `The public \`steelengine/plugin-sdk/${subpath}\` subpath has no known consumers and is scheduled for removal without a successor.`,
  }),
) satisfies readonly PluginCompatRecord[];
...
const BUNDLED_ONLY_PUBLIC_PLUGIN_SDK_SUBPATH_RECORDS = BUNDLED_ONLY_PUBLIC_PLUGIN_SDK_SUBPATHS.map(
  (subpath) => ({
    ...
    tests: ["src/plugins/compat/registry.test.ts"],
    releaseNote: `Only the public export for \`steelengine/plugin-sdk/${subpath}\` is retiring; the module stays available for bundled plugins as a private-local-only subpath.`,
  }),
) satisfies readonly PluginCompatRecord[];
...
const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "steelengine/plugin-sdk/memory-core-host-engine-embeddings registerMemoryEmbeddingProvider",
  ...
  },
  {
    ...
    surfaces: [
      "steelengine/plugin-sdk/session-store-runtime loadSessionStore",
      "steelengine/plugin-sdk/session-store-runtime updateSessionStore",
      "steelengine/plugin-sdk/session-store-runtime resolveSessionFilePath",
      "steelengine/plugin-sdk/session-store-runtime resolveSessionStoreEntry",
    ],
  ...
  },
  {
    ...
    warningStarts: "2026-04-24",
    removeAfter: "2026-07-24",
    replacement: "focused `steelengine/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["steelengine/plugin-sdk", "steelengine/plugin-sdk/compat"],
    diagnostics: ["STEELENGINE_PLUGIN_SDK_COMPAT_DEPRECATED"],
    tests: [
  ...
  },
  {
    ...
    surfaces: [
      "@steelengine/whatsapp WebInboundMessage flat fields",
  ...
  },
  {
    ...
    docsPath: "/plugins/compatibility",
    surfaces: [
      "@steelengine/whatsapp WebInboundMessage top-level admission fields",
      "WhatsApp monitorWebInbox onMessage callback",
      "WhatsApp monitorWebChannel listenerFactory injected messages",
    ],
  ...
  },
  {
    ...
    surfaces: [
      "steelengine/plugin-sdk/discord component message helpers",
      "steelengine/plugin-sdk/telegram-account resolveTelegramAccount",
    ],
  ...
  },
  {
    ...
    replacement:
      "`steelengine/plugin-sdk/bundled-channel-config-schema` for maintained bundled plugins; plugin-local schemas for third-party plugins",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["steelengine/plugin-sdk/channel-config-schema-legacy"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-28",
    replacement:
      "focused `steelengine/plugin-sdk/*` test subpaths such as `plugin-test-runtime`, `channel-test-helpers`, `test-env`, and `test-fixtures`",
    docsPath: "/plugins/sdk-migration#private-testing-barrel",
    surfaces: ["steelengine/plugin-sdk/testing"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/compat/registry.test.ts"],
    releaseNote:
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "steelengine/plugin-sdk/channel-route channelRouteIdentityKey",
      "steelengine/plugin-sdk/channel-route channelRouteKey",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "steelengine/plugin-sdk/channel-route ChannelRouteExplicitTarget",
      "steelengine/plugin-sdk/channel-route ChannelRouteExplicitTargetParser",
      "steelengine/plugin-sdk/channel-route resolveChannelRouteTargetWithParser",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    warningStarts: "2026-05-23",
    removeAfter: "2026-08-23",
    replacement: "`steelengine/plugin-sdk/channel-targets`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["steelengine/plugin-sdk/messaging-targets"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
      "src/plugins/compat/registry.test.ts",
      "src/plugins/contracts/plugin-sdk-subpaths.test.ts",
  ...
  },
  {
    ...
    surfaces: ["steelengine.plugin.json providerAuthEnvVars", "provider setup"],
  ...
  },
  {
    ...
    docsPath: "/plugins/manifest",
    surfaces: ["steelengine.plugin.json channelEnvVars", "channel setup"],
    diagnostics: ["manifest compatibility diagnostic"],
    tests: [
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`steelengine/plugin-sdk/agent-runtime`",
    docsPath: "/plugins/sdk-agent-harness",
    surfaces: ["steelengine/plugin-sdk/agent-harness", "steelengine/plugin-sdk/agent-harness-runtime"],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    surfaces: [
      ...
      "steelengine/extension-api runEmbeddedPiAgent",
      "steelengine/plugin-sdk/agent-harness-runtime EmbeddedPi* aliases",
    ],
    diagnostics: ["plugin SDK compatibility registry"],
    tests: [
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`steelengine plugins registry --refresh` and `steelengine doctor --fix`",
    docsPath: "/cli/plugins#registry",
    surfaces: ["STEELENGINE_DISABLE_PERSISTED_PLUGIN_REGISTRY", "plugin registry reads"],
  ...
  },
  {
    ...
    docsPath: "/cli/plugins#registry",
    surfaces: [
      "STEELENGINE_DISABLE_PLUGIN_REGISTRY_MIGRATION",
      "STEELENGINE_FORCE_PLUGIN_REGISTRY_MIGRATION",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`steelengine.channel.exposure` metadata",
    docsPath: "/plugins/sdk-setup",
    surfaces: ["steelengine.channel.showConfigured", "steelengine.channel.showInSetup"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "focused channel SDK subpaths, especially `steelengine/plugin-sdk/channel-runtime-context`",
    docsPath: "/plugins/sdk-migration",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`steelengine/plugin-sdk/command-status`",
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "steelengine/plugin-sdk/command-auth buildCommandsMessage",
      "steelengine/plugin-sdk/command-auth buildCommandsMessagePaginated",
      "steelengine/plugin-sdk/command-auth buildHelpMessage",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`SteelEngineConfig`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["steelengine/plugin-sdk `ClawdbotConfig` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    code: "steelengine-schema-type-alias",
    status: "deprecated",
    owner: "sdk",
    introduced: "2026-04-26",
    deprecated: "2026-04-26",
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`SteelEngineConfig` from `steelengine/plugin-sdk/config-schema`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["steelengine/plugin-sdk `SteelEngineSchemaType` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "injected `api.runtime.*` helpers or focused `steelengine/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["steelengine/extension-api"],
    diagnostics: ["STEELENGINE_EXTENSION_API_DEPRECATED"],
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "steelengine/plugin-sdk/channel-actions createMessageToolButtonsSchema",
      "steelengine/plugin-sdk/channel-actions createMessageToolCardSchema",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "steelengine/plugin-sdk/channel-inbound resolveMentionGating",
      "steelengine/plugin-sdk/channel-inbound resolveMentionGatingWithBypass",
      "steelengine/plugin-sdk/channel-mention-gating resolveMentionGating",
      "steelengine/plugin-sdk/channel-mention-gating resolveMentionGatingWithBypass",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-provider-plugins",
    surfaces: ["steelengine/plugin-sdk/provider-web-search createPluginBackedWebSearchProvider"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "focused `steelengine/plugin-sdk/*` test subpaths",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["steelengine/plugin-sdk/test-utils"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
      "src/plugins/compat/registry.test.ts",
      "src/plugins/contracts/plugin-sdk-subpaths.test.ts",
