...
const CHANNEL_RUNTIME_SDK_SURFACE = ["recall/plugin-sdk/channel", "runtime"].join("-");
...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    warningStarts: "2026-04-24",
    removeAfter: "2026-07-24",
    replacement: "focused `recall/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["recall/plugin-sdk", "recall/plugin-sdk/compat"],
    diagnostics: ["RECALL_PLUGIN_SDK_COMPAT_DEPRECATED"],
    tests: [
  ...
  },
  {
    ...
    surfaces: [
      "recall/plugin-sdk/discord component message helpers",
      "recall/plugin-sdk/telegram-account resolveTelegramAccount",
    ],
  ...
  },
  {
    ...
    replacement:
      "`recall/plugin-sdk/bundled-channel-config-schema` for maintained bundled plugins; plugin-local schemas for third-party plugins",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["recall/plugin-sdk/channel-config-schema-legacy"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-28",
    replacement:
      "focused `recall/plugin-sdk/*` test subpaths such as `plugin-test-runtime`, `channel-test-helpers`, `test-env`, and `test-fixtures`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["recall/plugin-sdk/testing"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "recall/plugin-sdk/channel-route channelRouteIdentityKey",
      "recall/plugin-sdk/channel-route channelRouteKey",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    surfaces: ["recall.plugin.json providerAuthEnvVars", "provider setup"],
  ...
  },
  {
    ...
    docsPath: "/plugins/manifest",
    surfaces: ["recall.plugin.json channelEnvVars", "channel setup"],
    diagnostics: ["manifest compatibility diagnostic"],
    tests: [
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`recall/plugin-sdk/agent-runtime`",
    docsPath: "/plugins/sdk-agent-harness",
    surfaces: ["recall/plugin-sdk/agent-harness", "recall/plugin-sdk/agent-harness-runtime"],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`recall plugins registry --refresh` and `recall doctor --fix`",
    docsPath: "/cli/plugins#registry",
    surfaces: ["RECALL_DISABLE_PERSISTED_PLUGIN_REGISTRY", "plugin registry reads"],
  ...
  },
  {
    ...
    docsPath: "/cli/plugins#registry",
    surfaces: [
      "RECALL_DISABLE_PLUGIN_REGISTRY_MIGRATION",
      "RECALL_FORCE_PLUGIN_REGISTRY_MIGRATION",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`recall.channel.exposure` metadata",
    docsPath: "/plugins/sdk-setup",
    surfaces: ["recall.channel.showConfigured", "recall.channel.showInSetup"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "focused channel SDK subpaths, especially `recall/plugin-sdk/channel-runtime-context`",
    docsPath: "/plugins/sdk-migration",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`recall/plugin-sdk/command-status`",
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "recall/plugin-sdk/command-auth buildCommandsMessage",
      "recall/plugin-sdk/command-auth buildCommandsMessagePaginated",
      "recall/plugin-sdk/command-auth buildHelpMessage",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`RecallConfig`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["recall/plugin-sdk `ClawdbotConfig` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    code: "recall-schema-type-alias",
    status: "deprecated",
    owner: "sdk",
    introduced: "2026-04-26",
    deprecated: "2026-04-26",
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`RecallConfig` from `recall/plugin-sdk/config-schema`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["recall/plugin-sdk `RecallSchemaType` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "injected `api.runtime.*` helpers or focused `recall/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["recall/extension-api"],
    diagnostics: ["RECALL_EXTENSION_API_DEPRECATED"],
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "recall/plugin-sdk/channel-actions createMessageToolButtonsSchema",
      "recall/plugin-sdk/channel-actions createMessageToolCardSchema",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "recall/plugin-sdk/channel-inbound resolveMentionGating",
      "recall/plugin-sdk/channel-inbound resolveMentionGatingWithBypass",
      "recall/plugin-sdk/channel-mention-gating resolveMentionGating",
      "recall/plugin-sdk/channel-mention-gating resolveMentionGatingWithBypass",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-provider-plugins",
    surfaces: ["recall/plugin-sdk/provider-web-search createPluginBackedWebSearchProvider"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "focused `recall/plugin-sdk/*` test subpaths",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["recall/plugin-sdk/test-utils"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
      "src/plugins/compat/registry.test.ts",
      "src/plugins/contracts/plugin-sdk-subpaths.test.ts",
