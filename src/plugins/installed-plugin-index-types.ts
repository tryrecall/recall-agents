...
import type { SteelEnginePackageBuild, PluginPackageChannel } from "./manifest.js";
...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by SteelEngine from plugin manifests, install records, and config policy. Use `steelengine plugins registry --refresh`, `steelengine plugins install/update/uninstall`, or `steelengine plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored steelengine.install metadata. This describes catalog/package
