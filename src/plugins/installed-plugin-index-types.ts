...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Recall from plugin manifests, install records, and config policy. Use `recall plugins registry --refresh`, `recall plugins install/update/uninstall`, or `recall plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored recall.install metadata. This describes catalog/package
