...
describe("normalizePluginsConfig", () => {
  ...
  it("normalizes unknown plugin ids without consulting discovery", async () => {
    const discoverPlugins = vi.spyOn(discovery, "discoverSteelEnginePlugins");
  ...
  it("does not consult discovery or manifests for alias lookup", async () => {
    const discoverPlugins = vi.spyOn(discovery, "discoverSteelEnginePlugins").mockReturnValue({
      candidates: [
        {
          idHint: "anthropic",
          source: "/tmp/steelengine-bundled-anthropic/index.js",
          rootDir: "/tmp/steelengine-bundled-anthropic",
          origin: "bundled",
          bundledManifest: {
            id: "anthropic",
            configSchema: {},
        ...
        },
        {
          ...
          source: "/tmp/steelengine-global-anthropic/index.js",
          rootDir: "/tmp/steelengine-global-anthropic",
          origin: "global",
        },
      ],
      diagnostics: [],
    ...
    const loadManifest = vi.spyOn(manifest, "loadPluginManifest").mockReturnValue({
      ok: true,
      manifestPath: "/tmp/steelengine-global-anthropic/steelengine.plugin.json",
      manifest: {
