...
export type RecallPluginActiveModelContext = {
  provider?: string;
  modelId?: string;
  modelRef?: string;
};
...
export type RecallPluginToolContext = {
   ...
   * the local operator, installed plugin code, or a modified Recall runtime.
   */
  activeModel?: RecallPluginActiveModelContext;
  browser?: {
