...
export type SteelEnginePluginActiveModelContext = {
  provider?: string;
  modelId?: string;
  modelRef?: string;
};
...
export type SteelEnginePluginToolContext = {
   ...
   * the local operator, installed plugin code, or a modified SteelEngine runtime.
   */
  activeModel?: SteelEnginePluginActiveModelContext;
  browser?: {
...
export type SteelEnginePluginToolFactory = (
  ctx: SteelEnginePluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type SteelEnginePluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type SteelEnginePluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
