...
export function applyGoogleGeminiModelDefault(cfg: RecallConfig): {
  next: RecallConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: RecallConfig): RecallConfig {
...
export function applyOpenAIConfig(cfg: RecallConfig): RecallConfig {
...
export function applyOpencodeGoModelDefault(cfg: RecallConfig): {
  next: RecallConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: RecallConfig): {
  next: RecallConfig;
  changed: boolean;
} {
