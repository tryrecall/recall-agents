...
import type { RecallPluginService, RecallPluginServiceContext } from "./types.js";
...
function expectServiceLogger(ctx: RecallPluginServiceContext) {
...
function expectServiceContexts(
  contexts: RecallPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: RecallPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: RecallPluginServiceContext[] = [];
    ...
    const officialInstallContexts: RecallPluginServiceContext[] = [];
    ...
    const untrustedContexts: RecallPluginServiceContext[] = [];
    ...
    const spoofedContexts: RecallPluginServiceContext[] = [];
