...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  [bundledPluginFile({
    ...
    'export type { SteelEnginePluginServiceContext } from "./api.js";',
  ],
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin } from "steelengine/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "steelengine/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "steelengine/plugin-sdk/channel-config-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiSteelEngineConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [bundledPluginFile({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "steelengine/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema, GoogleChatConfigSchema } from "./config-api.js";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "steelengine/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "steelengine/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "steelengine/plugin-sdk/channel-outbound";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "steelengine/plugin-sdk/runtime-group-policy";',
    ...
    'export type { GoogleChatAccountConfig, GoogleChatConfig } from "steelengine/plugin-sdk/config-contracts";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "steelengine/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "steelengine/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]: [
    ...
    'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "steelengine/plugin-sdk/allow-from";',
    'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "steelengine/plugin-sdk/channel-contract";',
    ...
    'export { createChannelMessageReplyPipeline } from "steelengine/plugin-sdk/channel-outbound";',
    'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "steelengine/plugin-sdk/channel-status";',
    'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "steelengine/plugin-sdk/channel-targets";',
    'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsCloudName, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, SteelEngineConfig } from "steelengine/plugin-sdk/config-contracts";',
    'export { isDangerousNameMatchingEnabled } from "steelengine/plugin-sdk/dangerous-name-runtime";',
    ...
    'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension, resolveChannelMediaMaxBytes } from "steelengine/plugin-sdk/media-runtime";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "steelengine/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext } from "steelengine/plugin-sdk/channel-contract";',
    'export type { SteelEngineConfig } from "steelengine/plugin-sdk/config-contracts";',
  ...
  [bundledPluginFile({
    ...
    'export { createChannelPairingController } from "steelengine/plugin-sdk/channel-pairing";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, SteelEngineConfig } from "steelengine/plugin-sdk/config-contracts";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "steelengine/plugin-sdk/runtime-group-policy";',
    'export { createChannelMessageReplyPipeline } from "steelengine/plugin-sdk/channel-outbound";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { SteelEnginePluginService, SteelEnginePluginServiceContext, PluginLogger } from "steelengine/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "steelengine/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "steelengine/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "steelengine/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "steelengine/plugin-sdk/channel-plugin-common";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "steelengine/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "steelengine/plugin-sdk/channel-actions";',
      ...
      'export type { ChannelPlugin } from "steelengine/plugin-sdk/channel-core";',
      'export type { SteelEngineConfig } from "steelengine/plugin-sdk/config-contracts";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeSteelEngineConfig["channels"]>["telegram"] >;',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "steelengine/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "steelengine/plugin-sdk/channel-core";',
  ...
  [bundledPluginFile({
    ...
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText } from "steelengine/plugin-sdk/webhook-request-guards";',
    ...
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "steelengine/plugin-sdk/tts-runtime";',
...
describe("runtime api guardrails", () => {
  ...
  it("keeps bundled runtime api barrels off their own branded sdk facades", () => {
    for (const [pluginId, rootDir] of getBundledPluginRoots().entries()) {
      ...
      ).not.toContain(`"steelengine/plugin-sdk/${pluginId}"`);
      expect(
        source,
        `${pluginId} runtime api should use generic sdk subpaths or local exports`,
      ).not.toContain(`'steelengine/plugin-sdk/${pluginId}'`);
