...
import type { ClawdbotConfig, RecallConfig, RecallSchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<ClawdbotConfig>().toEqualTypeOf<RecallConfig>();
    expectTypeOf<RecallSchemaType>().toEqualTypeOf<RecallConfig>();
  });
