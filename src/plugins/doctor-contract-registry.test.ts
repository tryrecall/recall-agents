...
function makeTempDir(): string {
  return makeTrackedTempDir("steelengine-doctor-contract-registry", tempDirs);
}
...
describe("doctor-contract-registry module loader", () => {
  ...
  it("loads config-derived session-store agent IDs from doctor contract modules", () => {
    ...
    mocks.loadPluginManifestRegistry.mockReturnValue({
      plugins: [{ id: "test-plugin", packageName: "@steelengine/demo", rootDir: pluginRoot }],
      diagnostics: [],
    });
