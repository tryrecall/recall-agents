...
import { relinkRecallPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: RecallConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: RecallConfig = {
    ...
    channels: channels as RecallConfig["channels"],
  };
