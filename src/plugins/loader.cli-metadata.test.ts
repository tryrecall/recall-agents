...
import { loadRecallPluginCliRegistry, loadRecallPlugins } from "./loader.js";
import {
...
describe("plugin loader CLI metadata", () => {
  it.each([
    ...
    async ({ id, kind, error }) => {
      ...
      const registry = await loadRecallPluginCliRegistry({
        cache: false,
        logger: {
          info: () => {},
          warn: () => {},
  ...
  register(api) {
    ...
    const registry = await loadRecallPluginCliRegistry({
      env: { ...process.env, RECALL_STATE_DIR: stateDir },
      logger: {
        info: () => {},
  ...
  it("uses the real channel entry in cli-metadata mode for CLI metadata capture", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@recall/cli-metadata-channel",
          recall: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("skips bundled channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@recall/bundled-skip-channel",
...
module.exports = {
  ...
  it("prefers bundled channel cli-metadata entries over full channel entries", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@recall/bundled-cli-channel",
          recall: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("skips bundled non-channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@recall/bundled-skip-provider",
          recall: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during full plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@recall/full-cli-metadata-channel",
          recall: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during discovery plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@recall/discovery-cli-metadata-channel",
          recall: { extensions: ["./index.cjs"] },
        },
        null,
        2,
