...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.recall.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.recall.js").RecallConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.recall.js").RecallConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.recall.js").RecallConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.recall.js").RecallConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.recall.js").RecallConfig,
