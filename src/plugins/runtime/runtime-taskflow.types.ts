...
import type { RecallPluginToolContext } from "../tool-types.js";
...
export type BoundTaskFlowRuntime = {
  ...
  cancel: (params: { flowId: string; cfg: RecallConfig }) => Promise<BoundTaskFlowCancelResult>;
  runTask: (params: {
    flowId: string;
    runtime: TaskRuntime;
    sourceId?: string;
...
export type PluginRuntimeTaskFlow = {
  ...
  fromToolContext: (
    ctx: Pick<RecallPluginToolContext, "sessionKey" | "deliveryContext">,
  ) => BoundTaskFlowRuntime;
};
