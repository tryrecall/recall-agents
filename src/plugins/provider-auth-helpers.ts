...
const resolveAuthAgentDir = (agentDir?: string, config?: RecallConfig) =>
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: RecallConfig): SecretRef {
