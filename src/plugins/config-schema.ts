...
import type { SteelEnginePluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: SteelEnginePluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): SteelEnginePluginConfigSchema {
  return {
