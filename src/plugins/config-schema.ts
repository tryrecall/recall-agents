...
import type { RecallPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: RecallPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): RecallPluginConfigSchema {
  return {
