...
export type RecallPluginToolContext = {
  config?: RecallConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type RecallPluginToolFactory = (
  ctx: RecallPluginToolContext,
...
export type RecallPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: RecallConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: RecallConfig, value: unknown) => void;
  applySelectionConfig?: (config: RecallConfig) => RecallConfig;
...
export type RecallPluginDefinition = {
  ...
  register?: (api: RecallPluginApi) => void | Promise<void>;
  activate?: (api: RecallPluginApi) => void | Promise<void>;
};

export type RecallPluginModule =
  | RecallPluginDefinition
  | ((api: RecallPluginApi) => void | Promise<void>);
...
export type RecallPluginApi = {
  ...
  registerCli: (registrar: RecallPluginCliRegistrar, opts?: { commands?: string[] }) => void;
...
export type PluginFormat = "recall" | "bundle";
