...
vi.mock("../discovery.js", () => ({
  discoverRecallPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverRecallPlugins>
  ) => registryJitiMocks.discoverRecallPlugins(...args),
}));
