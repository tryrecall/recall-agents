...
const registryJitiMocks = vi.hoisted(() => ({
  createJiti: vi.fn(),
  discoverSteelEnginePlugins: vi.fn(),
...
vi.mock("../discovery.js", () => ({
  discoverSteelEnginePlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverSteelEnginePlugins>
  ) => registryJitiMocks.discoverSteelEnginePlugins(...args),
}));
...
export function resetRegistryJitiMocks(): void {
  ...
  registryJitiMocks.discoverSteelEnginePlugins.mockReset();
  registryJitiMocks.loadPluginManifestRegistry.mockReset();
  registryJitiMocks.loadPluginRegistrySnapshot.mockReset();
  registryJitiMocks.discoverSteelEnginePlugins.mockReturnValue({
    candidates: [],
    diagnostics: [],
  });
