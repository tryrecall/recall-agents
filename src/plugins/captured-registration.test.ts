...
import type { AnyAgentTool, SteelEnginePluginApi } from "./types.js";
...
describe("captured plugin registration", () => {
  ...
  it("returns synthetic scheduled-turn ids independent of human-readable names", async () => {
    let scheduleSessionTurn: SteelEnginePluginApi["scheduleSessionTurn"] | undefined;
    let registerSessionSchedulerJob: SteelEnginePluginApi["registerSessionSchedulerJob"] | undefined;
    const captured = capturePluginRegistration({
