...
import type { AnyAgentTool, RecallPluginApi } from "./types.js";
...
describe("captured plugin registration", () => {
  ...
  it("returns synthetic scheduled-turn ids independent of human-readable names", async () => {
    let scheduleSessionTurn: RecallPluginApi["scheduleSessionTurn"] | undefined;
    let registerSessionSchedulerJob: RecallPluginApi["registerSessionSchedulerJob"] | undefined;
    const captured = capturePluginRegistration({
