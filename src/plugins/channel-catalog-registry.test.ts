...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/recall-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/recall-weixin@2.3.7",
    installPath:
      "/tmp/recall-test-home/.recall/npm/node_modules/@tencent-weixin/recall-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverRecallPlugins: discoverSpy }));
