...
import type { SteelEnginePluginApi, PluginLogger, PluginRegistrationMode } from "./types.js";
          ...
          ? {
              ...
              enqueueNextTurnInjection: (injection) => {
                ...
                return enqueuePluginNextTurnInjection({
                  cfg: registryParams.runtime.config.current() as SteelEngineConfig,
                  pluginId: record.id,
              ...
              sendSessionAttachment: async (attachment) => {
                ...
                try {
                  ...
                  const runtimeConfig =
                    (registryParams.runtime.config?.current?.() as SteelEngineConfig | undefined) ??
                    params.config;
