/** Tests bundle manifest parsing for Codex, Claude, Cursor, and SteelEngine formats. */
...
function makeTempDir() {
  return makeTrackedTempDir("steelengine-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat steelengine.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "steelengine.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
