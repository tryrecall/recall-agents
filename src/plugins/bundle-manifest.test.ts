...
function makeTempDir() {
  return makeTrackedTempDir("recall-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat recall.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "recall.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
