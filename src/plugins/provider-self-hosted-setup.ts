...
export function applyProviderDefaultModel(cfg: SteelEngineConfig, modelRef: string): SteelEngineConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: SteelEngineConfig; modelId: string; modelRef: string; profileId: string } {
