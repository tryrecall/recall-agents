...
export function applyProviderDefaultModel(cfg: RecallConfig, modelRef: string): RecallConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: RecallConfig; modelId: string; modelRef: string; profileId: string } {
