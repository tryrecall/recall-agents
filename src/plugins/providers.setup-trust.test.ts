...
function makeTempDir() {
  return makeTrackedTempDir("steelengine-provider-setup-trust", tempDirs);
}
...
function writeWorkspaceProviderPlugin(params: {
  ...
  const pluginDir = path.join(params.workspaceDir, ".steelengine", "extensions", params.pluginId);
