...
const PLUGIN_SOURCE_ROOTS = {
  stock: path.resolve(path.sep, "opt", "homebrew", "lib", "node_modules", "recall", "extensions"),
  global: path.resolve(path.sep, "Users", "x", ".recall", "extensions"),
  workspace: path.resolve(path.sep, "Users", "x", "ws", ".recall", "extensions"),
};
