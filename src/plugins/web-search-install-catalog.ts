...
function getConfigPath(config: SteelEngineConfig | undefined, path: string): unknown {
...
function setConfigPath(target: SteelEngineConfig, path: string, value: unknown): void {
