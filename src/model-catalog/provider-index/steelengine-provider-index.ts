// Bundled SteelEngine provider index advertises pre-install provider metadata for model picker discovery.
import type { SteelEngineProviderIndex } from "./types.js";

// SteelEngine-owned preview metadata for providers whose plugins may not be
...
export const STEELENGINE_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
...
} satisfies SteelEngineProviderIndex;
