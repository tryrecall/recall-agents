...
function resolveHeartbeatConfig(cfg: RecallConfig, agentId: string): HeartbeatConfig | undefined {
...
function listHeartbeatDoctorAgents(cfg: RecallConfig) {
 ...
 */
export function describeHeartbeatSessionTargetIssues(cfg: RecallConfig): string[] {
