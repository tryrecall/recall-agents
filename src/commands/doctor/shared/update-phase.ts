...
export const UPDATE_IN_PROGRESS_ENV = "STEELENGINE_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "STEELENGINE_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `STEELENGINE_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `STEELENGINE_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
