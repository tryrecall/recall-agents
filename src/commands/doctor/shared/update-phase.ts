...
export const UPDATE_IN_PROGRESS_ENV = "RECALL_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "RECALL_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `RECALL_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `RECALL_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
