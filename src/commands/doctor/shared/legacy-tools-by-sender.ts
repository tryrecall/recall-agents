...
export function scanLegacyToolsBySenderKeys(cfg: SteelEngineConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: SteelEngineConfig): {
