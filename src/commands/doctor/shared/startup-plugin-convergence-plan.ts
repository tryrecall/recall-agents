...
function hasPotentialPluginConfig(config: SteelEngineConfig, env: NodeJS.ProcessEnv): boolean {
...
function collectConfiguredMemoryEmbeddingProviderIds(config: SteelEngineConfig): ReadonlySet<string> {
...
function hasConfiguredCapabilityPlugin(config: SteelEngineConfig, env: NodeJS.ProcessEnv): boolean {
