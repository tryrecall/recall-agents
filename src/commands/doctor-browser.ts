...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: SteelEngineConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: SteelEngineConfig, deps?: BrowserDoctorDeps) {
  try {
