...
export function resetCleanupCommandMocks() {
  ...
  resolveCleanupPlanFromDisk.mockReturnValue({
    ...
    configPath: "/tmp/.steelengine/steelengine.json",
    oauthDir: "/tmp/.steelengine/credentials",
    configInsideState: true,
    oauthInsideState: true,
    workspaceDirs: ["/tmp/.steelengine/workspace"],
  });
  removePath.mockResolvedValue({ ok: true });
  listAgentSessionDirs.mockResolvedValue(["/tmp/.steelengine/agents/main/sessions"]);
