...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `steelengine doctor --fix`.";
    case "module-missing":
      return "Fix: run `steelengine doctor --fix`.";
    case "service-missing":
      return "Fix: run `steelengine gateway install --force`.";
    case "service-stopped":
      return "Fix: run `steelengine gateway restart`.";
    case "startup-blocked":
      return "Fix: run `steelengine gateway status --deep`.";
    case "not-listening":
      return "Fix: start `steelengine gateway run`, or run `steelengine gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
