      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run recall plugins install @recall/feishu or recall doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run recall doctor --fix",
        },
      ],
      details: [],
    });
