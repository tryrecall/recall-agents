...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://steelengine.local")).toBe("https://steelengine.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://steelengine.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: steelengine security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://steelengine.local" },
      ...
      { Item: "Security", Value: "Run: steelengine security audit --deep" },
