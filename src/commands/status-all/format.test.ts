...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://recall.local")).toBe("https://recall.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://recall.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: recall security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://recall.local" },
      ...
      { Item: "Security", Value: "Run: recall security audit --deep" },
