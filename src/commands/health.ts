...
async function inspectHealthAccount(plugin: ChannelPlugin, cfg: RecallConfig, accountId: string) {
  return (
...
export async function healthCommand(
  opts: { json?: boolean; timeoutMs?: number; verbose?: boolean; config?: RecallConfig },
  runtime: RuntimeEnv,
) {
