...
function resolveConfiguredCommandOwners(cfg: SteelEngineConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: SteelEngineConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: SteelEngineConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("steelengine config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
