...
function resolveDefaultAccountId(cfg: RecallConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: RecallConfig): boolean {
...
export function summarizeBindings(cfg: RecallConfig, bindings: AgentBinding[]): string[] {
