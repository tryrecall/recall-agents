...
export const MIGRATION_SELECTION_ACCEPT = "__steelengine_migrate_accept_recommended__";
export const MIGRATION_SELECTION_TOGGLE_ALL_ON = "__steelengine_migrate_toggle_all_on__";
export const MIGRATION_SELECTION_TOGGLE_ALL_OFF = "__steelengine_migrate_toggle_all_off__";
