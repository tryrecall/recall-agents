...
vi.mock("./status.summary.runtime.js", () => ({
  statusSummaryRuntime: {
    ...
    resolveSessionRuntimeLabel: vi.fn(() => "SteelEngine Default"),
    ...
    setActiveDegradedPlugins([
      ...
      },
      {
        ...
        diagnostic: {
          ...
          detail:
            "/private/plugins/peer-plugin/node_modules/steelengine points to /private/other/steelengine instead of /private/host/steelengine",
