// Fast `steelengine status --json` scan policy.
...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: SteelEngineConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: SteelEngineConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: SteelEngineConfig): boolean {
