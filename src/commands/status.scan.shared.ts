...
function hasExplicitMemorySearchConfig(cfg: SteelEngineConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: SteelEngineConfig): MemoryPluginStatus {
