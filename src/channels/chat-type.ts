 ...
 *
 * Maps channel-specific direct/group/channel labels into SteelEngine chat types.
 */
...
/**
 * Normalizes channel-specific chat type labels into SteelEngine conversation kinds.
 */
