...
export type ChannelMessageSendTextContext<TConfig = SteelEngineConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = SteelEngineConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = SteelEngineConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = SteelEngineConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = SteelEngineConfig> =
...
type ChannelMessageSendFailureContext<TConfig = SteelEngineConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = SteelEngineConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
...
export type ChannelMessageDeferredDeliveryAdmissionContext<TConfig = SteelEngineConfig> = {
  cfg: TConfig;
  channel: string;
  to: string;
  accountId?: string | null;
