...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: SteelEngineConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: SteelEngineConfig }>(
  collector: WarningCollector<{ cfg: SteelEngineConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: SteelEngineConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: SteelEngineConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: SteelEngineConfig },
>(
  projectCfg: (cfg: SteelEngineConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: SteelEngineConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: SteelEngineConfig },
>(params: {
  providerConfigPresent: (cfg: SteelEngineConfig) => boolean;
