...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: RecallConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: RecallConfig }>(
  collector: WarningCollector<{ cfg: RecallConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: RecallConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: RecallConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: RecallConfig },
>(
  projectCfg: (cfg: RecallConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: RecallConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: RecallConfig },
>(params: {
  providerConfigPresent: (cfg: RecallConfig) => boolean;
