...
export function listChannelMessageActions(cfg: RecallConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: RecallConfig): ChannelMessageCapability[] {
