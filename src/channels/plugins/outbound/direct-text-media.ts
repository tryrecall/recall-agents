...
import { sendTextMediaPayload } from "recall/plugin-sdk/reply-payload";
...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: RecallConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: RecallConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: string) {
  return (params: { cfg: RecallConfig; accountId?: string | null }) =>
