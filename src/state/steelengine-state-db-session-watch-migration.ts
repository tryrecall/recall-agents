...
import { ensureColumn, tableExists, tableHasColumn } from "./steelengine-state-db-schema-helpers.js";
...
type SessionWatchCursorDatabase = Pick<SteelEngineStateKyselyDatabase, "session_watch_cursors">;
