// Removes transient runtime state from restorable SteelEngine database snapshots.
...
export function sanitizeSteelEngineStateLeaseRows(database: DatabaseSync): void {
...
export function sanitizeSteelEngineGlobalStateSnapshot(database: DatabaseSync): void {
