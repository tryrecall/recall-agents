...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `steelengine/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `steelengine/plugin-sdk/channel-ingress-runtime`. */
