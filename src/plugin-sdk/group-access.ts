...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `recall/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `recall/plugin-sdk/channel-ingress-runtime`. */
