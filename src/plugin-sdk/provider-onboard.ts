...
export type { RecallConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: RecallConfig, ...args: TArgs) => RecallConfig;
  applyConfig: (cfg: RecallConfig, ...args: TArgs) => RecallConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: RecallConfig, preset: TParams) => RecallConfig;
  primaryModelRef: string;
