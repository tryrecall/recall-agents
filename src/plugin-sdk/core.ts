...
import type { SteelEnginePluginApi } from "../plugins/types.js";
...
export type { SteelEnginePluginGatewayEventScope } from "../plugins/gateway-events.js";
export type { SteelEnginePluginGatewayEvents } from "../plugins/gateway-events.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: SteelEngineConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
