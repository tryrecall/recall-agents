...
/** @deprecated Use RecallConfig instead */
export type { RecallConfig as ClawdbotConfig } from "../config/config.js";
/** @deprecated Use RecallConfig instead */
export type { RecallConfig as RecallSchemaType } from "../config/config.js";
export type {
