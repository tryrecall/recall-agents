...
type EnsureAuthProfileStore =
  typeof import("recall/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("recall/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("recall/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<typeof import("recall/plugin-sdk/provider-auth")>(
        "recall/plugin-sdk/provider-auth",
      );
      return {
        ...actual,
