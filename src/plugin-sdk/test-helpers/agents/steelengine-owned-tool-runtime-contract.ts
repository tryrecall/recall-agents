// SteelEngine-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installSteelEngineOwnedToolHooks(params?: {
 ...
 * Pair with `installSteelEngineOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetSteelEngineOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
