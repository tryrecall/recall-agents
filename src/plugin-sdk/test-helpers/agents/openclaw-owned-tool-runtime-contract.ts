...
export function installRecallOwnedToolHooks(params?: {
 ...
 * Pair with `installRecallOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetRecallOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
