...
export const toolPluginMetadataSymbol = Symbol.for("steelengine.plugin-sdk.tool-plugin.metadata");

/** Runtime context supplied to a concrete tool plugin execution handler. */
export type ToolPluginExecutionContext = {
  /** Plugin runtime API for tool implementations that need SteelEngine services. */
...
export type ToolPluginFactoryContext<TConfig> = {
  ...
  toolContext: SteelEnginePluginToolContext;
};
