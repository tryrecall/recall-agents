...
/**
 * @deprecated Compatibility facade for the `steelengine/plugin-sdk/discord` subpath.
...
export type { SteelEnginePluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
/** Discord channel config shape for one account in SteelEngine config. */
export type DiscordAccountConfig = NonNullable<NonNullable<SteelEngineConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: SteelEngineConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: SteelEngineConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: SteelEngineConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: SteelEngineConfig }): SteelEngineConfig {
...
/** List configured Discord account ids from SteelEngine config. */
export function listDiscordAccountIds(cfg: SteelEngineConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: SteelEngineConfig): string {
