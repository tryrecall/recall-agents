...
/**
 * @deprecated Compatibility facade for the `recall/plugin-sdk/discord` subpath.
...
export type { RecallConfig } from "./config-types.js";
export type { RecallPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
export type DiscordAccountConfig = NonNullable<NonNullable<RecallConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: RecallConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: RecallConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: RecallConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: RecallConfig }): RecallConfig {
...
export function listDiscordAccountIds(cfg: RecallConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: RecallConfig): string {
