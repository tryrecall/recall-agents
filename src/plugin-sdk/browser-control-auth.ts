// Browser control auth helpers resolve plugin browser credentials from SteelEngine config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: SteelEngineConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
