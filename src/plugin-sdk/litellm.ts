...
import type { ModelDefinitionConfig, RecallConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: RecallConfig) => RecallConfig;
  applyLitellmProviderConfig: (cfg: RecallConfig) => RecallConfig;
