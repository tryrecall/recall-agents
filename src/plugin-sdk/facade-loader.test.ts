...
const FACADE_LOADER_GLOBAL = "__steelengineTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("steelengine-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "steelengine-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "steelengine-facade-loader-b-",
      marker: "override-b",
    });

    process.env.STEELENGINE_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.STEELENGINE_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "steelengine-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.STEELENGINE_BUNDLED_PLUGINS_DIR = createTempDirSync("steelengine-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "steelengine-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.STEELENGINE_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "steelengine-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("steelengine-facade-loader-circular-");
    process.env.STEELENGINE_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("steelengine-facade-loader-throw-");
    process.env.STEELENGINE_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
