...
type FacadeModule = {
  applyOpenrouterConfig: (cfg: SteelEngineConfig) => SteelEngineConfig;
  applyOpenrouterProviderConfig: (cfg: SteelEngineConfig) => SteelEngineConfig;
...
/** Apply OpenRouter defaults to the full SteelEngine config. */
