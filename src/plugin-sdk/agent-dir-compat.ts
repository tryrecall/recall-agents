 ...
 */
export function resolveSteelEngineAgentDir(env: NodeJS.ProcessEnv = process.env): string {
  const override = env.STEELENGINE_AGENT_DIR?.trim() || env.PI_CODING_AGENT_DIR?.trim();
