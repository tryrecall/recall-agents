...
type ChannelConfigAccessorParams<Config extends SteelEngineConfig = SteelEngineConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends SteelEngineConfig = SteelEngineConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends SteelEngineConfig = SteelEngineConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: SteelEngineConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends SteelEngineConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends SteelEngineConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends SteelEngineConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
