...
const DEFAULT_VAPID_SUBJECT = "https://recall.ai";
...
function resolveVapidSubjectFromEnv(): string {
  return process.env.RECALL_VAPID_SUBJECT || DEFAULT_VAPID_SUBJECT;
}

function resolveVapidPublicKeyFromEnv(): string | undefined {
  return process.env.RECALL_VAPID_PUBLIC_KEY || undefined;
}

function resolveVapidPrivateKeyFromEnv(): string | undefined {
  return process.env.RECALL_VAPID_PRIVATE_KEY || undefined;
}
