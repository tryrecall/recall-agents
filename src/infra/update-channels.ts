// Resolves SteelEngine update channels from config, tags, and versions.
...
/**
 * Env var carrying the *effective* update channel into `steelengine update finalize`
 ...
 * channel split (`STEELENGINE_UPDATE_POST_CORE_CHANNEL` vs `…_REQUESTED_CHANNEL`).
 */
export const UPDATE_EFFECTIVE_CHANNEL_ENV = "STEELENGINE_UPDATE_EFFECTIVE_CHANNEL";
...
/** Maps an SteelEngine update channel to the npm dist-tag used for package lookups. */
