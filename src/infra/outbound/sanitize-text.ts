 ...
 *
 * @see https://github.com/tryrecall/recall-agents/issues/31884
 * @see https://github.com/tryrecall/recall-agents/issues/18558
 */
...
const INTERNAL_RUNTIME_DELIMITED_BLOCKS = [
  ["<<<BEGIN_RECALL_INTERNAL_CONTEXT>>>", "<<<END_RECALL_INTERNAL_CONTEXT>>>"],
] as const;
