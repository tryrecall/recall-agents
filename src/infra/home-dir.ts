// Resolves SteelEngine home and platform-specific config directories.
...
function resolveRawHomeDir(env: NodeJS.ProcessEnv, homedir: () => string): string | undefined {
  const explicitHome = normalize(env.STEELENGINE_HOME);
  if (!explicitHome) {
...
/** Resolves SteelEngine's effective home, honoring STEELENGINE_HOME before OS homes. */
...
/** Resolves the underlying OS user home, ignoring STEELENGINE_HOME overrides. */
...
export function resolveRequiredHomeDir(
  ...
  throw new Error(
    "Unable to resolve an SteelEngine home: set STEELENGINE_HOME, HOME, or USERPROFILE, or run from an existing directory.",
  );
}
...
/** Resolves a user-supplied path against the OS home, ignoring STEELENGINE_HOME. */
