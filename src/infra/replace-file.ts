// Wraps fs-safe atomic replacement and move helpers for SteelEngine install flows.
...
/**
 * Moves a path using fs-safe's copy fallback, with an SteelEngine hardlink guard
