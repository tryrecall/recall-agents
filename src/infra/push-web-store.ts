...
export const DEFAULT_WEB_PUSH_VAPID_SUBJECT = "https://steelengine.ai";
...
function webPushStateDatabaseOptions(stateDir?: string): SteelEngineStateDatabaseOptions {
  return stateDir
...
export function listWebPushSubscriptions(stateDir?: string): WebPushSubscription[] {
  const database = openSteelEngineStateDatabase(webPushStateDatabaseOptions(stateDir));
