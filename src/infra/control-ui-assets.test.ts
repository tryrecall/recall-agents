...
let recallRoot: typeof import("./recall-root.js");
...
describe("control UI assets helpers (fs-mocked)", () => {
  beforeAll(async () => {
    ...
    recallRoot = await import("./recall-root.js");
  });
  ...
  it("uses resolveRecallPackageRoot when available", async () => {
    ...
    (
      recallRoot.resolveRecallPackageRoot as unknown as ReturnType<typeof vi.fn>
  ...
  it("resolves control-ui root for dist bundle argv1 and moduleUrl candidates", async () => {
    ...
    (
      recallRoot.resolveRecallPackageRootSync as unknown as ReturnType<typeof vi.fn>
