...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SteelEngineConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SteelEngineConfig; env: NodeJS.ProcessEnv }): {
  cfg: SteelEngineConfig;
  changes: string[];
} {
