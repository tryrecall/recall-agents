...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof RecallConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: RecallConfig; env: NodeJS.ProcessEnv }): {
  cfg: RecallConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
