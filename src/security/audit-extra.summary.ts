...
function summarizeGroupPolicy(cfg: SteelEngineConfig): {
  open: number;
  allowlist: number;
  other: number;
} {
...
function hasWebSearchKey(cfg: SteelEngineConfig, env: NodeJS.ProcessEnv): boolean {
...
function isWebSearchEnabled(cfg: SteelEngineConfig, env: NodeJS.ProcessEnv): boolean {
...
function isWebFetchEnabled(cfg: SteelEngineConfig): boolean {
...
function isBrowserEnabled(cfg: SteelEngineConfig): boolean {
...
export function collectAttackSurfaceSummaryFindings(cfg: SteelEngineConfig): SecurityAuditFinding[] {
