...
import type { SecurityAuditSuppression } from "../config/types.recall.js";
...
export function collectLoggingFindings(cfg: RecallConfig): SecurityAuditFinding[] {
...
export function collectElevatedFindings(cfg: RecallConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
export function collectExecRuntimeFindings(cfg: RecallConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
