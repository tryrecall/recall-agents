...
describe("realtime voice activation names", () => {
  it("normalizes and validates one- or two-word activation names", () => {
    expect(normalizeSupportedRealtimeVoiceActivationName("  SteelEngine  ")).toBe("steelengine");
  ...
  it("prefers longer activation names first", () => {
    expect(sortRealtimeVoiceActivationNames(["claw", "claw bot", "steelengine"])).toEqual([
      "claw bot",
      "steelengine",
      "claw",
    ]);
