...
type ConsoleConfigLoader = () => SteelEngineConfig["logging"] | undefined;
...
function normalizeConsoleLevel(level?: string): LogLevel {
  ...
  if (!level && process.env.VITEST === "true" && process.env.STEELENGINE_TEST_CONSOLE !== "1") {
    return "silent";
  }
...
function resolveConsoleSettings(): ConsoleSettings {
  ...
  let cfg: SteelEngineConfig["logging"] | undefined =
