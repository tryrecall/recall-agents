...
function resolveDiagnosticSessionStorePaths(config?: SteelEngineConfig): string[] | undefined {
  if (!config) {
    return undefined;
  }
  try {
...
function shouldWriteCriticalMemoryPressureBundle(config?: SteelEngineConfig): boolean {
 ...
 */
export function isStuckSessionRecoveryEnabled(config?: SteelEngineConfig): boolean {
...
export function resolveStuckSessionWarnMs(config?: SteelEngineConfig): number {
