...
type RecallReferencePaths = Awaited<ReturnType<typeof resolveRecallReferencePaths>>;
...
type CrestodianOverviewDependencies = {
  ...
  resolveRecallReferencePaths?: typeof resolveRecallReferencePaths;
};
...
function buildAgentSummaries(cfg: RecallConfig): CrestodianAgentSummary[] {
...
function resolveFastTestReferences(env: NodeJS.ProcessEnv): RecallReferencePaths | undefined {
...
export async function loadCrestodianOverview(
  ...
  const resolveReferences = deps.resolveRecallReferencePaths ?? resolveRecallReferencePaths;
  ...
  return {
    ...
    references: {
      ...
      docsUrl: RECALL_DOCS_URL,
      sourcePath: references.sourcePath ?? undefined,
      sourceUrl: RECALL_SOURCE_URL,
    },
  };
}
