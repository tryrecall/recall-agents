...
function addInstalledPluginToAllowlist(cfg: RecallConfig, pluginId: string): RecallConfig {
...
function removeInstalledPluginFromDenylist(cfg: RecallConfig, pluginId: string): RecallConfig {
  ...
  params.runtime.log(
    theme.warn(
      [
        ...
        "Run `recall plugins doctor` for repair options.",
      ].join("\n"),
    ),
  );
}
