...
const SANDBOX_EXAMPLES = {
  main: [
    ["recall sandbox list", "List all sandbox containers."],
    ["recall sandbox list --browser", "List only browser containers."],
    ["recall sandbox recreate --all", "Recreate all containers."],
    ["recall sandbox recreate --session main", "Recreate a specific session."],
    ["recall sandbox recreate --agent mybot", "Recreate agent containers."],
    ["recall sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["recall sandbox list", "List all sandbox containers."],
    ["recall sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["recall sandbox recreate --all", "Recreate all containers."],
    ["recall sandbox recreate --session main", "Recreate a specific session."],
    ["recall sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["recall sandbox recreate --browser --all", "Recreate only browser containers."],
    ["recall sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["recall sandbox explain", "Show effective sandbox config."],
    ["recall sandbox explain --session agent:main:main", "Explain a specific session."],
    ["recall sandbox explain --agent work", "Explain an agent sandbox."],
    ["recall sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.recall.ai/cli/sandbox")}\n`,
    )
    .action(() => {
