...
import { detectMime, normalizeMimeType } from "@steelengine/media-core/mime";
import {
...
const LOCAL_MODEL_RUN_SYSTEM_PROMPT = "You are a personal assistant running inside SteelEngine.";
