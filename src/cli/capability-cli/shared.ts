...
function getAuthProfileIdsForProvider(cfg: SteelEngineConfig, providerId: string): string[] {
...
export function pinRuntimeConfigSnapshot(config: SteelEngineConfig): void {
