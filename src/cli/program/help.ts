...
const EXAMPLES = [
  ["recall models --help", "Show detailed help for the models command."],
  [
    "recall channels login --verbose",
    "Link personal WhatsApp Web and show QR + connection logs.",
  ],
  [
    'recall message send --target +15555550123 --message "Hi" --json',
    "Send via your web session and print JSON result.",
  ],
  ["recall gateway --port 18789", "Run the WebSocket Gateway locally."],
  ["recall --dev gateway", "Run a dev Gateway (isolated state/config) on ws://127.0.0.1:19001."],
  ["recall gateway --force", "Kill anything bound to the default gateway port, then start it."],
  ["recall gateway ...", "Gateway control via WebSocket."],
  [
