...
${formatHelpExamples([
  ['recall message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'recall message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'recall message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.recall.ai/cli/message")}`,
    )
    .action(() => {
