...
/** Register `steelengine agent` for one Gateway-backed agent turn. */
...
${formatHelpExamples([
  ['steelengine agent --to +15555550123 --message "status update"', "Start a new session."],
  ['steelengine agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  ["steelengine agent --agent ops --message-file ./task.md", "Read a multiline message file."],
  [
  ...
  ['steelengine agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.steelengine.ai/cli/agent")}`,
    )
