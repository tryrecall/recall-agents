    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["steelengine directory self --channel slack", "Show the connected account identity."],
          [
            'steelengine directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["steelengine directory groups list --channel discord", "List available groups/channels."],
          [
            "steelengine directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.steelengine.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
