    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["recall directory self --channel slack", "Show the connected account identity."],
          [
            'recall directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["recall directory groups list --channel discord", "List available groups/channels."],
          [
            "recall directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.recall.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
