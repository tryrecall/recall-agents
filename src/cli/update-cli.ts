// Commander wiring for `steelengine update`, its status/finalize subcommands, and help text.
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["steelengine update repair", "Rerun post-update doctor and plugin convergence."],
          ["steelengine update repair --channel beta", "Repair against the beta update channel."],
          ["steelengine update repair --json", "JSON output for automation."],
        ])}\n\n${theme.heading("Notes:")}\n${theme.muted(
          ...
          "Docs:",
        )} ${formatDocsLink("/cli/update", "docs.steelengine.ai/cli/update")}`,
    )
...
export function registerUpdateCli(program: Command) {
  ...
  const update = program
    ...
    .addHelpText("after", () => {
      const examples = [
        ["steelengine update", "Update a source checkout (git)"],
        [
          "steelengine update --channel extended-stable",
          "Switch to the monthly supported npm channel",
        ],
        ["steelengine update --channel beta", "Switch to beta channel (git + npm)"],
        ["steelengine update --channel dev", "Switch to dev channel (git + npm)"],
        ["steelengine update --tag beta", "One-off update to a dist-tag or version"],
        ["steelengine update --tag main", "One-off package update from GitHub main"],
        ["steelengine update --dry-run", "Preview actions without changing anything"],
        ["steelengine update --no-restart", "Update without restarting the service"],
        ["steelengine update --json", "Output result as JSON"],
        ["steelengine update --yes", "Non-interactive (accept downgrade prompts)"],
        ["steelengine update repair", "Repair stranded post-update plugin state"],
        ["steelengine update --acknowledge-clawhub-risk", "Acknowledge ClawHub plugin trust warnings"],
        ["steelengine update wizard", "Interactive update wizard"],
        ["steelengine --update", "Shorthand for steelengine update"],
      ] as const;
...
${theme.heading("Switch channels:")}
  ...
  - Run steelengine update status to see the active channel and source
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/update", "docs.steelengine.ai/cli/update")}`;
    })
  ...
  update
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["steelengine update status", "Show channel + version status."],
          ["steelengine update status --json", "JSON output."],
          ["steelengine update status --timeout 10", "Custom timeout."],
        ])}\n\n${theme.heading("Notes:")}\n${theme.muted(
