...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): RecallConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: RecallConfig, env: NodeJS.ProcessEnv) =>
