...
import type { ConfigFileSnapshot, LegacyConfigIssue, SteelEngineConfig } from "./types.js";
...
export async function readConfigFileSnapshotInternal(
  ...
  let fallbackSourceConfig: SteelEngineConfig = {};
  ...
  try {
    ...
    if (
      ...
      let recoveryCandidate: SteelEngineConfig | null = null;
