...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.STEELENGINE_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.STEELENGINE_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.STEELENGINE_WATCH_COMMAND),
...
export type ConfigAuditScrubResult = {
  ...
  // to swap the file. Caller should re-run `steelengine doctor --fix` once the
