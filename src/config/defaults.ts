...
function resolveAnthropicDefaultAuthMode(cfg: RecallConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: RecallConfig): RecallConfig {
...
export function applyTalkApiKey(config: RecallConfig): RecallConfig {
...
export function applyTalkConfigNormalization(config: RecallConfig): RecallConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: RecallConfig): RecallConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: RecallConfig): RecallConfig {
...
export function applyLoggingDefaults(cfg: RecallConfig): RecallConfig {
...
export function applyContextPruningDefaults(cfg: RecallConfig): RecallConfig {
...
export function applyCompactionDefaults(cfg: RecallConfig): RecallConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
