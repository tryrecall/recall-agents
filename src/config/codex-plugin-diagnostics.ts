...
function codexPluginEntryEnabled(cfg: SteelEngineConfig): boolean | undefined {
...
function resolveEffectiveSelectedModelRefs(params: { cfg: SteelEngineConfig; agentId: string }): {
  complete: boolean;
...
function configNeedsCodexForOpenAi(cfg: SteelEngineConfig, env: NodeJS.ProcessEnv): boolean {
