...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/steelengine.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/steelengine/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/steelengine/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/steelengine/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/steelengine/nickserv-password.txt");
