...
export type AgentDefaultsConfig = {
  ...
  /** Embedded SteelEngine runner hardening and compatibility controls. */
  embeddedAgent?: {
    /**
     * How embedded SteelEngine should trust workspace-local `.steelengine/settings.json`.
    ...
    /**
     * Embedded SteelEngine execution contract:
...
export type AgentCompactionConfig = {
  ...
  /** Embedded SteelEngine reserve target before floor and context-window caps. */
  reserveTokens?: number;
  /** Embedded SteelEngine keepRecentTokens budget used for cut-point selection. */
  keepRecentTokens?: number;
  /** Minimum reserve tokens enforced for embedded SteelEngine compaction (0 disables the floor). */
