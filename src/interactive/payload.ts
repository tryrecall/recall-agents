...
import { asOptionalRecord as toRecord } from "@steelengine/normalization-core/record-coerce";
import {
...
export type MessagePresentationAction =
  ...
  | {
      ...
      url: string;
      /** SteelEngine hosted-widget ID whose launch mechanics are owned by the channel. */
      widgetId?: string;
    }
  | {
      /** Launch a channel-native web app. */
