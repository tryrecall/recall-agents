...
function listConfiguredChannelIds(cfg: SteelEngineConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: SteelEngineConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: SteelEngineConfig): ChannelRouteTarget[] {
