...
function listConfiguredChannelIds(cfg: RecallConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: RecallConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: RecallConfig): ChannelRouteTarget[] {
