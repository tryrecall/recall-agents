...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in SteelEngine config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `steelengine doctor` next.",
    ...
    memoryImport: {
      ...
      confirm: "Import these memories into your SteelEngine workspace?",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  steelengine config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: STEELENGINE_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in SteelEngine config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in SteelEngine config",
    ...
    guided: {
      ...
      custodianIntro: "Hi — I'm SteelEngine. I keep this system running. Let's get you set up.",
      failedOptionLine: "{label}: {reason}",
      failedOptionsIntro: "These didn't work just now:",
      findMeLater:
        "You can always find me later — run `steelengine` in a terminal, or open Settings in the dashboard.",
      ...
      complete: "SteelEngine is ready.",
      completeWithoutAi: "SteelEngine setup is saved. Connect AI before opening chat.",
      ...
      escapeHatches: "For the full step-by-step wizard, run `steelengine onboard --classic`.",
      ...
      invalidConfigDetails: "SteelEngine config {path} is invalid:\n{issues}",
      invalidConfigRepair:
      ...
      nextSteps:
        "Workspace: {workspace}\nAdd a channel: `steelengine channels add`\nPrefer chatting? Run `steelengine setup` and say `connect telegram` (or `connect slack`).\nOpen the dashboard: `steelengine dashboard`\nChat later: `steelengine`",
      nextStepsWithoutAi:
        "Workspace: {workspace}\nAdd AI later: re-run `steelengine onboard`\nAfter AI connects, add a channel: `steelengine channels add`\nOpen the dashboard: `steelengine dashboard`",
    ...
    security: {
      ...
      beta: "SteelEngine is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run SteelEngine.",
      learnMore: "Learn more",
      notMultitenant: "SteelEngine is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, SteelEngine is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.steelengine.ai/skills",
      enterEnv: "Enter {env}",
      ...
      manualPrereqsDoctorHint:
        "Install those tools first, then run `steelengine doctor` to review skills + requirements.",
    ...
    clickclack: {
      ...
      helpCreateToken:
        "In ClickClack: Workspace settings → Integrations → SteelEngine → create bot → copy token",
      invalidToken:
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "SteelEngine" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so SteelEngine can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for SteelEngine",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: steelengine channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL SteelEngine uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "SteelEngine"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var STEELENGINE_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: STEELENGINE_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to SteelEngine with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with steelengine configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.steelengine.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control SteelEngine.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control SteelEngine.",
      ...
      daemonRuntimeNodeHint:
        "Required because SteelEngine state uses node:sqlite; Bun cannot run the Gateway.",
      ...
      gatewayTokenStored:
        "Stored in: $STEELENGINE_CONFIG_PATH (default: ~/.steelengine/steelengine.json) under gateway.auth.token, or in STEELENGINE_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control SteelEngine.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control SteelEngine.",
      outroSeeded:
      ...
      containerSystemdUnavailable:
        "Systemd user services are not available inside this container. SteelEngine is skipping only the background service install; run the Gateway in the foreground or use your container supervisor.",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.steelengine.ai/security",
      ...
      webDocs: "Docs: https://docs.steelengine.ai/tools/web",
      ...
      whatNow: 'What now: https://steelengine.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.steelengine.ai/concepts/agent-workspace",
