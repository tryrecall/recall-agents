...
describe("process supervisor", () => {
  ...
  it("bounds retained output on UTF-16 boundaries while streaming full chunks", async () => {
    ...
    const stdoutMarker = `[steelengine: captured stdout truncated to last ${maxCapturedOutputChars} chars]\n`;
    const stderrMarker = `[steelengine: captured stderr truncated to last ${maxCapturedOutputChars} chars]\n`;
