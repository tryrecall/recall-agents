// Provider-neutral live inference ladder for delegated SteelEngine sessions.
...
type InferenceFallbackDeps = {
  readConfig?: () => Promise<SteelEngineConfig>;
  resolveRoute?: (
...
async function readCurrentConfig(): Promise<SteelEngineConfig> {
