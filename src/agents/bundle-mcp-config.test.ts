...
describe("loadMergedBundleMcpConfig", () => {
  it("lets Recall mcp.servers override bundle defaults while preserving raw transport shape", () => {
  ...
  it("maps Recall transports to downstream CLI types when requested", () => {
    expect(
