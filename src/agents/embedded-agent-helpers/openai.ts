 ...
 * pairs directly into the provider payload, so SteelEngine must normalize here.
 */
 ...
 *
 * SteelEngine persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
