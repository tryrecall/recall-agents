...
function isCliAgentRuntime(runtime: string | undefined, cfg: RecallConfig | undefined): boolean {
...
function resolveImageFallbackDefaultProvider(cfg: RecallConfig | undefined): string {
