...
function primeConfiguredContextWindowsFromConfig(cfg: SteelEngineConfig): SteelEngineConfig {
...
function primeConfiguredContextWindows(): SteelEngineConfig | undefined {
...
export function ensureContextWindowCacheLoaded(cfgOverride?: SteelEngineConfig): Promise<void> {
...
export async function refreshContextWindowCache(cfg: SteelEngineConfig): Promise<void> {
  beginContextWindowCacheRefresh();
