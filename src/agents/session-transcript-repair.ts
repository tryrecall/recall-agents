...
function makeMissingToolResult(params: {
  ...
  // explicit Recall diagnostic text unless the caller opts in.
  text?: string;
    ...
    content: [
      {
        ...
        text:
          params.text ??
          "[recall] missing tool result in session history; inserted synthetic error result for transcript repair.",
      },
    ],
    isError: true,
    timestamp: Date.now(),
