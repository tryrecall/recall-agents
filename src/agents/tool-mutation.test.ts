...
describe("tool mutation helpers", () => {
  ...
  it.each([
    ...
    ["exec", "gh search prs --repo steelengine/steelengine tool-mutation --json number,title,state"],
    ["bash", "gh pr view 123 --repo steelengine/steelengine --json title,state"],
  ...
  it.each([
    ...
    ["exec", "gh api --method POST repos/steelengine/steelengine/issues"],
