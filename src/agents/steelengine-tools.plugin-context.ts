...
/**
 * Runtime context resolver for SteelEngine plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking SteelEngine plugin tools. */
...
export function resolveSteelEnginePluginToolInputs(params: {
  options?: SteelEnginePluginToolOptions;
