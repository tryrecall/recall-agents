...
describe("splitSdkTools", () => {
  ...
  it("keeps SteelEngine-managed custom tools in SteelEngine runtime's session allowlist", () => {
    // Session tools are SteelEngine-managed custom tools; dropping them from the
