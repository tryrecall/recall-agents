// Covers conversion from SteelEngine bundle-MCP config into Codex app-server
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes SteelEngine MCP servers into Codex app-server mcp_servers shape", () => {
    ...
    expect(
      ...
      steelengine: {
        ...
        bearer_token_env_var: "STEELENGINE_MCP_TOKEN",
        http_headers: {
          "x-static": "static-value",
        },
        env_http_headers: {
