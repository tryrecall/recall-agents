...
export function isCliProvider(provider: string, cfg?: RecallConfig): boolean {
...
export function buildConfiguredModelCatalog(params: { cfg: RecallConfig }): ModelCatalogEntry[] {
