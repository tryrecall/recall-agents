...
function modelConfig(primary: string, models?: Record<string, object>): SteelEngineConfig {
  return {
    agents: {
...
describe("resolveSessionModelIdentityRef", () => {
  const resolveLegacyIdentityRef = (cfg: SteelEngineConfig, modelProvider?: string) =>
  ...
  test("infers provider from configured provider catalogs when allowlist is absent", () => {
    ...
    } as unknown as SteelEngineConfig["models"];
