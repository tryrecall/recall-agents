...
type CreateSteelEngineToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateSteelEngineToolsOpts) {
...
vi.mock("../config/sessions.js", () => ({
  ...
  resolveStorePath: () => "/tmp/steelengine-sessions-spawn-test-store.json",
