...
export const PLUGIN_MODEL_CATALOG_GENERATED_BY = "steelengine-plugin-model-catalog-v1";
...
/** Detects model catalogs generated by SteelEngine rather than user-authored JSON. */
