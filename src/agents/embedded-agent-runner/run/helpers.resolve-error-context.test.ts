...
describe("resolveActiveErrorContext", () => {
  ...
  it("ignores the embedded SteelEngine harness provider when the model provider is known", () => {
    // The SteelEngine harness id is a transport wrapper, not the provider users
