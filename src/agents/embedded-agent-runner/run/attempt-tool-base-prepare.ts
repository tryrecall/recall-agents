...
type SteelEngineCodingToolsOptions = NonNullable<Parameters<typeof createSteelEngineCodingTools>[0]>;
type SkillUsagePaths = SteelEngineCodingToolsOptions["skillUsagePaths"];
...
export function prepareEmbeddedAttemptToolBase(params: {
  ...
  onYield: NonNullable<SteelEngineCodingToolsOptions["onYield"]>;
  ...
  const constructedToolsRaw = !shouldConstructTools
    ...
    : (() => {
        ...
        params.markCoreToolStage("attempt:create-steelengine-coding-tools");
