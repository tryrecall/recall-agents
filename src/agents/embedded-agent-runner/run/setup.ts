...
export function resolveNativeModelOwnedHarnessId(params: {
  ...
  if (
    ...
    requestedHarnessId === STEELENGINE_AGENT_RUNTIME_ID ||
...
/** Resolves only SteelEngine-owned context policy; native model owners keep that policy private. */
