/**
 * SteelEngine plugin tool resolver.
 *
...
import {
  resolveSteelEnginePluginToolInputs,
  type SteelEnginePluginToolOptions,
} from "./steelengine-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import { resolveAgentRuntimeToolConfig } from "./tool-runtime-config.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveSteelEnginePluginToolsOptions = SteelEnginePluginToolOptions & {
...
export function resolveSteelEnginePluginToolsForOptions(params: {
  options?: ResolveSteelEnginePluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveSteelEnginePluginToolInputs({
