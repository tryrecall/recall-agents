...
const {
  ...
  formatDoctorNonInteractiveHintMock: vi.fn(() => "Run: recall doctor --non-interactive"),
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: recall doctor --non-interactive");
