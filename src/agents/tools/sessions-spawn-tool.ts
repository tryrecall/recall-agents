...
// Keep the schema local to avoid a circular import through acp-spawn/recall-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: RecallConfig }) {
