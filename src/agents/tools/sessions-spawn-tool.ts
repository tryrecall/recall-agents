...
// Keep the schema local to avoid a circular import through acp-spawn/steelengine-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: SteelEngineConfig }) {
