...
type CreateRecallTools = typeof import("../recall-tools.js").createRecallTools;
...
let createRecallTools: CreateRecallTools;
...
beforeAll(async () => {
  ...
  ({ createRecallTools } = await import("../recall-tools.js"));
});
...
describe("message tool secret scoping", () => {
  ...
  it("forwards source reply delivery mode through createRecallTools", () => {
...
describe("message tool agent routing", () => {
  ...
  it("forwards agentThreadId through createRecallTools to the message tool", async () => {
    mockSendResult({ channel: "slack", to: "channel:C123" });
