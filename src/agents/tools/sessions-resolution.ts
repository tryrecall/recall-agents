...
export function resolveMainSessionAlias(cfg: SteelEngineConfig) {
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("steelengine.sessionsResolutionTestApi")] = {
    testing,
  };
}
