...
function resolveMemoryToolContext(options: { config?: RecallConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: RecallConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: RecallConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: RecallConfig): MemoryCitationsMode {
