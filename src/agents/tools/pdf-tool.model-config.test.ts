...
const TEST_AGENT_DIR = "/tmp/steelengine-pdf-model-config";
...
vi.mock("./model-config.helpers.js", () => ({
  ...
  hasProviderAuthForTool: ({ provider, cfg }: { provider: string; cfg?: SteelEngineConfig }) => {
  ...
  resolveDefaultModelRef: (cfg?: SteelEngineConfig) => {
