...
export function coerceImageModelConfig(cfg?: SteelEngineConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: SteelEngineConfig; ref: string }): string[] {
