...
import { imageMimeFromFormat } from "@steelengine/media-core/mime";
...
const NOT_COMPUTER_CAPABLE_HINT =
  "enable Computer Control in the SteelEngine app and approve the pairing update";
    ...
    execute: (toolCallId, args, signal) =>
      serialize(async () => {
        ...
        const screenshotResult = async (
          ...
          // matching SteelEngineComputerInputGeometry.capturedWidth on the node.
