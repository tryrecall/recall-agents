...
function resolveAdaptiveReadMaxBytes(options?: RecallReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createRecallReadTool(base, {
...
export function createRecallReadTool(
  base: AnyAgentTool,
  options?: RecallReadToolOptions,
): AnyAgentTool {
