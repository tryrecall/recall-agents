// Verifies createSteelEngineTools wires shared config and context into the TTS tool.
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/steelengine/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./steelengine-tools.nodes-workspace-guard.js", () => ({
...
describe("createSteelEngineTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createSteelEngineTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createSteelEngineTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createSteelEngineTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
