...
export function createAgentToolsSandboxContext(
  ...
  return {
    ...
    runtimeId: params.containerName ?? "steelengine-sbx-test",
    runtimeLabel: params.containerName ?? "steelengine-sbx-test",
    containerName: params.containerName ?? "steelengine-sbx-test",
