/**
 * Fast SteelEngine tool-bundle mock.
 *
...
const createSteelEngineToolsMock = vi.fn(
  (options?: { enableHeartbeatTool?: boolean; recordToolPrepStage?: (name: string) => void }) => {
    options?.recordToolPrepStage?.("steelengine-tools:test-helper");
    return coreTools
...
vi.mock("../steelengine-tools.js", async (importOriginal) => {
  ...
  return {
    createSteelEngineTools: createSteelEngineToolsMock,
