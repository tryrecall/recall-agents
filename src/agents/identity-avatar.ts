...
function resolveAvatarSource(cfg: RecallConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: RecallConfig, agentId: string): AgentAvatarResolution {
