...
const contextTestState = vi.hoisted(() => {
  const state = {
    ...
    runtimeConfigSnapshot: null as SteelEngineConfig | null,
    runtimeConfigSourceSnapshot: null as SteelEngineConfig | null,
...
vi.mock("../config/runtime-source-projection.js", () => ({
  projectConfigOntoRuntimeSourceSnapshot: (config: SteelEngineConfig) =>
