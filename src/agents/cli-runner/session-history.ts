...
/** Builds a reseed prompt that carries prior SteelEngine transcript context. */
export function buildCliSessionHistoryPrompt(params: {
  ...
  const truncationMarker = "[SteelEngine reseed history truncated; older turns dropped]";
