...
const CODE_MODE_NAMESPACE_TOOL_CALL = Symbol.for("steelengine.codeMode.namespaceToolCall");
...
const CODE_MODE_NAMESPACE_REGISTRY_KEY = Symbol.for("steelengine.codeMode.namespaces");
...
function normalizeRegistration(
  ...
  if (RESERVED_NAMESPACE_GLOBALS.has(globalName) || globalName.startsWith("__steelengine")) {
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("steelengine.codeModeNamespacesTestApi")] = {
