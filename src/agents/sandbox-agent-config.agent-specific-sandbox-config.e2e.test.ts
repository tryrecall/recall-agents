...
async function resolveContext(config: RecallConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): RecallConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
