...
describe("isSilentOverflowProneModel", () => {
  ...
  // recall#75799 reporter's setup: an OpenAI-compatible in-house gateway
  ...
  // Recall's preemptive compaction continues to handle real overflow.
...
describe("applyPiAutoCompactionGuard", () => {
  // Direct repro of recall#75799: pi-ai's silent-overflow detection misfires
  ...
  // state.messages intact; Recall's preemptive compaction continues to
