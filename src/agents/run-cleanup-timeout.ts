...
const AGENT_CLEANUP_STEP_TIMEOUT_ENV = "STEELENGINE_AGENT_CLEANUP_TIMEOUT_MS";
const TRAJECTORY_FLUSH_TIMEOUT_ENV = "STEELENGINE_TRAJECTORY_FLUSH_TIMEOUT_MS";
...
function resolveAgentCleanupStepTimeoutMs(params: {
  ...
  if (params.step === "steelengine-trajectory-flush") {
