...
function openAIProviderUsesCustomBaseUrl(config: RecallConfig | undefined): boolean {
...
function configuredOpenAIAuthOrderStartsWithCodexProfile(config: RecallConfig | undefined) {
