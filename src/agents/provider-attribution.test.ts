...
describe("provider attribution", () => {
  it("resolves the canonical SteelEngine product and runtime version", () => {
  ...
  it("returns a documented Google Gemini attribution policy", () => {
    ...
    expect(policy).toEqual({
      ...
      version: "2026.3.22",
      headers: {
        "x-goog-api-client": "steelengine/2026.3.22",
      },
    });
  });
  ...
  it("returns a hidden-spec OpenAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("openai", { STEELENGINE_VERSION: "2026.3.22" })).toEqual({
      provider: "openai",
      enabledByDefault: true,
    ...
    expect(
      resolveProviderAttributionPolicy("openai", { STEELENGINE_VERSION: "2026.3.22" })?.headers,
    ).toEqual({
      originator: "steelengine",
      version: "2026.3.22",
      "User-Agent": "steelengine/2026.3.22",
  ...
  it("returns a hidden-spec xAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("xai", { STEELENGINE_VERSION: "2026.3.22" })).toEqual({
      provider: "xai",
      enabledByDefault: true,
      verification: "vendor-hidden-api-spec",
      hook: "request-headers",
    ...
    expect(
      resolveProviderAttributionPolicy("xai", { STEELENGINE_VERSION: "2026.3.22" })?.headers,
    ).toEqual({
      originator: "steelengine",
      version: "2026.3.22",
      "User-Agent": "steelengine/2026.3.22",
  ...
  it("lists the current attribution support matrix", () => {
    ...
    expect(
      listProviderAttributionPolicies({ STEELENGINE_VERSION: "2026.3.22" }).map((policy) => [
        policy.provider,
