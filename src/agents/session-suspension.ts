 ...
 */
const SESSION_SUSPENSION_STATE_KEY = Symbol.for("steelengine.sessionSuspensionRuntimeState");
...
function resolveLaneResumeConcurrency(cfg: SteelEngineConfig | undefined, laneId: string): number {
  switch (laneId) {
    case "main":
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("steelengine.sessionSuspensionTestApi")] = {
