...
export const DEFAULT_SANDBOX_IMAGE = "steelengine-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "steelengine-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "steelengine-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "steelengine-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "steelengine-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "steelengine-sandbox-browser";
