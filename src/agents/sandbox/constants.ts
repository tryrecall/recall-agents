...
export const DEFAULT_SANDBOX_IMAGE = "recall-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "recall-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "recall-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "recall-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "recall-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "recall-sandbox-browser";
