...
import { tableExists } from "../state/steelengine-state-db-schema-helpers.js";
...
type McpOAuthDatabase = Pick<SteelEngineStateKyselyDatabase, "mcp_oauth_stores">;
...
export function readMcpOAuthStore(storeKey: string): McpOAuthStore {
  return readFromDatabase(openSteelEngineStateDatabase().db, storeKey);
}
