 ...
 * Converts provider-specific usage shapes into SteelEngine's normalized input,
...
/** Normalize provider-specific token usage fields into SteelEngine usage buckets. */
