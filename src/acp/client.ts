...
export async function createAcpClient(opts: AcpClientOptions = {}): Promise<AcpClientHandle> {
  ...
  const defaultServerCommand = entryPath ? process.execPath : "recall";
  ...
  await client.initialize({
    ...
    clientInfo: { name: "recall-acp-client", version: "1.0.0" },
  });
