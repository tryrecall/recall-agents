...
export function isAcpEnabledByPolicy(cfg: RecallConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: RecallConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: RecallConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: RecallConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: RecallConfig): AcpRuntimeError | null {
...
export function resolveAcpExplicitTurnPolicyError(cfg: RecallConfig): AcpRuntimeError | null {
  if (isAcpEnabledByPolicy(cfg)) {
    return null;
  }
...
export function isAcpAgentAllowedByPolicy(cfg: RecallConfig, agentId: string): boolean {
