...
import { normalizeText } from "@steelengine/acp-core/normalize-text";
...
export { normalizeText } from "@steelengine/acp-core/normalize-text";
...
export type ConfiguredAcpBindingSpec = {
  ...
  /** Owning SteelEngine agent id (used for session identity/storage). */
  agentId: string;
