...
import { safeParseJson } from "@steelengine/normalization-core";
...
type AcpSessionsTable = SteelEngineStateKyselyDatabase["acp_sessions"];
type AcpSessionMetaDatabase = Pick<SteelEngineStateKyselyDatabase, "acp_sessions">;
...
}): { cfg: SteelEngineConfig; agentId?: string; storePath: string } {
...
function selectAcpSessionRows(options: SteelEngineStateDatabaseOptions = {}): AcpSessionRow[] {
