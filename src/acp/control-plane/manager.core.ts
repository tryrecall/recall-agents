...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: SteelEngineConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: SteelEngineConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: SteelEngineConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(cfg: SteelEngineConfig): Promise<void> {
