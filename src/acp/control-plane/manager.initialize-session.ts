...
import type { AcpRuntime, AcpRuntimeHandle } from "@steelengine/acp-core/runtime/types";
...
export async function runManagerInitializeSession(params: {
  ...
  enforceConcurrentSessionLimit: (params: { cfg: SteelEngineConfig; sessionKey: string }) => void;
