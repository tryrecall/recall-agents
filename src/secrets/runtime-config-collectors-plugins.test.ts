...
function makeContext(sourceConfig: RecallConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: RecallConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: RecallConfig): void {
