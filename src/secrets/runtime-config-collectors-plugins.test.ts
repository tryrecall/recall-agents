...
function makeContext(sourceConfig: SteelEngineConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: SteelEngineConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: SteelEngineConfig): void {
