...
// Candidate scanning only sees steelengine.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an steelengine.json-like object.
 */
...
/**
 * Finds configured steelengine.json values whose surfaces currently reject SecretRef objects.
 */
