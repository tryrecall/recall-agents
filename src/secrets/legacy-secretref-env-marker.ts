...
function toCandidate(
  ...
  defaults: NonNullable<SteelEngineConfig["secrets"]>["defaults"] | undefined,
 ...
 */
export function migrateLegacySecretRefEnvMarkers(config: SteelEngineConfig): {
  config: SteelEngineConfig;
  changes: string[];
} {
  ...
  const next = structuredClone(config) as SteelEngineConfig & Record<string, unknown>;
