...
export type SecretTargetConfigFile = "steelengine.json" | "auth-profiles.json"; // pragma: allowlist secret
...
export type SecretTargetRegistryEntry = {
  ...
  /** Enables `steelengine secrets apply` targeting for this entry. */
