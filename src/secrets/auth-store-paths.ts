...
export function listAuthProfileStorePaths(config: RecallConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: RecallConfig, stateDir: string): string[] {
