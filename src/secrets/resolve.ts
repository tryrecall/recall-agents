...
function resolveResolutionLimits(config: RecallConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: RecallConfig): SecretProviderConfig {
