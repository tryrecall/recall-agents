...
// Removes SteelEngine-only envelopes before messages are shown in UI/RPC results.
...
/** Strips SteelEngine envelope metadata from one display message without mutating it. */
