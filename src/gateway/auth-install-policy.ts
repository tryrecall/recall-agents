...
type GatewayInstallAuthMode = NonNullable<NonNullable<SteelEngineConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: SteelEngineConfig): boolean {
...
function hasDurableGatewayPasswordEnvForInstall(
  ...
  return Boolean(
    normalizeOptionalString(durableServiceEnv.STEELENGINE_GATEWAY_PASSWORD) ||
