...
function resolveScopedSessionKey(cfg: RecallConfig, rawSessionKey: string | undefined): string {
...
export function resolveMcpRequestContext(
  ...
  return {
    ...
    messageProvider:
      normalizeMessageChannel(getHeader(req, "x-recall-message-channel")) ?? undefined,
    accountId: normalizeOptionalString(getHeader(req, "x-recall-account-id")),
    inboundEventKind: normalizeMcpInboundEventKind(getHeader(req, "x-recall-inbound-event-kind")),
