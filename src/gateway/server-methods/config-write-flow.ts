...
export function didSharedGatewayAuthChange(prev: RecallConfig, next: RecallConfig): boolean {
...
}): Promise<{ path: string; config: RecallConfig; queueFollowUp: () => void }> {
