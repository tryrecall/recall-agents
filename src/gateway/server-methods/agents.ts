...
import { normalizeOptionalString as resolveOptionalStringParam } from "@steelengine/normalization-core/string-coerce";
import {
  ErrorCodes,
  errorShape,
...
function resolveAgentIdOrError(agentIdRaw: string, cfg: SteelEngineConfig) {
