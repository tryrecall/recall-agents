...
import type { RecallConfig, TtsConfig, TtsProviderConfigMap } from "../../config/types.js";
...
function buildTalkTtsConfig(
  ...
  | { cfg: RecallConfig; provider: string; providerConfig: TalkProviderConfig }
...
function buildTalkCatalog(config: RecallConfig) {
