...
describe("resolveOpenPathCommand", () => {
  it("uses open on macOS", () => {
    expect(resolveOpenPathCommand("/tmp/steelengine.json", "darwin")).toEqual({
      command: "open",
      args: ["/tmp/steelengine.json"],
    });
  });

  it("uses xdg-open on Linux", () => {
    expect(resolveOpenPathCommand("/tmp/steelengine.json", "linux")).toEqual({
      command: "xdg-open",
      args: ["/tmp/steelengine.json"],
    });
  });
