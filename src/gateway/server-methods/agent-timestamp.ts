 ...
 *
 * @see https://github.com/tryrecall/recall-agents/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an RecallConfig.
 */
export function timestampOptsFromConfig(cfg: RecallConfig): TimestampInjectionOptions {
  return {
