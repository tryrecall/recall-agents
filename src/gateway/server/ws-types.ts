...
export const GATEWAY_WS_CONNECTION_KIND_PROPERTY = "__steelengineConnectionKind";
export const GATEWAY_WS_PREAUTH_BUDGET_PROPERTY = "__steelenginePreauthBudget";
