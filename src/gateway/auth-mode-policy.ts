...
export function hasAmbiguousGatewayAuthModeConfig(cfg: RecallConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: RecallConfig): void {
