...
const gatewayPluginConfigCache = new WeakMap<SteelEngineConfig, CachedGatewayPluginConfig>();

/** Resolves runtime config with plugin auto-enable applied for gateway startup/reload paths. */
export function resolveGatewayPluginConfig(params: { config: SteelEngineConfig }): SteelEngineConfig {
