...
import type { RecallConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: RecallConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  ...
  const applySnapshot = async (nextConfig: RecallConfig) => {
