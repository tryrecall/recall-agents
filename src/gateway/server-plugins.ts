...
import { clearActivatedPluginRuntimeState, loadRecallPlugins } from "../plugins/loader.js";
...
export function setPluginSubagentOverridePolicies(cfg: RecallConfig): void {
  ...
  if (!policy?.allowModelOverride) {
    return {
      ...
      reason:
        ...
        "See https://docs.recall.ai/plugins/sdk-runtime#api-runtime-subagent and search for: " +
