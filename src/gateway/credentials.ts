  ...
  constructor(path: string) {
    super(
      [
        ...
        "Fix: set STEELENGINE_GATEWAY_TOKEN/STEELENGINE_GATEWAY_PASSWORD, pass explicit --token/--password,",
...
export function resolveGatewayCredentialsFromConfig(params: {
  ...
  const localTokenPrecedence =
    ...
    (env.STEELENGINE_SERVICE_KIND === "gateway" ? "config-first" : "env-first");
