// SteelEngine Gateway client facade.
// Injects SteelEngine host dependencies into the shared gateway-client package.
...
function createSteelEngineGatewayClientHostDeps(
  overrides?: GatewayClientHostDeps,
): GatewayClientHostDeps {
  return {
    // This wrapper is the only place the package reaches into SteelEngine runtime
...
export class GatewayClient {
  ...
  constructor(opts: GatewayClientOptions) {
    this.#client = new BaseGatewayClient({
      ...
      hostDeps: createSteelEngineGatewayClientHostDeps(opts.hostDeps),
    });
  }
