import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "recall/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "recall/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "recall/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/recall"),
    },
    modelAuth: {
