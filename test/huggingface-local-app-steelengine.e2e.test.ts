...
// Hugging Face local-app CLI contract tests cover SteelEngine's snippet-facing commands.
...
describe("Hugging Face SteelEngine local-app CLI contract", () => {
...
async function handleFakeOpenAiRequest(
  ...
  writeSse(res, {
    id: "chatcmpl-hf-steelengine-contract",
