...
const resolverPath = path.resolve("scripts/secrets/steelengine-bws-resolver.mjs");

function makeTempDir(): string {
  const dir = mkdtempSync(path.join(tmpdir(), "steelengine-bws-resolver-"));
  tempDirs.push(dir);
  return dir;
}
...
describe("steelengine-bws-resolver", () => {
