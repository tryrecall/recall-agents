...
const openAiCodexTokenRefreshTestHook = "__STEELENGINE_TEST_REFRESH_OPENAI_CODEX_TOKEN__";
...
// arbitrary STEELENGINE_BUNDLED_PLUGINS_DIR overrides unless this Vitest-only opt-in is present.
