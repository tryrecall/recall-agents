...
import type { TtsAutoMode, TtsProvider } from "steelengine/plugin-sdk/config-contracts";
import { privateFileStoreSync } from "steelengine/plugin-sdk/security-runtime";
import { canonicalizeSpeechProviderId } from "steelengine/plugin-sdk/speech-core";
