...
import { resolveChannelTtsVoiceDelivery } from "steelengine/plugin-sdk/channel-targets";
import type {
  SteelEngineConfig,
  ResolvedTtsPersona,
  TtsConfig,
...
import { transcodeAudioBuffer } from "steelengine/plugin-sdk/media-runtime";
import { clampTimerTimeoutMs } from "steelengine/plugin-sdk/number-runtime";
import { mergeDeep } from "steelengine/plugin-sdk/plugin-config-runtime";
import {
  markReplyPayloadAsTtsSupplement,
  resolveSendableOutboundReplyParts,
  type ReplyPayload,
} from "steelengine/plugin-sdk/reply-payload";
import { isVerbose, logVerbose } from "steelengine/plugin-sdk/runtime-env";
import { tempWorkspaceSync, resolvePreferredSteelEngineTmpDir } from "steelengine/plugin-sdk/sandbox";
import {
...
function resolveConfiguredSpeechVoiceModelRefs(cfg: SteelEngineConfig | undefined): VoiceModelRef[] {
...
function sortSpeechProvidersForAutoSelection(cfg?: SteelEngineConfig) {
...
export function resolveTtsProviderOrder(primary: TtsProvider, cfg?: SteelEngineConfig): TtsProvider[] {
  const effectiveCfg = cfg ? resolveTtsRuntimeConfig(cfg) : undefined;
