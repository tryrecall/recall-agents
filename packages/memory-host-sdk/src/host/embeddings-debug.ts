...
const debugEmbeddings = isTruthyEnvValue(process.env.STEELENGINE_DEBUG_MEMORY_EMBEDDINGS);

/** Write embedding debug metadata when STEELENGINE_DEBUG_MEMORY_EMBEDDINGS is enabled. */
