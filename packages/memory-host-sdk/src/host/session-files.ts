...
import { createSubsystemLogger, redactSensitiveText } from "./recall-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
} from "./recall-runtime-session.js";
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "recall:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip Recall-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/tryrecall/recall-agents/issues/63921
 */
