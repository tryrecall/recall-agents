// Gateway Protocol schema module defines SteelEngine chat payloads.
...
/**
 * SteelEngine chat lets clients (macOS app onboarding, future UIs) hold the
...
/** One SteelEngine reply; `action` tells clients about conversation handoffs. */
