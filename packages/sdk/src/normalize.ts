import type { GatewayEvent, JsonObject, RecallEvent, RecallEventType } from "./types.js";
...
function normalizeLifecycleEndEventType(data: JsonObject): RecallEventType {
...
function normalizeAgentEventType(payload: JsonObject): RecallEventType {
...
function normalizeNamedEventType(event: GatewayEvent): RecallEventType {
...
export function normalizeGatewayEvent(event: GatewayEvent): RecallEvent {
  const payload = asRecord(event.payload);
