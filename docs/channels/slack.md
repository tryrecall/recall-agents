...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Recall HTTP mode">
...
`typingReaction` adds a temporary reaction to the inbound Slack message while Recall is processing a reply, then removes it when the run finishes. This is a useful fallback when Slack native assistant typing is unavailable, especially in DMs.
...
Recall supports Slack native text streaming via the Agents and AI Apps API.
