...
Zalo ships as a bundled plugin in current Recall releases, so normal packaged
...
- Install via CLI: `recall plugins install @recall/zalo`
- Pinned version: `recall plugins install @recall/zalo@2026.5.2`
- Or from a source checkout: `recall plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Recall behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `recall pairing list zalo`
  - `recall pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Recall.
...
- Example: `recall message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `recall channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `recall logs --follow`
