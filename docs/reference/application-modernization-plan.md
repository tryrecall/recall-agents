...
read_when:
  - Planning a broad Recall application modernization pass
...
modernization task. If adopting this guidance as a repo-local Recall skill,
create `.agents/skills/recall-frontend/SKILL.md` first, keep the frontmatter
