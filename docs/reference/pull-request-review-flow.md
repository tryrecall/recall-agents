---
summary: "How Barnacle and ClawSweeper feedback helps move SteelEngine pull requests through review."
read_when:
...
This page explains the review flow after you open or update an SteelEngine pull
...
ClawSweeper is the AI-assisted review and maintenance bot for SteelEngine
...
SteelEngine also uses separate stale automation. Unassigned issues and PRs can be
...
- [steelengine/clawsweeper](https://github.com/steelengine/clawsweeper)
- [ClawSweeper docs](https://clawsweeper.bot/)

## Related

- [Contributing](https://github.com/steelengineai/recall-agents/blob/main/CONTRIBUTING.md)
- [CI pipeline](/ci)
