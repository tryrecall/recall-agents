...
These test-helper subpaths are repo-local source entrypoints for Recall's own
bundled plugin tests. They are not package exports for third-party plugins.

**Plugin API mock import:** `recall/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `recall/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `recall/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `recall/plugin-sdk/channel-test-helpers`

**Channel target test import:** `recall/plugin-sdk/channel-target-testing`

**Plugin contract import:** `recall/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `recall/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `recall/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `recall/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `recall/plugin-sdk/test-env`

**Generic fixture import:** `recall/plugin-sdk/test-fixtures`

**Node builtin mock import:** `recall/plugin-sdk/test-node-mocks`

Prefer the focused subpaths below for new plugin tests. The broad
`recall/plugin-sdk/testing` barrel is legacy compatibility only.
...
import { installCommonResolveTargetErrorCases } from "recall/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "recall/plugin-sdk/agent-runtime-test-contracts";
...
import { getProviderHttpMocks } from "recall/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "recall/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "recall/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "recall/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled Recall inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "recall/plugin-sdk/plugin-test-runtime";
```
...
Recall's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `recall/plugin-sdk/channel-test-helpers`
