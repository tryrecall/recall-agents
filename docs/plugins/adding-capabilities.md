---
summary: "Contributor guide for adding a new shared capability to the Recall plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Recall core developers. If you are
...
Use this when Recall needs a new shared domain such as embeddings, image
