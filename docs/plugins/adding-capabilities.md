---
summary: "Contributor guide for adding a new shared capability to the SteelEngine plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for SteelEngine core developers. If you are
...
Use this when SteelEngine needs a new shared domain such as embeddings, image
