...
Voice calls for Recall via a plugin. Supports outbound notifications and
...
- Use `recall voicecall ...` or the `voice_call` tool
...
```bash
recall plugins install ./extensions/voice-call
