...
`steelengine/plugin-sdk/channel-outbound`. Use
`steelengine/plugin-sdk/channel-inbound` for receive/context/dispatch
orchestration.
...
`steelengine/plugin-sdk/error-runtime`. Core can then clear stale send-attempt
