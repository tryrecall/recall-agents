---
summary: "Adds OpenCode Go model provider support to SteelEngine."
read_when:
...
Adds OpenCode Go model provider support to SteelEngine.

## Distribution

- Package: `@steelengine/opencode-go-provider`
