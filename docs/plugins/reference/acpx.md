---
summary: "SteelEngine ACP runtime backend with plugin-owned session and transport management."
read_when:
...
SteelEngine ACP runtime backend with plugin-owned session and transport management.
