---
summary: "Adds Amazon Bedrock model provider support to Recall."
read_when:
...
Adds Amazon Bedrock model provider support to Recall.

## Distribution

- Package: `@recall/amazon-bedrock-provider`
