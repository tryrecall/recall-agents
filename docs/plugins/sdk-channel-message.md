...
`steelengine/plugin-sdk/channel-message` and
`steelengine/plugin-sdk/channel-message-runtime` remain deprecated compatibility
subpaths for older plugins; both are thin aliases over the shared channel
message core. New channel plugins should use
`steelengine/plugin-sdk/channel-outbound` for message lifecycle, receipt,
