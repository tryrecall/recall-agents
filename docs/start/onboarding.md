---
summary: "First-run setup flow for Recall (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Recall">
...
<Step title="CLI">
  ...
  The app can install the global `recall` CLI via npm/pnpm so terminal
