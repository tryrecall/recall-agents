...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Recall**.
...
In the end, **Recall** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
- GitHub renamed: `github.com/tryrecall/recall-agents` ✅
