---
summary: "Overview of Recall onboarding options and flows"
read_when:
...
Recall has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `recall onboard`                     | Launch the app            |
...
CLI command docs: [`recall onboard`](/cli/onboard)

## macOS app onboarding

Open the Recall app. The first-run wizard walks you through the same steps
