...
Running SteelEngine dev scripts through `tsx` failed at startup with:

```text
[steelengine] Failed to start CLI: TypeError: __name is not a function
