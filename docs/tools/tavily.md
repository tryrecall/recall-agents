...
[Tavily](https://tavily.com) is a search API designed for AI applications. Recall exposes it in two ways:
...
<Tip>
Choosing Tavily in onboarding or `recall configure --section web` enables the bundled Tavily plugin automatically.
</Tip>
