...
[Tavily](https://tavily.com) is a search API designed for AI applications. SteelEngine exposes it in two ways:
...
| --------- | --------------------------------------------------------------------------------------------- |
| Plugin id | `tavily`                                                                                      |
| Package   | `@steelengine/tavily-plugin`                                                                     |
...
<Tip>
Choosing Tavily in onboarding or `steelengine configure --section web` installs and enables the official Tavily plugin when needed.
</Tip>
