...
TypeBox is a TypeScript-first schema library. SteelEngine uses it to define the **Gateway WebSocket protocol** (handshake, request/response, server events). Those schemas drive **runtime validation** (AJV), **JSON Schema export**, and **Swift codegen** for the macOS app. One source of truth; everything else is generated.
...
- Generated Swift models: `apps/shared/SteelEngineKit/Sources/SteelEngineProtocol/GatewayModels.swift`
...
- [https://raw.githubusercontent.com/steelengine/steelengine/main/dist/protocol.schema.json](https://raw.githubusercontent.com/steelengine/steelengine/main/dist/protocol.schema.json)
