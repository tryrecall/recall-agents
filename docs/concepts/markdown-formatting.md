...
SteelEngine converts outbound Markdown into a shared intermediate representation
...
```markdown
Hello **world** - see [docs](https://docs.steelengine.ai).
```
...
```json
{
  ...
  "links": [{ "start": 19, "end": 23, "href": "https://docs.steelengine.ai" }]
}
```
