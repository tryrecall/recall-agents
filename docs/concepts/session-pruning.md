...
Recall also builds a separate idempotent replay view for sessions that
...
Recall auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Recall does not override them.
