...
Recall treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.recall/settings/voicewake.json`

Shape:

```json
{ "triggers": ["recall", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
