...
recall voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
recall voicecall call     -m <text> [-t <phone>] [--mode <m>]
recall voicecall start    --to <phone> [--message <text>] [--mode <m>]
recall voicecall continue --call-id <id> --message <text>
recall voicecall speak    --call-id <id> --message <text>
recall voicecall dtmf     --call-id <id> --digits <digits>
recall voicecall end      --call-id <id>
recall voicecall status   [--call-id <id>] [--json]
recall voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
recall voicecall latency  [--file <path>] [--last <n>]
recall voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `Recall voice call smoke test.` | Message to speak during the smoke call. |
...
recall voicecall smoke --to "+15555550123"        # dry run
recall voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
recall voicecall call --to "+15555550123" --message "Hello"
recall voicecall call -m "Heads up" --mode notify
```
...
```bash
recall voicecall status
recall voicecall status --json
