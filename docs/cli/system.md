---
summary: "CLI reference for `steelengine system` (system events, heartbeat, presence)"
read_when:
...
steelengine system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$STEELENGINE_GATEWAY_TOKEN"
steelengine system heartbeat enable
steelengine system heartbeat last
steelengine system presence
```
