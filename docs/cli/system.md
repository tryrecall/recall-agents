---
summary: "CLI reference for `recall system` (system events, heartbeat, presence)"
read_when:
...
recall system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$RECALL_GATEWAY_TOKEN"
recall system heartbeat enable
recall system heartbeat last
recall system presence
```
