---
summary: "How Recall triages, responds to, and follows up on security incidents"
...
- **High:** Verified trust-boundary bypass requiring limited preconditions (for example authenticated but unauthorized high-impact action), or exposure of Recall-owned sensitive credentials.
