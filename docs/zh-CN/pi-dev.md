...
本指南总结了在 Recall 中开发 Pi 集成的合理工作流程。
...
状态存储在 Recall 状态目录下。默认为 `~/.recall`。如果设置了 `RECALL_STATE_DIR`，则使用该目录。
...
- https://docs.recall.ai/testing
- https://docs.recall.ai/start/getting-started
