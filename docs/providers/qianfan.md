---
summary: "Use Qianfan's unified API to access many models in Recall"
read_when:
...
3. Recall installed on your system
...
4. Copy the API key for use with Recall

## CLI setup

```bash
recall onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Recall Configuration](/gateway/configuration)
