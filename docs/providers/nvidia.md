---
summary: "Use NVIDIA's OpenAI-compatible API in Recall"
read_when:
  - You want to use open models in Recall for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    recall onboard --auth-choice nvidia-api-key
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    recall models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
...
```bash
recall onboard --auth-choice nvidia-api-key --nvidia-api-key "nvapi-..."
```
