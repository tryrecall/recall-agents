...
title: "Together AI"
read_when:
  - You want to use Together AI with Recall
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    recall onboard --auth-choice together-api-key
    ```
  </Step>
...
Recall ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.recall/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `recall models list --provider together`
