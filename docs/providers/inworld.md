---
summary: "Inworld streaming text-to-speech for Recall replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In Recall it
...
Recall posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Recall synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    Recall asks Inworld for `OGG_OPUS` so the audio plays as a native
