...
<Steps>
  ...
  <Step title="Configure Recall">
    Point Recall at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Recall
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Recall integration with Claude CLI or API keys.
  </Card>
