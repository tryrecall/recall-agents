...
You can point Recall at the proxy as a custom OpenAI-compatible endpoint:
...
- [Anthropic provider](/providers/anthropic) - Native Recall integration with Claude setup-token or API keys
