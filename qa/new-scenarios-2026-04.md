...
- Code: `.agents/skills/recall-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/recall-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
