...
execution:
  kind: flow
  summary: Run with `pnpm recall qa suite --provider-mode live-frontier --model anthropic/claude-opus-4-7 --alt-model anthropic/claude-opus-4-7 --scenario anthropic-opus-api-key-smoke`.
  config:
