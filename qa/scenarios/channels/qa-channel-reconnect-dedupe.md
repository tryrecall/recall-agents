...
execution:
  ...
  config:
    firstPrompt: "@recall Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@recall Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
