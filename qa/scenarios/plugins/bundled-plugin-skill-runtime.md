...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as RECALL_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                RECALL_OAUTH_DIR: path.join(stateDir, "credentials"),
                RECALL_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
