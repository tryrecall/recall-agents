...
class NodesPage extends SteelEngineLightDomElement implements NodesPageDataState {
...
if (!customElements.get("steelengine-nodes-page")) {
  customElements.define("steelengine-nodes-page", NodesPage);
}
