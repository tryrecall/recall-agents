...
const PAIRING_DOCS_URL =
  "https://docs.steelengine.ai/channels/pairing#pair-from-the-control-ui-recommended";
...
export function renderDevicePairSetup(props: DevicePairSetupProps) {
  ...
  return html`
    <steelengine-modal-dialog label=${title} description=${description} @modal-cancel=${props.onClose}>
