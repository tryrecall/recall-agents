...
class AgentMemoryPanel extends SteelEngineLightDomElement {
...
if (!customElements.get("steelengine-agent-memory-panel")) {
  customElements.define("steelengine-agent-memory-panel", AgentMemoryPanel);
}
