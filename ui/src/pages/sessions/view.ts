...
function renderSessionGoalStatus(goal: GatewaySessionRow["goal"]) {
  ...
  return html`
    <steelengine-tooltip .content=${detail}>
...
function renderFilterToggle(params: {
  ...
  const className = [
    ...
    .join(" ");
  return html`
    <steelengine-tooltip .content=${params.title}>
...
export function renderSessions(props: SessionsProps) {
  ...
  const sessionsTitle = html`
    ...
    ${props.result
      ? html`
          <steelengine-tooltip .content=${t("sessionsView.store", { path: props.result.path })}>
  ...
  return html`
    ...
    >
      ...
      <div class="session-filter-primary-row">
        <steelengine-tooltip .content=${activeTooltip}>
        ...
        <steelengine-tooltip .content=${limitTooltip}>
          <label class="session-filter-field">
  ...
  return [
    ...
    >
      ...
      <td class="data-table-key-col">
        <steelengine-tooltip .content=${keyCellTitle}>
          ...
          ${sessionDetails.map(
            (item) => html`
              <div class="session-detail-stat">
                ...
                <steelengine-tooltip .content=${item.value}>
