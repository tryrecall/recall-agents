...
function renderServerRow(server: McpServerRow) {
  ...
  const probeCommand = `steelengine mcp probe ${quotedName}`;
  const loginCommand = `steelengine mcp login ${quotedName}`;
  const meta = [
    server.transport,
    server.auth,
          ...
          <div class="settings-group">
            <div class="settings-row settings-row--stacked">
              <div class="mcp-command-card__grid">
                <code>steelengine mcp status --verbose</code>
                <code>steelengine mcp doctor --probe</code>
                <code>steelengine mcp login &lt;name&gt;</code>
                <code>steelengine mcp reload</code>
              </div>
            </div>
          </div>
        </section>
