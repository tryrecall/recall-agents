            ...
            <div class="chat-thread-inner">
              <div class="chat-group assistant">
                ...
                <div class="chat-group-messages">
                  <div class="chat-bubble">
                    <div class="chat-text">
                      <p><code>steelengine_message_send_channel_webchat_target_example_com_thread_very_long_identifier_without_spaces_1234567890abcdefghijklmnopqrstuvwxyz</code></p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        `<!doctype html><html><head><style>${readUiCss()}</style></head><body>
          <div class="chat-workbench chat-workbench--dock-bottom" style="height: 620px;">
            ...
            <aside class="chat-workspace-rail">
              ...
              <div class="chat-workspace-rail__path">/Users/steipete/.steelengine/workspace</div>
