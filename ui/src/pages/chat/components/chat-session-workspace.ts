...
export function renderSessionWorkspaceToggle(
  ...
  return html`
    <steelengine-tooltip .content=${`${label} (⇧⌘B)`}>
      <button
...
export function renderSessionWorkspaceRail(
  ...
  const terminalButton = sessionWorkspace.onToggleTerminal
    ? html`
        <steelengine-tooltip .content=${t("terminal.toggle")}>
          <button
            type="button"
  ...
  const browserButton = sessionWorkspace.onToggleBrowser
    ? html`
        <steelengine-tooltip .content=${t("browser.toggle")}>
          <button
            type="button"
            class="chat-workspace-rail__terminal"
  ...
  const diffButton = sessionWorkspace.onOpenDiff
    ? html`
        <steelengine-tooltip .content=${t("chat.sessionDiff.show")}>
          <button
            type="button"
  ...
  const renderPathActions = (path: string, origin: "session" | "workspace"): TemplateResult => html`
    ...
    >
      <steelengine-tooltip .content=${t("chat.workspaceFiles.preview")}>
        <button
      ...
      <steelengine-tooltip .content=${t("chat.workspaceFiles.copyPath")}>
        <button
          class="chat-workspace-rail__row-action"
          type="button"
                ...
                >
                  ...
                  >
                    ...
                    <span class="chat-workspace-rail__file-main">
                      <steelengine-tooltip .content=${file.path || file.name}>
                ...
                return html`
                  ...
                  >
                    ...
                    >
                      ...
                      >
                      <span class="chat-workspace-rail__file-main">
                        <steelengine-tooltip .content=${entry.path || entry.name}>
              ...
              return html`
                ...
                >
                  ...
                  >
                    ...
                    >
                    <span class="chat-workspace-rail__file-main">
                      <steelengine-tooltip .content=${artifact.title}>
  ...
  return html`
    <aside class="chat-workspace-rail" aria-label=${t("chat.workspaceFiles.label")}>
        ...
        <div class="chat-workspace-rail__actions">
          ...
          ${sessionWorkspace.narrowLayout
            ...
            : html`
              ...
              `}
          <steelengine-tooltip .content=${t("chat.workspaceFiles.refresh")}>
            <button
          ...
          <steelengine-tooltip .content=${`${t("chat.workspaceFiles.collapse")} (⇧⌘B)`}>
            <button
              type="button"
      ...
      ${sessionWorkspace.list?.root
        ? html`
            <steelengine-tooltip .content=${sessionWorkspace.list.root}>
