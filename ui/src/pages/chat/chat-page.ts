...
export class ChatPage extends SteelEngineLightDomElement {
  ...
  private readonly handleDragOver = (event: DragEvent) => {
    ...
    const pane = target?.closest<ChatPaneElement>("steelengine-chat-pane");
...
if (!customElements.get("steelengine-chat-page")) {
  customElements.define("steelengine-chat-page", ChatPage);
}
