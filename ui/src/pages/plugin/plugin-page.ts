...
export class PluginPage extends SteelEngineLightDomContentsElement {
...
if (!customElements.get("steelengine-plugin-page")) {
  customElements.define("steelengine-plugin-page", PluginPage);
}
