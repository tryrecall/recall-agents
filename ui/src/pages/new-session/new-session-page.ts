...
class NewSessionPage extends SteelEngineLightDomElement {
  ...
  private cloudRuntimeUnsupportedReason(): string | undefined {
    ...
    return runtime && runtime !== "steelengine"
      ? t("newSession.cloudRequiresSteelEngineRuntime", { runtime })
      : undefined;
  }
...
if (!customElements.get("steelengine-new-session-page")) {
  customElements.define("steelengine-new-session-page", NewSessionPage);
}
