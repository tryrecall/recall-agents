...
class WorkboardPage extends SteelEngineLightDomElement {
...
if (!customElements.get("steelengine-workboard-page")) {
  customElements.define("steelengine-workboard-page", WorkboardPage);
}
