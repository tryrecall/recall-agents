...
describe("message-normalizer", () => {
  describe("normalizeMessage", () => {
      ...
      expect(result.content).toEqual([
        { type: "text", text: "Here." },
        {
          ...
          preview: {
            ...
            render: "url",
            viewId: "cv_status",
            url: "/__steelengine__/canvas/documents/cv_status/index.html",
            title: "Status",
            preferredHeight: 320,
          },
          rawText: null,
        ...
        content: [
          {
            ...
            preview: {
              ...
              surface: "assistant_message",
              render: "url",
              url: "/__steelengine__/canvas/documents/cv_widget/index.html",
              sandbox: "scripts",
            },
          },
        ],
    ...
    it("keeps valid local MEDIA paths as assistant attachments", () => {
      const result = normalizeMessage({
        role: "assistant",
        content: "Hello\nMEDIA:/tmp/steelengine/test-image.png\nWorld",
      });
      ...
      expect(result.content).toEqual([
        { type: "text", text: "Hello" },
        {
          type: "attachment",
          attachment: {
            url: "/tmp/steelengine/test-image.png",
            kind: "image",
    ...
    it("keeps spaced local filenames together instead of leaking suffix text", () => {
      const result = normalizeMessage({
        role: "assistant",
        content: "MEDIA:/tmp/steelengine/shinkansen kato - Google Shopping.pdf",
      });
      ...
      expect(result.content).toEqual([
        {
          type: "attachment",
          attachment: {
            url: "/tmp/steelengine/shinkansen kato - Google Shopping.pdf",
            kind: "document",
