...
const SKILL_SOURCE_GROUPS: Array<{ id: string; labelKey: string; sources: string[] }> = [
  { id: "workspace", labelKey: "skillGroups.workspace", sources: ["steelengine-workspace"] },
  { id: "built-in", labelKey: "skillGroups.builtIn", sources: ["steelengine-bundled"] },
  { id: "installed", labelKey: "skillGroups.installed", sources: ["steelengine-managed"] },
  { id: "extra", labelKey: "skillGroups.extra", sources: ["steelengine-extra"] },
];
