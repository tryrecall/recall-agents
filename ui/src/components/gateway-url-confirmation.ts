...
class GatewayUrlConfirmation extends SteelEngineLightDomContentsElement {
...
if (!customElements.get("steelengine-gateway-url-confirmation")) {
  customElements.define("steelengine-gateway-url-confirmation", GatewayUrlConfirmation);
}
