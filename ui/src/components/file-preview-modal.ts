...
export class SteelEngineFilePreviewModal extends SteelEngineLitElement {
  ...
  override render() {
    ...
    return html`
      <steelengine-modal-dialog
        label=${label}
        style="--steelengine-modal-width: min(1100px, 92vw); --steelengine-modal-max-height: 86vh;"
...
declare global {
  interface HTMLElementTagNameMap {
    "steelengine-file-preview-modal": SteelEngineFilePreviewModal;
  }
}
