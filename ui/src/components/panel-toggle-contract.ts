...
export const TERMINAL_PANEL_TOGGLE_EVENT = "steelengine:terminal-toggle";
export const BROWSER_PANEL_TOGGLE_EVENT = "steelengine:browser-toggle";
export const UI_COMMAND_EVENT = "steelengine:ui-command";
