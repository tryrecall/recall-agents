...
function renderCommandPalette(props: CommandPaletteProps) {
  ...
  return html`
    <steelengine-modal-dialog
      ...
      label=${paletteLabel}
      style="--steelengine-modal-width: min(640px, calc(100vw - 32px));"
...
export class CommandPalette extends SteelEngineLightDomContentsElement {
...
if (!customElements.get("steelengine-command-palette")) {
  customElements.define("steelengine-command-palette", CommandPalette);
}
