...
const UPDATE_BANNER_DISMISS_KEY = "steelengine:control-ui:update-banner-dismissed:v1";
...
class SidebarUpdateCard extends SteelEngineLightDomContentsElement {
...
if (!customElements.get("steelengine-sidebar-update-card")) {
  customElements.define("steelengine-sidebar-update-card", SidebarUpdateCard);
}
