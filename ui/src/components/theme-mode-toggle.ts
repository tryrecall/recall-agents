...
class ThemeModeToggle extends SteelEngineLightDomContentsElement {
...
if (!customElements.get("steelengine-theme-mode-toggle")) {
  customElements.define("steelengine-theme-mode-toggle", ThemeModeToggle);
}
