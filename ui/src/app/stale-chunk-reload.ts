...
const RELOAD_GUARD_STORAGE_KEY = "steelengine.controlUi.staleChunkReloadBuildId";
...
export function installMissingStylesheetRecovery(
  ...
  const isCssApplied =
    deps.isCssApplied ??
    (() =>
      getComputedStyle(document.documentElement).getPropertyValue("--steelengine-css-ok").trim() ===
      "1");
