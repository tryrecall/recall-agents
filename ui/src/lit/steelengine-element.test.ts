...
import {
  SteelEngineLightDomContentsElement,
  SteelEngineLightDomElement,
  SteelEngineLitElement,
} from "./steelengine-element.ts";

const LIGHT_ELEMENT_NAME = "test-steelengine-light-dom-element";
const LIGHT_CONTENTS_ELEMENT_NAME = "test-steelengine-light-dom-contents-element";
const SHADOW_ELEMENT_NAME = "test-steelengine-shadow-dom-element";

class TestLightDomElement extends SteelEngineLightDomElement {
  renderCount = 0;
...
class TestShadowDomElement extends SteelEngineLitElement {
  override render() {
    return html`<span>shadow content</span>`;
  }
}

class TestLightDomContentsElement extends SteelEngineLightDomContentsElement {
  override render() {
...
describe("SteelEngine Lit elements", () => {
  beforeEach(async () => {
