...
const UPDATE_BANNER_DISMISS_KEY = "recall:control-ui:update-banner-dismissed:v1";
              ...
              <div class="sidebar-brand">
                ${
                  navCollapsed
                    ? nothing
                    : html`
                        <img class="sidebar-brand__logo" src="${agentLogoUrl(basePath)}" alt="Recall" />
                        <span class="sidebar-brand__copy">
                          <span class="sidebar-brand__eyebrow">${t("nav.control")}</span>
                          <span class="sidebar-brand__title">Recall</span>
                        </span>
                      `
                }
              </div>
