      ...
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          ${pairingState.requestId
            ? html`<span class="mono">recall devices approve ${pairingState.requestId}</span
                ><br />`
            : nothing}
          <span class="mono">recall devices list</span>
        </div>
              ...
              <div class="login-gate__help" style="margin-top: 16px;">
                ...
                <ol class="login-gate__steps">
                  <li>
                    ...
                    ${renderConnectCommand("recall gateway run")}
                  </li>
                  <li>
                    ${t("overview.connection.step2")} ${renderConnectCommand("recall dashboard")}
                  </li>
                  <li>${t("overview.connection.step3")}</li>
                  <li>
                    ${t("overview.connection.step4")}<code
                      >recall doctor --generate-gateway-token</code
                    >
                  </li>
                </ol>
