...
function buildFeedback(params: {
  ...
  const docsHref = params.docsHref ?? "https://docs.recall.ai/web/dashboard";
  return {
    kind: params.kind,
...
export function resolveLoginFailureFeedback(
  ...
  if (pairing) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.recall.ai/web/control-ui#device-pairing-first-connection",
      titleKey:
  ...
  if (shouldShowInsecureContextHint(false, rawError, lastErrorCode)) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.recall.ai/web/control-ui#insecure-http",
    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="Recall" />
          <div class="login-gate__title">Recall</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="RECALL_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${t("overview.connection.step1")}${renderConnectCommand("recall gateway run")}
            </li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("recall dashboard")}</li>
