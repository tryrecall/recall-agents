...
export const ko: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "SteelEngine가 백그라운드에서 업데이트되었습니다. 최신 패널을 사용하려면 새로고침하세요.",
    retry: "다시 시도",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "SteelEngine 모바일 페어링 QR 코드",
      ...
      review: "검토",
      waiting: "공식 SteelEngine 모바일 앱은 스캔 후 자동으로 연결됩니다.",
      help: "페어링 도움말",
      manageDevices: "기기 관리",
    },
    binding: {
  ...
  worktrees: {
    ...
    title: "관리되는 Worktree",
    subtitle: "SteelEngine가 소유한 격리된 저장소 체크아웃입니다.",
    cleanNow: "지금 정리",
    cleanupTitle: "정리",
    cleanupSubtitle:
      "SteelEngine는 디스크 공간을 확보하기 위해 오래된 worktree를 주기적으로 제거합니다. 정리 수준을 조정하세요.",
  ...
  newSession: {
    ...
    cloudRequiresSteelEngineRuntime:
      "클라우드 워커에는 SteelEngine 런타임이 필요합니다. 현재 {runtime}이(가) 선택되어 있습니다.",
  ...
  configView: {
    ...
    retry: "재시도",
    applyBannerText: "steelengine.json에 저장됨 — Gateway를 재시작하여 적용하세요.",
  ...
  nav: {
    ...
    settings: "설정",
    settingsGeneral: "일반",
    askSteelEngine: "SteelEngine에 질문하기",
  ...
  modelSetup: {
    heading: "AI 연결",
    intro:
      "SteelEngine는 CLI 로그인, API 키 또는 제공업체 로그인 등 이미 보유한 AI 액세스를 재사용합니다.",
    ...
    access: {
      ...
      gatewayTooOld: "Gateway에서 이전 버전의 SteelEngine가 실행 중입니다",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup: "SteelEngine는 메모리를 복사하기 전에 검증된 가져오기 전 백업을 생성합니다.",
    confirmImport: "메모리 가져오기",
    disconnected: "메모리를 가져오려면 Gateway에 연결하세요.",
    title: "어시스턴트 메모리 가져오기",
    subtitle: "Codex 통합 메모리와 Claude Code 자동 메모리를 SteelEngine로 복사하기 전에 검토하세요.",
    agent: "대상 에이전트",
  ...
  onboarding: {
    memoryImport: {
      title: "어시스턴트 메모리 가져오기",
      body: "SteelEngine에서 다른 코딩 어시스턴트의 메모리를 찾았습니다. 에이전트 작업 공간으로 가져오시겠습니까?",
      ...
      doneBody:
        "{migrated}개 마이그레이션됨, {skipped}개 건너뜀. SteelEngine 설정을 계속할 수 있습니다.",
    },
  },
  custodian: {
    title: "SteelEngine",
    ...
    exitSetup: "설정 종료",
    hatchDraft: "일어나, 친구야!",
    placeholder: "SteelEngine에 메시지 보내기…",
    sensitivePlaceholder: "민감한 값 입력…",
    sensitiveReply: "민감한 답변을 보냈습니다",
    send: "보내기",
    thinking: "SteelEngine가 생각 중입니다",
    requestFailed: "SteelEngine가 응답하지 못했습니다. 다시 시도하세요.",
    connectionChanged: "Gateway 연결이 변경되었습니다. 이 설정을 계속하려면 다시 시도하세요.",
    unsupportedGateway: "SteelEngine로 설정을 계속하려면 Gateway를 업데이트하세요.",
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody: "추천 플러그인을 살펴보거나 ClawHub를 검색해 SteelEngine를 확장하세요.",
    ...
    optionalCapability: "선택적 SteelEngine 기능입니다.",
    enabled: "사용 설정됨",
    disabled: "사용 중지됨",
    available: "사용 가능",
  ...
  aboutPage: {
    ...
    linkX: "X (Twitter)",
    linkChangelog: "변경 내역",
    license: "© 2026 SteelEngine Foundation — MIT 라이선스.",
  ...
  appsPage: {
    heroTitle: "어디서든 SteelEngine를 사용하세요",
    heroTagline:
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS에서 채팅하고, 대화하고, 작업을 승인하고, SteelEngine로 공유하세요.",
      },
      android: {
        title: "Android",
        desc: "Android 휴대폰을 채팅, 카메라, Canvas를 지원하는 완전한 SteelEngine 노드로 활용하세요.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Android 컴패니언 앱으로 시계에서도 SteelEngine를 사용할 수 있습니다.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Windows 도우미는 PC를 SteelEngine 노드로 연결합니다.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "SteelEngine가 기존 Chrome의 탭, 페이지, 양식을 제어할 수 있게 합니다.",
      },
      plugins: {
        title: "플러그인 및 ClawHub",
        desc: "커뮤니티의 채널, 도구, 스킬로 SteelEngine를 확장하세요.",
      },
    },
  },
  profilePage: {
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      pitchTitle: "자기 학습 켜기",
      pitchBody:
        "SteelEngine는 수정 사항과 완료된 주요 실행을 검토한 후 이 보드에 게시할 Skill 제안 초안을 작성합니다. 추가 백그라운드 토큰을 사용하며, 초안은 보류 중인 제안으로 등록됩니다.",
      enable: "자기 학습 활성화",
      enabling: "활성화 중…",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "steelengine dashboard --no-open의 토큰을 붙여넣거나 구성된 비밀번호를 입력하세요.",
        stepGenerate:
          "토큰이 구성되어 있지 않으면 Gateway 호스트에서 steelengine doctor --generate-gateway-token을 실행하세요.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "steelengine dashboard --no-open을 실행하고 새 URL을 열거나 해당 토큰을 붙여넣으세요.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Gateway 호스트에서 steelengine devices list를 실행하세요.",
        stepApproveId: "이 요청을 승인하세요: steelengine devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "UI와 Gateway가 같은 설치에서 오도록 steelengine dashboard로 제공된 dashboard를 다시 여세요.",
        stepDevUi:
          "pnpm ui:dev를 사용하는 경우 현재 checkout 기준으로 개발 UI를 다시 빌드하거나 다시 시작하세요.",
        stepRestart:
          "SteelEngine를 업데이트한 뒤 Gateway를 다시 시작하여 현재 프로토콜을 제공하게 하세요.",
      },
      network: {
        title: "연결할 수 없음",
        summary:
        ...
        stepGateway:
          "steelengine status 또는 steelengine gateway run으로 Gateway가 실행 중인지 확인하세요.",
        stepUrl:
          "WebSocket URL을 확인하고 Gateway가 HTTPS/Tailscale Serve 뒤에 있으면 wss://를 사용하세요.",
        stepDashboard:
          "steelengine dashboard --no-open으로 dashboard를 다시 열어 현재 URL과 인증 세부 정보를 다시 복사하세요.",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "SteelEngine가 무엇을 언제 해야 하는지 설명하면 일정에 따라 실행됩니다.",
    ...
    detail: {
      tabsLabel: "자동화 세부 정보",
      newTitle: "새 예약 작업",
      newSubtitle: "SteelEngine가 수행할 작업을 설명한 후 실행 시점을 선택하세요.",
      back: "모든 자동화",
      settingsTab: "설정",
      historyTitle: "실행 기록",
      generalSection: "일반",
    ...
    form: {
      ...
      promptPlaceholder: "SteelEngine가 수행할 작업을 설명하세요...",
      repeat: "반복",
      repeatInterval: "간격",
      repeatOnce: "한 번",
      repeatOnExit: "종료 시",
