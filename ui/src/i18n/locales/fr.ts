...
export const fr: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "SteelEngine a été mis à jour en arrière-plan. Rechargez la page pour obtenir le panneau le plus récent.",
    retry: "Réessayer",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "Code QR d’association SteelEngine mobile",
      ...
      review: "Révision",
      waiting:
        "Les applications mobiles officielles SteelEngine se connectent automatiquement après la numérisation.",
  ...
  worktrees: {
    ...
    subtitle: "Checkouts de dépôt isolés appartenant à SteelEngine.",
    cleanNow: "Nettoyer maintenant",
    cleanupTitle: "Nettoyage",
    cleanupSubtitle:
      "SteelEngine supprime périodiquement les anciens worktrees afin de libérer de l’espace disque. Ajustez le niveau d’agressivité du nettoyage.",
  ...
  newSession: {
    ...
    cloudRequiresSteelEngineRuntime:
      "Les workers cloud nécessitent le runtime SteelEngine ; {runtime} est sélectionné.",
  ...
  configView: {
    ...
    retry: "Réessayer",
    applyBannerText: "Enregistré dans steelengine.json — redémarrez le gateway pour appliquer.",
  ...
  nav: {
    ...
    askSteelEngine: "Demander à SteelEngine",
  ...
  subtitles: {
    ...
    config: "Modifier steelengine.json.",
  ...
  modelSetup: {
    ...
    intro:
      "SteelEngine réutilise l’accès à l’IA dont vous disposez déjà — une connexion CLI, une clé API ou une connexion à un fournisseur.",
    ...
    access: {
      ...
      gatewayTooOld: "Le Gateway utilise une ancienne version d’SteelEngine",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup:
      "SteelEngine crée une sauvegarde vérifiée avant l’importation, puis copie la mémoire.",
    ...
    subtitle:
      "Examinez la mémoire consolidée de Codex et la mémoire automatique de Claude Code avant de les copier dans SteelEngine.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "SteelEngine a trouvé des données de mémoire provenant d’autres assistants de programmation. Voulez-vous les importer dans l’espace de travail de votre agent ?",
      ...
      doneBody:
        "{migrated} migrés, {skipped} ignorés. Vous pouvez poursuivre la configuration d’SteelEngine.",
    },
  },
  custodian: {
    title: "SteelEngine",
    ...
    placeholder: "Envoyer un message à SteelEngine…",
    sensitivePlaceholder: "Saisissez une valeur sensible…",
    sensitiveReply: "Réponse sensible envoyée",
    send: "Envoyer",
    thinking: "SteelEngine réfléchit",
    requestFailed: "SteelEngine n’a pas pu répondre. Réessayez.",
    connectionChanged:
      "La connexion au Gateway a changé. Réessayez pour poursuivre cette configuration.",
    unsupportedGateway: "Mettez à jour le Gateway pour poursuivre la configuration avec SteelEngine.",
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody:
      "Découvrez un plugin mis en avant ou recherchez dans ClawHub pour étendre SteelEngine.",
    ...
    optionalCapability: "Fonctionnalité SteelEngine facultative.",
    enabled: "Activé",
    disabled: "Désactivé",
    available: "Disponible",
  ...
  aboutPage: {
    ...
    license: "© 2026 SteelEngine Foundation — Licence MIT.",
  ...
  appsPage: {
    heroTitle: "Emportez SteelEngine partout",
    heroTagline:
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Discutez, parlez, approuvez des actions et partagez du contenu dans SteelEngine depuis iOS.",
      },
      android: {
        title: "Android",
        desc: "Votre téléphone Android comme nœud SteelEngine complet — chat, appareil photo et Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "L’app compagnon Android étend SteelEngine à votre montre.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Le compagnon Windows connecte votre PC en tant que nœud SteelEngine.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Permettez à SteelEngine de piloter votre navigateur Chrome existant — onglets, pages et formulaires.",
      },
      plugins: {
        title: "Plugins et ClawHub",
        desc: "Étendez SteelEngine avec des canaux, des outils et des compétences créés par la communauté.",
      },
    },
  },
  profilePage: {
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "SteelEngine analyse les corrections et les exécutions substantielles terminées, puis rédige des propositions de Skills pour ce tableau. Il utilise des jetons supplémentaires en arrière-plan, et les brouillons apparaissent comme propositions en attente.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Collez le jeton de steelengine dashboard --no-open ou saisissez le mot de passe configuré.",
        stepGenerate:
          "Si aucun jeton n’est configuré, exécutez steelengine doctor --generate-gateway-token sur l’hôte Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Exécutez steelengine dashboard --no-open et ouvrez la nouvelle URL ou collez son jeton.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Exécutez steelengine devices list sur l’hôte Gateway.",
        stepApproveId: "Approuvez cette demande : steelengine devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Rouvrez le dashboard servi avec steelengine dashboard afin que l’UI et le Gateway viennent de la même installation.",
        stepDevUi:
          "Si vous utilisez pnpm ui:dev, reconstruisez ou redémarrez l’UI de développement avec le checkout actuel.",
        stepRestart:
          "Redémarrez le Gateway après la mise à jour d’SteelEngine afin qu’il serve le protocole actuel.",
      },
      network: {
        ...
        stepGateway:
          "Confirmez que le Gateway fonctionne avec steelengine status ou steelengine gateway run.",
        stepUrl:
          "Vérifiez l’URL WebSocket et utilisez wss:// lorsque le Gateway est derrière HTTPS/Tailscale Serve.",
        stepDashboard:
          "Rouvrez le dashboard avec steelengine dashboard --no-open pour recopier l’URL actuelle et les détails d’authentification.",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Décrivez ce qu'SteelEngine doit faire et quand — l'exécution suit la planification.",
    ...
    detail: {
      ...
      newSubtitle: "Décrivez ce qu'SteelEngine doit faire, puis choisissez quand l'exécuter.",
    ...
    form: {
      ...
      promptPlaceholder: "Décrivez ce qu'SteelEngine doit faire...",
      repeat: "Répéter",
