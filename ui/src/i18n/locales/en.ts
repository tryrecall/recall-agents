...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from recall dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with recall models auth",
  ...
  login: {
    ...
    failure: {
      ...
      pairing: {
        ...
        stepList: "Run recall devices list on the Gateway host.",
        stepApproveId: "Approve this request: recall devices approve {requestId}.",
      ...
      network: {
        ...
        stepGateway: "Confirm the Gateway is running with recall status or recall gateway run.",
        stepUrl:
