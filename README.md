# 🦞 Recall — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/recall-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/recall-logo-text.svg" alt="Recall" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/tryrecall/recall-agents/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/tryrecall/recall-agents/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/tryrecall/recall-agents/releases"><img src="https://img.shields.io/github/v/release/tryrecall/recall-agents?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Recall** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://recall.ai) · [Docs](https://docs.recall.ai) · [Vision](VISION.md) · [DeepWiki](https://deepwiki.com/tryrecall/recall-agents) · [Getting Started](https://docs.recall.ai/start/getting-started) · [Updating](https://docs.recall.ai/install/updating) · [Showcase](https://docs.recall.ai/start/showcase) · [FAQ](https://docs.recall.ai/help/faq) · [Onboarding](https://docs.recall.ai/start/wizard) · [Nix](https://github.com/recall/nix-recall) · [Docker](https://docs.recall.ai/install/docker) · [Discord](https://discord.gg/clawd)

New install? Start here: [Getting started](https://docs.recall.ai/start/getting-started)

Preferred setup: run `recall onboard` in your terminal.
Recall Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/tryrecall/recall-agents/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.recall.ai/start/wizard).
...
# or: pnpm add -g recall@latest

recall onboard --install-daemon
```

Recall Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.19+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.recall.ai/start/getting-started)
...
```bash
# Send a message
recall message send --target +1234567890 --message "Hello from Recall"
...
recall agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.recall.ai/install/updating) (and run `recall doctor`).

Models config + CLI: [Models](https://docs.recall.ai/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.recall.ai/concepts/model-failover).

## Security defaults (DM access)

Recall connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.recall.ai/gateway/security).
Before remote exposure, use the [Gateway exposure runbook](https://docs.recall.ai/gateway/security/exposure-runbook).

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `recall pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `recall doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.recall.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.recall.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.recall.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.recall.ai/nodes/voicewake) + [Talk Mode](https://docs.recall.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.recall.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.recall.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.recall.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.recall.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.recall.ai/nodes).
- **[Onboarding](https://docs.recall.ai/start/wizard) + [skills](https://docs.recall.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.recall.ai/gateway/security), [Gateway exposure runbook](https://docs.recall.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.recall.ai/gateway/sandboxing), and [Configuration](https://docs.recall.ai/gateway/configuration).
...
- Architecture overview: [Architecture](https://docs.recall.ai/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.recall.ai/start/getting-started), [Onboarding](https://docs.recall.ai/start/wizard), [Updating](https://docs.recall.ai/install/updating)
- Channel setup: [Channels index](https://docs.recall.ai/channels), [WhatsApp](https://docs.recall.ai/channels/whatsapp), [Telegram](https://docs.recall.ai/channels/telegram), [Discord](https://docs.recall.ai/channels/discord), [Slack](https://docs.recall.ai/channels/slack)
- Apps + nodes: [macOS](https://docs.recall.ai/platforms/macos), [iOS](https://docs.recall.ai/platforms/ios), [Android](https://docs.recall.ai/platforms/android), [Nodes](https://docs.recall.ai/nodes)
- Config + security: [Configuration](https://docs.recall.ai/gateway/configuration), [Security](https://docs.recall.ai/gateway/security), [Exposure runbook](https://docs.recall.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.recall.ai/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.recall.ai/gateway), [Remote access](https://docs.recall.ai/gateway/remote), [Tailscale](https://docs.recall.ai/gateway/tailscale), [Web surfaces](https://docs.recall.ai/web)
- Tools + automation: [Tools](https://docs.recall.ai/tools), [Skills](https://docs.recall.ai/tools/skills), [Cron jobs](https://docs.recall.ai/automation/cron-jobs), [Webhooks](https://docs.recall.ai/automation/webhook), [Gmail Pub/Sub](https://docs.recall.ai/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.recall.ai/concepts/architecture), [Agent](https://docs.recall.ai/concepts/agent), [Session model](https://docs.recall.ai/concepts/session), [Gateway protocol](https://docs.recall.ai/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.recall.ai/channels/troubleshooting), [Logging](https://docs.recall.ai/logging), [Docs home](https://docs.recall.ai)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.recall.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `recall nodes …`.

Runbook: [iOS connect](https://docs.recall.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`recall devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.recall.ai/platforms/android).
...
```bash
git clone https://github.com/tryrecall/recall-agents.git
cd recall
...
`pnpm recall setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm recall onboard --install-daemon`.

Note: `pnpm recall ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `recall` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `recall update --channel stable|beta|dev`.
Details: [Development channels](https://docs.recall.ai/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.recall/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.recall/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.tryrecall/recall-agents.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.recall.ai/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=tryrecall/recall-agents&type=date&legend=top-left)](https://www.star-history.com/#tryrecall/recall-agents&type=date&legend=top-left)

## Molty

Recall was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [recall.ai](https://recall.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@recall](https://x.com/recall)
