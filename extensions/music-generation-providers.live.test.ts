...
const providerFilter = parseCsvFilter(process.env.RECALL_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.RECALL_LIVE_MUSIC_GENERATION_MODELS);
