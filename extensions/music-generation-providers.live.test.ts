...
const providerFilter = parseCsvFilter(process.env.STEELENGINE_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.STEELENGINE_LIVE_MUSIC_GENERATION_MODELS);
