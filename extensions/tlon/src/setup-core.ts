...
export async function resolveTlonSetupConfigured(cfg: RecallConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: RecallConfig): Promise<string[]> {
