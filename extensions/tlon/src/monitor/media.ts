...
import { fetchWithSsrFGuard } from "recall/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Recall workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".recall", "workspace", "media", "inbound");
 ...
 * Format matches Recall's expected attachment structure.
 */
