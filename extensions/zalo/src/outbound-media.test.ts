...
const testStateEnv: NodeJS.ProcessEnv = {
  ...process.env,
  STEELENGINE_STATE_DIR: fs.mkdtempSync(
    path.join(resolvePreferredSteelEngineTmpDir(), "steelengine-zalo-media-"),
  ),
};
...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under SteelEngine control and returns a hosted URL", async () => {
