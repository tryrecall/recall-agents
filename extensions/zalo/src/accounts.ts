...
function mergeZaloAccountConfig(cfg: SteelEngineConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: SteelEngineConfig): ResolvedZaloAccount[] {
