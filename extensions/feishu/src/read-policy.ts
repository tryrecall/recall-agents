...
type FeishuReadContext = FeishuActionReadContext | SteelEnginePluginToolContext;
...
function resolveFeishuReadGroupPolicy(cfg: SteelEngineConfig, account: ResolvedFeishuAccount) {
