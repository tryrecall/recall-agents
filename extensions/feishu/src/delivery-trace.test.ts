...
vi.mock("./runtime.js", async () => {
  const replyChunking = await import("steelengine/plugin-sdk/reply-chunking");
  const textChunking = await import("steelengine/plugin-sdk/text-chunking");
  const markdownTables = await import("steelengine/plugin-sdk/markdown-table-runtime");
  const runtime = {
    channel: {
      text: {
