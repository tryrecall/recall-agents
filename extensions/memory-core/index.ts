...
import { resolveMemoryBackendConfig } from "recall/plugin-sdk/memory-core-host-runtime-files";
import {
  definePluginEntry,
  type AnyAgentTool,
...
type MemoryToolOptions = {
  config?: RecallConfig;
  getConfig?: () => RecallConfig | undefined;
  agentId?: string;
...
function getToolConfig(options: MemoryToolOptions): RecallConfig | undefined {
...
function resolveMemoryToolOptions(ctx: RecallPluginToolContext): MemoryToolOptions {
