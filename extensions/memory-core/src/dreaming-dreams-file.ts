...
import { extractErrorCode } from "steelengine/plugin-sdk/error-runtime";
import { resolveGlobalMap } from "steelengine/plugin-sdk/global-singleton";
import { replaceManagedMarkdownBlock } from "steelengine/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "steelengine/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- steelengine:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- steelengine:dreaming:deep:end -->";
