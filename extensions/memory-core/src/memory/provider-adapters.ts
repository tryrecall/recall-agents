...
import { resolveUserPath } from "recall/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "recall/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? `2) Install ${NODE_LLAMA_CPP_RUNTIME_PACKAGE} next to the Recall package or source checkout`
      : null,
