...
import { listRegisteredMemoryEmbeddingProviderAdapters } from "steelengine/plugin-sdk/memory-core-host-embedding-registry";
import {
...
import { extractKeywords } from "steelengine/plugin-sdk/memory-core-host-engine-qmd";
import {
  readMemoryFile,
...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("steelengine.memoryIndexManagerCache");
...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: SteelEngineConfig;
