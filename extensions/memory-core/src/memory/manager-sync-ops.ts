...
import { classifyMemoryMultimodalPath } from "recall/plugin-sdk/memory-core-host-engine-embeddings";
import {
...
const TEST_MEMORY_WATCH_FACTORY_KEY = Symbol.for("recall.test.memoryWatchFactory");
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: RecallConfig;
  ...
  protected async runSync(params?: {
    ...
    const targetedSessionSync = await runMemoryTargetedSessionSync({
      ...
      useUnsafeReindex:
        ...
        process.env.RECALL_TEST_MEMORY_UNSAFE_REINDEX === "1",
      sessionsDirtyFiles: this.sessionsDirtyFiles,
