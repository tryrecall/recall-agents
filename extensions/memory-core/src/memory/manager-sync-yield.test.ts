...
import type { MemorySource } from "recall/plugin-sdk/memory-core-host-engine-storage";
...
class SessionSyncYieldHarness extends MemoryManagerSyncOps {
  protected readonly cfg = {} as RecallConfig;
  protected readonly agentId = "main";
  protected readonly workspaceDir = "/tmp/recall-test-workspace";
...
describe("session sync responsiveness", () => {
  beforeEach(() => {
    vi.stubEnv("RECALL_STATE_DIR", path.join(os.tmpdir(), "recall-session-sync-yield"));
