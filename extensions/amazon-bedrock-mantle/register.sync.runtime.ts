...
import type { SteelEnginePluginApi, ProviderRuntimeModel } from "steelengine/plugin-sdk/plugin-entry";
import {
  modelCostsEqual,
...
/** Register the Amazon Bedrock Mantle provider with SteelEngine. */
export function registerBedrockMantlePlugin(api: SteelEnginePluginApi): void {
