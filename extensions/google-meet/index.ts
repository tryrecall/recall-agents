// Google Meet plugin entrypoint registers its SteelEngine integration.
import {
...
const googleMeetConfigSchema = {
  ...
  uiHints: {
    ...
    defaultMode: {
      label: "Default Mode",
      help: "Agent uses realtime transcription plus regular SteelEngine TTS. Bidi uses the realtime voice model directly. Transcribe observes only.",
    },
    "chrome.audioBackend": {
    ...
    "chrome.autoJoin": {
      ...
      help: "Best-effort guest-name fill and Join Now click through SteelEngine browser automation.",
    },
    ...
    "realtime.transcriptionProvider": {
      ...
      help: "Agent mode uses this provider to transcribe meeting audio before regular SteelEngine TTS answers.",
    },
    ...
    "realtime.model": {
      ...
      help: "Only used by mode=bidi. Agent mode answers with the configured SteelEngine agent and regular TTS.",
      advanced: true,
    },
    ...
    "realtime.agentId": {
      ...
      help: 'SteelEngine agent id used by steelengine_agent_consult. Defaults to "main".',
      advanced: true,
    },
    "realtime.toolPolicy": {
