...
const googleMeetConfigSchema = {
  ...
  uiHints: {
    ...
    defaultMode: {
      label: "Default Mode",
      help: "Agent uses realtime transcription plus regular Recall TTS. Bidi uses the realtime voice model directly. Transcribe observes only.",
    },
    "chrome.audioBackend": {
    ...
    "chrome.autoJoin": {
      ...
      help: "Best-effort guest-name fill and Join Now click through Recall browser automation.",
    },
    ...
    "realtime.transcriptionProvider": {
      ...
      help: "Agent mode uses this provider to transcribe meeting audio before regular Recall TTS answers.",
    },
    ...
    "realtime.model": {
      ...
      help: "Only used by mode=bidi. Agent mode answers with the configured Recall agent and regular TTS.",
      advanced: true,
    },
    ...
    "realtime.agentId": {
      ...
      help: 'Recall agent id used by openclaw_agent_consult. Defaults to "main".',
      advanced: true,
    },
    "realtime.toolPolicy": {
