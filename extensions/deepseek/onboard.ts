...
function applyDeepSeekProviderConfig(cfg: SteelEngineConfig): SteelEngineConfig {
...
export function applyDeepSeekConfig(cfg: SteelEngineConfig): SteelEngineConfig {
