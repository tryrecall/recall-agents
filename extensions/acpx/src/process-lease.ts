...
export const RECALL_ACPX_LEASE_ID_ENV = "RECALL_ACPX_LEASE_ID";
export const RECALL_GATEWAY_INSTANCE_ID_ENV = "RECALL_GATEWAY_INSTANCE_ID";
export const RECALL_ACPX_LEASE_ID_ARG = "--recall-acpx-lease-id";
export const RECALL_GATEWAY_INSTANCE_ID_ARG = "--recall-gateway-instance-id";
...
export function withAcpxLeaseEnvironment(params: {
  ...
  return [
    "env",
    `${RECALL_ACPX_LEASE_ID_ENV}=${quoteEnvValue(params.leaseId)}`,
    `${RECALL_GATEWAY_INSTANCE_ID_ENV}=${quoteEnvValue(params.gatewayInstanceId)}`,
