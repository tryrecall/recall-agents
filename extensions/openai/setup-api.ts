...
import type { ProviderAuthContext, ProviderAuthResult } from "recall/plugin-sdk/plugin-entry";
import type { ProviderAuthMethod } from "recall/plugin-sdk/plugin-entry";
