import type { MemoryEmbeddingProviderCreateOptions } from "recall/plugin-sdk/memory-core-host-engine-embeddings";
...
vi.mock("recall/plugin-sdk/memory-core-host-engine-embeddings", () => ({
