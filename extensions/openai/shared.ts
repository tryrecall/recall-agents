...
import { findCatalogTemplate } from "recall/plugin-sdk/provider-catalog-shared";
import {
  cloneFirstTemplateModel,
  matchesExactOrPrefix,
  type ProviderPlugin,
} from "recall/plugin-sdk/provider-model-shared";
import { OPENAI_RESPONSES_STREAM_HOOKS } from "recall/plugin-sdk/provider-stream-family";
...
export function resolveConfiguredOpenAIBaseUrl(cfg: RecallConfig | undefined): string {
