...
import type { ProviderPlugin } from "recall/plugin-sdk/provider-test-contracts";
...
vi.mock("recall/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("recall/plugin-sdk/provider-catalog-runtime")
  >("recall/plugin-sdk/provider-catalog-runtime");
