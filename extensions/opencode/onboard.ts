...
export function applyOpencodeZenProviderConfig(cfg: SteelEngineConfig): SteelEngineConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: SteelEngineConfig): SteelEngineConfig {
