...
import { readProviderJsonArrayFieldResponse } from "steelengine/plugin-sdk/provider-http";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in steelengine.json — no
