...
import { deriveCopilotApiBaseUrlFromToken } from "steelengine/plugin-sdk/provider-auth";
import { createProviderUsageFetch, makeResponse } from "steelengine/plugin-sdk/test-env";
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { CachedCopilotToken } from "./token-cache.js";
import { resolveCopilotApiToken } from "./token.js";
import { fetchCopilotUsage } from "./usage.js";

vi.mock("steelengine/plugin-sdk/provider-model-shared", async (importOriginal) => ({
  ...(await importOriginal<typeof import("steelengine/plugin-sdk/provider-model-shared")>()),
...
vi.mock("steelengine/plugin-sdk/json-store", () => ({
...
vi.mock("steelengine/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/steelengine-state",
}));

import type { ProviderResolveDynamicModelContext } from "steelengine/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/steelengine-state/credentials/github-copilot.token.json";
