...
import { getCachedLiveCatalogValue } from "recall/plugin-sdk/provider-catalog-shared";
...
function applyCopilotDefaultModel(cfg: RecallConfig): RecallConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: RecallConfig): GithubCopilotPluginConfig {
