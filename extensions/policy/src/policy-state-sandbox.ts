...
const DEFAULT_POLICY_SANDBOX_BROWSER_NETWORK = "steelengine-sandbox-browser";
...
export function scanPolicySandboxPosture(
  ...
  pushSandboxPostureEvidence(entries, {
    ...
    inheritedSandbox: {},
    sourceBase: "oc://steelengine.config/agents/defaults/sandbox",
    inheritedSourceBase: "oc://steelengine.config/agents/defaults/sandbox",
  });
  ...
  list.forEach((agent, index) => {
    ...
    pushSandboxPostureEvidence(entries, {
      ...
      sourceBase: `oc://steelengine.config/agents/list/#${index}/sandbox`,
      inheritedSourceBase: "oc://steelengine.config/agents/defaults/sandbox",
    });
  });
