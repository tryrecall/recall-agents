...
import { resolveEnvApiKey } from "recall/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: RecallConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: RecallConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: RecallConfig): string {
