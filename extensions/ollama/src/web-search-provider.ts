...
import { resolveEnvApiKey } from "steelengine/plugin-sdk/provider-auth-runtime";
...
function resolveConfiguredOllamaWebSearchApiKey(config?: SteelEngineConfig): string | undefined {
...
function resolveOllamaWebSearchBaseUrl(config?: SteelEngineConfig): string {
