...
import { buildApiKeyCredential } from "recall/plugin-sdk/provider-auth";
import type {
...
export default definePluginEntry({
  ...
  register(api: RecallPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: RecallConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "recall configure". ' +
        "See: https://docs.recall.ai/providers/ollama",
    });
  },
});
