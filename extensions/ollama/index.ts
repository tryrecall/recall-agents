// Ollama plugin entrypoint registers its SteelEngine integration.
import { collectConfiguredModelRefValues } from "@steelengine/model-catalog-core/configured-model-refs";
...
import { resolveConfiguredSecretInputString } from "steelengine/plugin-sdk/secret-input-runtime";
import {
...
export default definePluginEntry({
  ...
  register(api: SteelEnginePluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: SteelEngineConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY or run "steelengine onboard --auth-choice ollama-cloud". ' +
