...
// without touching ~/.tryrecall/recall-agents.json.
...
vi.mock("recall/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("recall/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("recall/plugin-sdk/config-mutation");
  vi.resetModules();
});
