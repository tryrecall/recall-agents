...
type PreflightResult =
  ...
  | {
      ok: false;
      result: SteelEnginePluginNodeInvokePolicyResult;
    };
...
async function handleFileTransferInvoke(
  ctx: SteelEnginePluginNodeInvokePolicyContext,
): Promise<SteelEnginePluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): SteelEnginePluginNodeInvokePolicy {
  return {
