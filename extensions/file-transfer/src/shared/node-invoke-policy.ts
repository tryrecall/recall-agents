...
type PreflightResult =
  ...
  | {
      ok: false;
      result: RecallPluginNodeInvokePolicyResult;
    };
...
async function handleFileTransferInvoke(
  ctx: RecallPluginNodeInvokePolicyContext,
): Promise<RecallPluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): RecallPluginNodeInvokePolicy {
  return {
