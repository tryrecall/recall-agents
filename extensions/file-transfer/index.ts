// File Transfer plugin entrypoint registers its SteelEngine integration.
import {
  definePluginEntry,
  type AnyAgentTool,
  type SteelEnginePluginNodeHostCommand,
...
const fileTransferNodeHostCommands: SteelEnginePluginNodeHostCommand[] = [
  {
    command: "file.fetch",
    cap: "file",
    dangerous: true,
