...
import type { SteelEngineConfig as RuntimeApiSteelEngineConfig } from "steelengine/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiSteelEngineConfig["channels"]>["imessage"]>,
