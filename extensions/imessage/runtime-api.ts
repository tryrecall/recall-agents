import type { RecallConfig as RuntimeApiRecallConfig } from "recall/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiRecallConfig["channels"]>["imessage"]>,
