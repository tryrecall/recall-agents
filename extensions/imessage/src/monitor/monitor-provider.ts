...
import { normalizeScpRemoteHost } from "recall/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "recall/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "recall/plugin-sdk/media-runtime";
import { kindFromMime } from "recall/plugin-sdk/media-runtime";
import {
 ...
 *   exec ssh -T recall@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., recall@192.168.64.3)
