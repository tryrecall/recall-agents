...
import * as processRuntime from "steelengine/plugin-sdk/process-runtime";
import * as setupRuntime from "steelengine/plugin-sdk/setup";
...
vi.mock("steelengine/plugin-sdk/setup-tools", async (importOriginal) => ({
  ...(await importOriginal<typeof import("steelengine/plugin-sdk/setup-tools")>()),
  ...setupToolsMocks,
}));
