...
describe("iMessage monitor attachment policy", () => {
  ...
  it("does not stage local attachments for messages dropped by inbound policy", async () => {
    ...
    const attachmentPath = "/Users/steelengine/Library/Messages/Attachments/AA/BB/photo.heic";
    let onNotification:
  ...
  it.each([
    {
      ...
      attachments: [
        {
          original_path: "/Users/steelengine/Library/Messages/Attachments/missing.heic",
          mime_type: "image/heic",
          missing: true,
        },
      ],
    ...
    },
    {
      ...
      attachments: [
        ...
        {
          original_path: "/Users/steelengine/Library/Messages/Attachments/report.pdf",
      ...
      staged: {
        attachments: [
          {
            path: "/Users/steelengine/Library/Messages/Attachments/report.pdf",
    ...
    await monitorIMessageProvider({
      ...
      config: {
        channels: {
          imessage: {
            includeAttachments: true,
            attachmentRoots: ["/Users/steelengine/Library/Messages/Attachments"],
            dmPolicy: "allowlist",
