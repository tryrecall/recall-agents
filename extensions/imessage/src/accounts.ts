...
function mergeIMessageAccountConfig(cfg: RecallConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: RecallConfig): ResolvedIMessageAccount[] {
