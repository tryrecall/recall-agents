...
import { safeParseJsonWithSchema, safeParseWithSchema } from "recall/plugin-sdk/extension-shared";
import { mergePairLoopGuardConfig } from "recall/plugin-sdk/pair-loop-guard-runtime";
import { isSecretRef } from "recall/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: RecallConfig): ResolvedGoogleChatAccount[] {
