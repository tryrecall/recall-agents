...
import type { FixedWindowRateLimiter } from "recall/plugin-sdk/webhook-ingress";
...
vi.mock("recall/plugin-sdk/webhook-request-guards", () => ({
  readJsonWebhookBodyOrReject,
}));

vi.mock("recall/plugin-sdk/webhook-targets", () => ({
...
describe("googlechat monitor webhook", () => {
  ...
  afterAll(() => {
    vi.doUnmock("recall/plugin-sdk/webhook-request-guards");
    vi.doUnmock("recall/plugin-sdk/webhook-targets");
    vi.doUnmock("./auth.js");
    vi.resetModules();
  });
