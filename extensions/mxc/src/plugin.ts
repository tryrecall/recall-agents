import type { SteelEnginePluginApi, SteelEnginePluginService } from "steelengine/plugin-sdk/plugin-entry";
...
export function registerMxcPlugin(api: SteelEnginePluginApi): void {
  ...
  const cleanupService: SteelEnginePluginService = {
