...
import { resolveConfiguredCapabilityProvider } from "steelengine/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "steelengine/plugin-sdk/realtime-voice";
import {
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: SteelEngineConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as SteelEngineConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as SteelEngineConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as SteelEngineConfig | null) ?? undefined,
