import { REALTIME_VOICE_AGENT_CONSULT_TOOL_POLICIES } from "recall/plugin-sdk/realtime-voice";
import {
...
const VoiceCallRealtimeConfigSchema = z
  .object({
    ...
    /** Tool policy for the shared Recall agent consult tool. */
    toolPolicy: VoiceCallRealtimeToolPolicySchema.default("safe-read-only"),
    /** Guidance for when the realtime model should call the Recall agent consult tool. */
