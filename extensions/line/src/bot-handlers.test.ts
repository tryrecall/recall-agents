...
vi.mock("recall/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("recall/plugin-sdk/channel-pairing", () => ({
...
vi.mock("recall/plugin-sdk/command-auth", () => ({
...
vi.mock("recall/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("recall/plugin-sdk/reply-history", () => ({
...
vi.mock("recall/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("recall/plugin-sdk/channel-inbound");
    vi.doUnmock("recall/plugin-sdk/channel-pairing");
    vi.doUnmock("recall/plugin-sdk/command-auth");
    vi.doUnmock("recall/plugin-sdk/runtime-group-policy");
    vi.doUnmock("recall/plugin-sdk/runtime-env");
    vi.doUnmock("recall/plugin-sdk/reply-history");
    vi.doUnmock("recall/plugin-sdk/routing");
