...
vi.mock("recall/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("recall/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("recall/plugin-sdk/channel-activity-runtime");
