import {
  ...
  type RecallPluginCommandDefinition,
  type RecallPluginApi,
} from "recall/plugin-sdk/channel-entry-contract";

type RegisteredLineCardCommand = RecallPluginCommandDefinition;

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: RecallPluginApi): Promise<RegisteredLineCardCommand> {
