/**
 * Twitch channel plugin for SteelEngine.
 *
...
} from "steelengine/plugin-sdk/channel-pairing";
 ...
 * for SteelEngine. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: SteelEngineConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: SteelEngineConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        defaultAccountId: (cfg: SteelEngineConfig): string => resolveDefaultTwitchAccountId(cfg),
        isConfigured: (_account: unknown, cfg: SteelEngineConfig): boolean =>
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("steelengine/plugin-sdk/runtime-env").RuntimeEnv;
