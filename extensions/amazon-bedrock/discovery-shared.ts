 ...
 */
import { resolveAwsSdkEnvVarName } from "steelengine/plugin-sdk/provider-auth-runtime";
import type { ModelProviderConfig } from "steelengine/plugin-sdk/provider-model-shared";

/** Resolve the config auth marker that tells SteelEngine to use AWS SDK credentials. */
