...
describe("codex conversation turn input", () => {
  ...
  it("uses staged remote-cache paths for remote iMessage image attachments", () => {
    ...
    const stagedPath = "/tmp/steelengine-proof/.steelengine/media/remote-cache/imessage/photo.jpg";
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaPath: "file:///tmp/SteelEngine%20QA/photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "/tmp/SteelEngine QA/photo.png" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrls: ["/tmp/staged-photo.png", "file:///tmp/SteelEngine%20QA/second.jpg"],
      ...
      { type: "localImage", path: "/tmp/SteelEngine QA/second.jpg" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrl: "C:\\SteelEngine QA\\photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "C:\\SteelEngine QA\\photo.png" },
    ]);
  });
});
