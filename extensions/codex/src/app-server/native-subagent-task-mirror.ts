/**
 * Mirrors Codex native subagent thread lifecycle events into SteelEngine task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "steelengine/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the SteelEngine task-runtime run id. */
