...
import { emitTrustedDiagnosticEvent } from "recall/plugin-sdk/diagnostic-runtime";
...
export class CodexAppServerEventProjector {
  ...
  buildResult(
    ...
    // context for Recall history, search, and future harness switching.
    if (reasoningText) {
...
function shouldSuppressChannelProgressForItem(item: CodexThreadItem): boolean {
  ...
  // Dynamic Recall tool requests are emitted at the item/tool/call request
