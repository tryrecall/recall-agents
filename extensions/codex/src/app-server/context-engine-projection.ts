/**
 * Projects SteelEngine context-engine assemblies into Codex prompt text while
...
import { redactSensitiveFieldValue, redactToolPayloadText } from "steelengine/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "SteelEngine assembled context for this turn:";
...
/** Projects assembled SteelEngine context-engine messages into Codex prompt inputs. */
