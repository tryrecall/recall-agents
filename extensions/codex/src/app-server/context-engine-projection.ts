...
import { redactSensitiveFieldValue, redactToolPayloadText } from "recall/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "Recall assembled context for this turn:";
...
/**
 * Project assembled Recall context-engine messages into Codex prompt inputs.
 */
