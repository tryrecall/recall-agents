// Codex tests cover steelengine owned tool runtime contract plugin behavior.
import type { AnyAgentTool } from "steelengine/plugin-sdk/agent-harness";
import { wrapToolWithBeforeToolCallHook } from "steelengine/plugin-sdk/agent-harness-runtime";
import {
...
describe("SteelEngine-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetSteelEngineOwnedToolHooks();
  });
