...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'plugins.entries.codex.config.codexDynamicToolsProfile is retired; Codex app-server always keeps Codex-native workspace tools native. Run "recall doctor --fix".',
...
export function normalizeCompatibilityConfig({ cfg }: { cfg: RecallConfig }): {
  ...
  const nextConfig = structuredClone(cfg) as RecallConfig & {
