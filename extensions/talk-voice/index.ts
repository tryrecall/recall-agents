// Talk Voice plugin entrypoint registers its SteelEngine integration.
import type { SteelEngineConfig } from "steelengine/plugin-sdk/config-contracts";
import { formatErrorMessage } from "steelengine/plugin-sdk/error-runtime";
import { parseStrictPositiveInteger } from "steelengine/plugin-sdk/number-runtime";
import type { SpeechVoiceOption } from "steelengine/plugin-sdk/speech";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
} from "steelengine/plugin-sdk/string-coerce-runtime";
import { resolveActiveTalkProviderConfig } from "steelengine/plugin-sdk/talk-config-runtime";
  ...
  register(api: SteelEnginePluginApi) {
    api.registerCommand({
      ...
      handler: async (ctx) => {
        ...
        const cfg = api.runtime.config.current() as SteelEngineConfig;
