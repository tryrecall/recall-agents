...
This directory contains the **BlueBubbles external channel plugin** for Recall.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `recall/plugin-sdk` helpers.
