...
function resolveBlueBubblesServerUrl(cfg: RecallConfig, accountId: string): string | undefined {
  return resolveBlueBubblesAccount({ cfg, accountId }).config.serverUrl?.trim() || undefined;
}

function resolveBlueBubblesWebhookPath(cfg: RecallConfig, accountId: string): string | undefined {
...
export const blueBubblesSetupWizard: ChannelSetupWizard = {
  ...
  completionNote: {
    ...
    lines: [
      ...
      "2. Add your Recall gateway URL + webhook path",
