...
export function resolveTavilySearchConfig(cfg?: RecallConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: RecallConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: RecallConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
