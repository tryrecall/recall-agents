...
import type { RecallPluginToolContext } from "recall/plugin-sdk/plugin-entry";
...
export function createTavilyExtractTool(api: RecallPluginApi, ctx?: TavilyToolConfigContext) {
  return {
    name: "tavily_extract",
