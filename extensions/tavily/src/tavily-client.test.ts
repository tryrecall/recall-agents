...
vi.mock("steelengine/plugin-sdk/provider-web-search", () => ({
...
describe("tavily client X-Client-Source header", () => {
  ...
  it("runTavilySearch sends X-Client-Source: steelengine", async () => {
    ...
    expect(params.extraHeaders).toEqual({ "X-Client-Source": "steelengine" });
  });
  ...
  it("runTavilyExtract sends X-Client-Source: steelengine", async () => {
