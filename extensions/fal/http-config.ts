...
import type { AuthProfileStore, SteelEngineConfig } from "steelengine/plugin-sdk/provider-auth";
...
function resolveFalConfiguredBaseUrl(cfg?: SteelEngineConfig): string | undefined {
