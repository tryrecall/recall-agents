import { expectExplicitMusicGenerationCapabilities } from "recall/plugin-sdk/provider-test-contracts";
...
vi.mock("recall/plugin-sdk/provider-http", async (importOriginal) => {
  const original = await importOriginal<typeof import("recall/plugin-sdk/provider-http")>();
  return {
    ...original,
