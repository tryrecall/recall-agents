...
function getChannelConfig(cfg: SteelEngineConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: SteelEngineConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: SteelEngineConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: SteelEngineConfig, accountId: string): string[] {
