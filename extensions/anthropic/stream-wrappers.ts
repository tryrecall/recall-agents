...
const STEELENGINE_DEFAULT_ANTHROPIC_BETAS = [
  "fine-grained-tool-streaming-2025-05-14",
  "interleaved-thinking-2025-05-14",
] as const;
const STEELENGINE_OAUTH_ANTHROPIC_BETAS = [
  "claude-code-20250219",
  "oauth-2025-04-20",
  ...STEELENGINE_DEFAULT_ANTHROPIC_BETAS,
] as const;
...
/** Wrap a stream function to merge SteelEngine and configured Anthropic beta headers. */
export function createAnthropicBetaHeadersWrapper(
  ...
  return (model, context, options) => {
    ...
    const steelEngineBetas = isOauth
      ? (STEELENGINE_OAUTH_ANTHROPIC_BETAS as readonly string[])
      : (STEELENGINE_DEFAULT_ANTHROPIC_BETAS as readonly string[]);
    const allBetas = [...new Set([...steelEngineBetas, ...effectiveBetas])];
