...
// steer Recall-managed Claude CLI runs toward a different provider,
...
function isRecallRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isRecallRequestedYolo(context)
