...
type AgentDefaultsModel = NonNullable<NonNullable<SteelEngineConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<SteelEngineConfig["agents"]>["defaults"]>["models"];
