...
/** Mocks a launched SteelEngine Chrome process with the supplied pid. */
export function mockLaunchedChrome(
  launchSteelEngineChrome: { mockResolvedValue: (value: RunningChrome) => unknown },
  pid: number,
) {
  const proc = new EventEmitter() as unknown as ChildProcessWithoutNullStreams;
  launchSteelEngineChrome.mockResolvedValue({
    pid,
