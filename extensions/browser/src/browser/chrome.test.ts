...
type StopChromeTarget = Parameters<typeof stopSteelEngineChrome>[0];
...
describe("browser chrome helpers", () => {
  ...
  it("stopSteelEngineChrome sends SIGTERM and returns once CDP is down", async () => {
  ...
  it("stopSteelEngineChrome asks Chrome to close gracefully before sending a signal", async () => {
  ...
  it("stopSteelEngineChrome escalates when graceful close leaves CDP reachable", async () => {
