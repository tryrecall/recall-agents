...
describe("registerBrowserCli lazy browser subcommands", () => {
  ...
  it("registers browser placeholders without loading handlers for help", () => {
    ...
    registerBrowserCli(program, ["node", "steelengine", "browser", "--help"]);
  ...
  it("registers only the requested browser group before dispatch", async () => {
    ...
    registerBrowserCli(program, ["node", "steelengine", "browser", "status"]);
  ...
  it("loads browser doctor from the manage group so --deep is available", async () => {
    ...
    registerBrowserCli(program, ["node", "steelengine", "browser", "doctor", "--deep"]);
  ...
  it("preserves parent --json while reparsing lazy manage commands", async () => {
    ...
    registerBrowserCli(program, ["node", "steelengine", "browser", "--json", "open", "about:blank"]);
    ...
    tabsProgram.name("steelengine");
    registerBrowserCli(tabsProgram, ["node", "steelengine", "browser", "--json", "tabs"]);
  ...
  it("accepts the shipped trailing browser profile order after lazy loading", async () => {
    const program = new Command().name("steelengine").enablePositionalOptions();
  ...
  it("can eagerly register all browser groups for compatibility", async () => {
    vi.stubEnv("STEELENGINE_DISABLE_LAZY_SUBCOMMANDS", "1");
    const program = new Command();
    program.name("steelengine");
