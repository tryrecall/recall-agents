...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload from SteelEngine temp uploads or managed inbound media (e.g. /tmp/steelengine/uploads/file.pdf or media://inbound/<id>)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within steelengine temp downloads dir (default: /tmp/steelengine/downloads/...; fallback: os.tmpdir()/steelengine/downloads/...)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within steelengine temp downloads dir (e.g. report.pdf or /tmp/steelengine/downloads/report.pdf)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
