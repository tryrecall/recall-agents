...
export function describeBrowserTool(opts: {
  ...
  return [
    "Control the browser via SteelEngine's browser control server (status/start/stop/profiles/tabs/open/snapshot/screenshot/download/actions).",
    "Browser choice: omit profile to use the configured default (normally the isolated SteelEngine-managed `steelengine` browser).",
