...
import { asFiniteNumber, asObject, trimToUndefined } from "recall/plugin-sdk/speech-core";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: RecallConfig | undefined): string | undefined {
