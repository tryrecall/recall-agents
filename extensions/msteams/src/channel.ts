...
import { createTopLevelChannelConfigAdapter } from "steelengine/plugin-sdk/channel-config-helpers";
import type {
...
const resolveMSTeamsChannelConfig = (cfg: SteelEngineConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: SteelEngineConfig }>(
