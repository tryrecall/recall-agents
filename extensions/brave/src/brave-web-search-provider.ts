...
import { createWebSearchProviderContractFields } from "recall/plugin-sdk/provider-web-search-config-contract";
...
export function createBraveWebSearchProvider(): WebSearchProviderPlugin {
  return {
    ...
    docsUrl: "https://docs.recall.ai/tools/brave-search",
    autoDetectOrder: 10,
