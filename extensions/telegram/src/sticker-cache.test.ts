...
const TEST_CACHE_DIR = "/tmp/recall-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.RECALL_STATE_DIR = "/tmp/recall-test-sticker-cache";
    fs.rmSync("/tmp/recall-test-sticker-cache", { recursive: true, force: true });
