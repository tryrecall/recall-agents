...
export function shouldShowTelegramDmAccessWarning(cfg: SteelEngineConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`steelengine config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`steelengine config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
