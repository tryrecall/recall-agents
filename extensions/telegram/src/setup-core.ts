import type { ChannelSetupAdapter } from "recall/plugin-sdk/setup-runtime";
import {
...
export function getTelegramTokenHelpLines(): string[] {
  return [
    ...
    t("wizard.telegram.website", { url: "https://recall.ai" }),
  ];
}
...
export function getTelegramUserIdHelpLines(): string[] {
  return [
    t("wizard.telegram.userIdHelpLogs", {
      command: formatCliCommand("recall logs --follow"),
    }),
