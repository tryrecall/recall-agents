...
import type { ChannelGroupPolicy } from "recall/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "recall/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("recall/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("recall/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("recall/plugin-sdk/plugin-runtime").executePluginCommand;
...
type RecordInboundSessionMetaSafeFn =
  typeof import("recall/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("recall/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("recall/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("recall/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as RecallConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as RecallConfig),
