...
import type { TelegramExecApprovalConfig } from "steelengine/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: SteelEngineConfig): Array<string | number> {
