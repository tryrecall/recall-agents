...
import { resolveAgentMaxConcurrent } from "steelengine/plugin-sdk/model-session-runtime";
...
function createTelegramRunnerOptions(cfg: SteelEngineConfig): RunOptions<unknown> {
  return {
    sink: {
