...
import { isTruthyEnvValue, isWSL2Sync } from "steelengine/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "steelengine/plugin-sdk/string-coerce-runtime";

const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "STEELENGINE_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "STEELENGINE_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "STEELENGINE_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable STEELENGINE_TELEGRAM_DNS_RESULT_ORDER
