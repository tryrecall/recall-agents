...
import type { TelegramNetworkConfig } from "recall/plugin-sdk/config-runtime";
import { isTruthyEnvValue } from "recall/plugin-sdk/infra-runtime";
import { isWSL2Sync } from "recall/plugin-sdk/infra-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "RECALL_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "RECALL_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "RECALL_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable RECALL_TELEGRAM_DNS_RESULT_ORDER
