...
import { createChannelPluginBase, type ChannelPlugin } from "recall/plugin-sdk/channel-core";
import { getChatChannelMeta } from "recall/plugin-sdk/channel-plugin-common";
 ...
 */
function isBlockedByMultiBotGuard(cfg: RecallConfig, accountId: string): boolean {
