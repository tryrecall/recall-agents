...
import { isTruthyEnvValue } from "recall/plugin-sdk/infra-runtime";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "recall/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "recall/plugin-sdk/routing";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.RECALL_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/recall/recall/issues/30673
...
export function listEnabledTelegramAccounts(cfg: RecallConfig): ResolvedTelegramAccount[] {
