...
import { formatSetExplicitDefaultInstruction } from "steelengine/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "steelengine/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.STEELENGINE_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listEnabledTelegramAccounts(cfg: SteelEngineConfig): ResolvedTelegramAccount[] {
