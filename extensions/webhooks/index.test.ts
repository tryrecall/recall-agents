...
function createApi(params?: {
  pluginConfig?: SteelEnginePluginApi["pluginConfig"];
  registerHttpRoute?: SteelEnginePluginApi["registerHttpRoute"];
  logger?: SteelEnginePluginApi["logger"];
  ...
  return createTestPluginApi({
    ...
    logger:
      ...
      ({
        ...
        error: vi.fn(),
        debug: vi.fn(),
      } as SteelEnginePluginApi["logger"]),
  });
}
...
function requireFirstRouteRegistration(mock: ReturnType<typeof vi.fn>) {
  ...
  return call[0] as Parameters<SteelEnginePluginApi["registerHttpRoute"]>[0];
}
