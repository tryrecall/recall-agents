import { createClaimableDedupe } from "recall/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: RecallConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<RecallConfig["channels"]>["mattermost"]>;
