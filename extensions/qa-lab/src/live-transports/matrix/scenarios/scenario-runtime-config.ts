...
import { isRecord as isMatrixQaPlainRecord } from "steelengine/plugin-sdk/string-coerce-runtime";
import {
  buildMatrixQaToken,
  buildMentionPrompt,
...
export async function runMatrixQaAllowlistHotReloadScenario(
  ...
  const configPath = context.gatewayRuntimeEnv?.STEELENGINE_CONFIG_PATH;
