...
import { applyAuthProfileConfig, type SteelEngineConfig } from "steelengine/plugin-sdk/provider-auth";
...
export async function applyAuthProfileConfigWithConflictCheck(params: {
  ctx: MigrationProviderContext;
  profile: HermesAuthProfileConfig;
  applyConfigPatch?: (config: SteelEngineConfig) => SteelEngineConfig;
