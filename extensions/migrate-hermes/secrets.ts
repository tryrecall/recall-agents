...
import { updateAuthProfileStoreWithLock } from "steelengine/plugin-sdk/provider-auth";
import {
...
async function buildOpenCodeSecretCandidates(
  ...
  // SteelEngine's Copilot token profile cannot preserve OpenCode enterprise routing yet.
