...
import { withTrustedWebSearchEndpoint } from "steelengine/plugin-sdk/provider-web-search";
...
// without this, undici sends a generic `node` UA and SteelEngine usage is only
  ...
  const init = await postMcp({
    ...
    body: {
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "steelengine-parallel", version: PLUGIN_VERSION },
      },
    },
  });
  if (!init.ok) {
