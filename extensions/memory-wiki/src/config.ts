...
import { buildPluginConfigSchema, z, type RecallPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: RecallPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".recall", "wiki", "main");
}
