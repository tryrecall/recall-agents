...
vi.mock("steelengine/plugin-sdk/security-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("steelengine/plugin-sdk/security-runtime")>();
  return {
    ...actual,
