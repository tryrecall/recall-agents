...
const GENERATED_START = "<!-- recall:wiki:generated:start -->";
const GENERATED_END = "<!-- recall:wiki:generated:end -->";
const HUMAN_START = "<!-- recall:human:start -->";
const HUMAN_END = "<!-- recall:human:end -->";
