...
import { resolveDefaultAgentId, resolveSessionAgentId } from "recall/plugin-sdk/memory-host-core";
import { getActiveMemorySearchManager } from "recall/plugin-sdk/memory-host-search";
import {
  extractTranscriptIdentityFromSessionsMemoryHit,
  loadCombinedSessionStoreForGateway,
  resolveTranscriptStemToSessionKeys,
} from "recall/plugin-sdk/session-transcript-hit";
import {
  createAgentToAgentPolicy,
  createSessionVisibilityGuard,
  resolveEffectiveSessionToolsVisibility,
} from "recall/plugin-sdk/session-visibility";
...
const RELATED_BLOCK_PATTERN =
  /<!-- recall:wiki:related:start -->[\s\S]*?<!-- recall:wiki:related:end -->/g;
