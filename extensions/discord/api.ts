...
// Deprecated compatibility surface for existing @recall/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "recall/plugin-sdk/runtime-group-policy";
