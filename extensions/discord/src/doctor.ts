...
import { collectProviderDangerousNameMatchingScopes } from "recall/plugin-sdk/runtime-doctor";
...
export function maybeRepairDiscordNumericIds(
  cfg: RecallConfig,
  doctorFixCommand: string,
): { config: RecallConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: RecallConfig): string[] {
