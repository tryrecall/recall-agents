...
import { collectProviderDangerousNameMatchingScopes } from "steelengine/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: SteelEngineConfig): DiscordNumericIdHit[] {
...
function collectDiscordMutableAllowlistWarnings(cfg: SteelEngineConfig): string[] {
