...
vi.mock("recall/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("recall/plugin-sdk/fetch-runtime")>(
    "recall/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,
