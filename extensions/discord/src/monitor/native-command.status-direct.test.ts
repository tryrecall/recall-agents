...
vi.mock("steelengine/plugin-sdk/reply-dispatch-runtime", async () => {
  const actual = await vi.importActual<typeof import("steelengine/plugin-sdk/reply-dispatch-runtime")>(
...
vi.mock("steelengine/plugin-sdk/command-status-runtime", () => ({
...
function createConfig(params?: { requireMention?: boolean }): SteelEngineConfig {
  return {
    commands: {
...
describe("discord native /status", () => {
  ...
  beforeEach(() => {
    ...
    nativeCommandRuntime.dispatchReplyWithDispatcher =
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("steelengine/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithDispatcher;
    nativeCommandRuntime.matchPluginCommand = (() =>
      null) as typeof import("steelengine/plugin-sdk/plugin-runtime").matchPluginCommand;
  ...
  it("prioritizes direct status replies over matching plugin commands", async () => {
    ...
    nativeCommandRuntime.matchPluginCommand = (() => ({
      ...
      args: undefined,
    })) as typeof import("steelengine/plugin-sdk/plugin-runtime").matchPluginCommand;
    nativeCommandRuntime.executePluginCommand =
      executePluginCommand as typeof import("steelengine/plugin-sdk/plugin-runtime").executePluginCommand;
    const cfg = createConfig();
    const command = await createStatusCommand(cfg);
    const interaction = createInteraction();
