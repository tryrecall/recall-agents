...
vi.mock("recall/plugin-sdk/reply-dispatch-runtime", async () => {
  const actual = await vi.importActual<typeof import("recall/plugin-sdk/reply-dispatch-runtime")>(
...
vi.mock("recall/plugin-sdk/command-status-runtime", () => ({
...
function createConfig(params?: { requireMention?: boolean }): RecallConfig {
  return {
    commands: {
...
async function createStatusCommand(cfg: RecallConfig) {
...
describe("discord native /status", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("recall/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithDispatcher,
    );
    discordNativeCommandTesting.setMatchPluginCommand(
      (() => null) as typeof import("recall/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
  ...
  it("prioritizes direct status replies over matching plugin commands", async () => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand((() => ({
      ...
      args: undefined,
    })) as typeof import("recall/plugin-sdk/plugin-runtime").matchPluginCommand);
    discordNativeCommandTesting.setExecutePluginCommand(
      executePluginCommand as typeof import("recall/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    const cfg = createConfig();
    const command = await createStatusCommand(cfg);
    const interaction = createInteraction();
