...
const DISCORD_GATEWAY_READY_TIMEOUT_ENV = "RECALL_DISCORD_READY_TIMEOUT_MS";
const DISCORD_GATEWAY_RUNTIME_READY_TIMEOUT_ENV = "RECALL_DISCORD_RUNTIME_READY_TIMEOUT_MS";
