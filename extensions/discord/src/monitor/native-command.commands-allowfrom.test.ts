...
import { matchPluginCommand } from "steelengine/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "steelengine/plugin-sdk/reply-dispatch-runtime";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { defineThrowingDiscordChannelGetter } from "../test-support/partial-channel.js";
import { createDiscordNativeCommand } from "./native-command.js";

vi.mock("steelengine/plugin-sdk/plugin-runtime", { spy: true });
...
function createCommand(cfg: SteelEngineConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: SteelEngineConfig) => void;
