...
import type { NativeCommandSpec } from "recall/plugin-sdk/command-auth";
import { resolveDirectStatusReplyForSession } from "recall/plugin-sdk/command-status-runtime";
...
import { dispatchReplyWithDispatcher } from "recall/plugin-sdk/reply-dispatch-runtime";
...
async function createNativeCommand(cfg: RecallConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: RecallConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("recall/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("recall/plugin-sdk/plugin-runtime").executePluginCommand,
    );
