...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("recall/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class RecallGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new RecallGatewayPlugin();
}
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // Recall registers its own async interaction listener.
