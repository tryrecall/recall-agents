...
import { danger, warn, type RuntimeEnv } from "recall/plugin-sdk/runtime-env";
...
let pluginRuntimePromise: Promise<typeof import("recall/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("recall/plugin-sdk/plugin-runtime");
