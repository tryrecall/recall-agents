...
import type { RecallConfig, ReplyToMode } from "recall/plugin-sdk/config-runtime";
...
import { getPluginCommandSpecs } from "recall/plugin-sdk/plugin-runtime";
...
import { summarizeStringEntries } from "recall/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("recall/plugin-sdk/reply-history").HistoryEntry[]
    >();
