import { createSubsystemLogger, formatDurationSeconds } from "recall/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("recall/plugin-sdk/runtime-env").createSubsystemLogger
>;
