...
vi.mock("recall/plugin-sdk/web-media", async () => {
...
afterAll(() => {
  vi.doUnmock("recall/plugin-sdk/web-media");
});
...
describe("uploadStickerDiscord", () => {
  ...
  it("uploads sticker assets", async () => {
    ...
    expect(stickerBody.description).toBe("Recall waving");
