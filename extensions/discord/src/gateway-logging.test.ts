...
let logVerbose: typeof import("steelengine/plugin-sdk/runtime-env").logVerbose;
...
describe("attachDiscordGatewayLogging", () => {
  beforeAll(async () => {
    const { logVerbose: loadedLogVerbose } = await import("steelengine/plugin-sdk/runtime-env");
