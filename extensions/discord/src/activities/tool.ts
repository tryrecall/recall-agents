...
import type { AnyAgentTool, SteelEnginePluginToolContext } from "steelengine/plugin-sdk/plugin-entry";
import { escapeHtml } from "steelengine/plugin-sdk/text-utility-runtime";
import {
  assertWidgetHtmlSize,
  isCompleteHtmlDocument,
  WidgetHtmlInputError,
} from "steelengine/plugin-sdk/widget-html";
...
function currentConfig(context: SteelEnginePluginToolContext, runtime: DiscordActivitiesRuntime) {
  return (
...
function resolveDiscordChannelId(context: SteelEnginePluginToolContext): string | undefined {
