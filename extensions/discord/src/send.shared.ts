...
import { buildOutboundMediaLoadOptions } from "steelengine/plugin-sdk/media-runtime";
import { extensionForMime } from "steelengine/plugin-sdk/media-runtime";
import {
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: SteelEngineConfig },
): Promise<{ channelId: string; dm?: boolean }> {
