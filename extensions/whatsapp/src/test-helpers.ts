...
import { formatEnvelopeTimestamp } from "recall/plugin-sdk/channel-test-helpers";
...
const SOURCE_CONFIG_KEY = Symbol.for("recall:testSourceConfigMock");
...
vi.mock("./auto-reply/monitor/message-line.runtime.js", () => ({
  ...
  resolveMessagePrefix: (
    ...
    return params?.hasAllowFrom === true ? "" : "[recall]";
  },
}));
