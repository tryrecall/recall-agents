...
import { clamp } from "steelengine/plugin-sdk/text-utility-runtime";
...
export function resolveHeartbeatSeconds(cfg: SteelEngineConfig, overrideSeconds?: number): number {
