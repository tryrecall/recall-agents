...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "recall/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: RecallConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: RecallConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: RecallConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: RecallConfig): ResolvedWhatsAppAccount[] {
