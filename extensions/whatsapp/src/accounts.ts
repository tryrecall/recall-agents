...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "steelengine/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: SteelEngineConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SteelEngineConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: SteelEngineConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SteelEngineConfig): ResolvedWhatsAppAccount[] {
