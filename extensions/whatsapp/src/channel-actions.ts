...
function areWhatsAppAgentReactionsEnabled(params: { cfg: SteelEngineConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: SteelEngineConfig) {
