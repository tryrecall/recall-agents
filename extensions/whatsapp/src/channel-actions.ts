...
function areWhatsAppAgentReactionsEnabled(params: { cfg: RecallConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: RecallConfig) {
