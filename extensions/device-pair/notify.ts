...
import type { RecallPluginService } from "recall/plugin-sdk/core";
import { listDevicePairing } from "recall/plugin-sdk/device-bootstrap";
...
export function createPairingNotifierService(api: RecallPluginApi): RecallPluginService {
...
export function registerPairingNotifierService(api: RecallPluginApi): void {
