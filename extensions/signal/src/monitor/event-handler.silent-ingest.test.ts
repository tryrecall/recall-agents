...
vi.mock("steelengine/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("steelengine/plugin-sdk/hook-runtime")>(
    "steelengine/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
