...
vi.mock("recall/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("recall/plugin-sdk/hook-runtime")>(
    "recall/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
