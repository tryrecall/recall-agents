...
vi.mock("recall/plugin-sdk/memory-core-host-engine-embeddings", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("recall/plugin-sdk/memory-core-host-engine-embeddings")>();
  return {
    ...actual,
