...
function registerCommands(): RecallPluginCommandDefinition[] {
  ensurePlatformAdapter();
  const commands: RecallPluginCommandDefinition[] = [];
  const api = {
    logger: {},
    registerCommand: (command: RecallPluginCommandDefinition) => {
...
function findCommand(
  commands: RecallPluginCommandDefinition[],
  name: string,
): RecallPluginCommandDefinition {
