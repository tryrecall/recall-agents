...
export const qqbotConfigAdapter = {
  listAccountIds: (cfg: SteelEngineConfig) => listQQBotAccountIds(cfg),
  ...
  defaultAccountId: (cfg: SteelEngineConfig) => resolveDefaultQQBotAccountId(cfg),
  setAccountEnabled: ({
    cfg,
    accountId,
    enabled,
  ...
  deleteAccount: ({ cfg, accountId }: { cfg: SteelEngineConfig; accountId: string }) =>
    deleteAccountFromConfigSection({
      cfg,
      sectionKey: "qqbot",
      accountId,
...
export const qqbotSetupAdapterShared = {
  resolveAccountId: ({ cfg, accountId }: { cfg: SteelEngineConfig; accountId?: string | null }) =>
