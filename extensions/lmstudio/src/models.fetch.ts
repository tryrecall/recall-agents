...
import { SELF_HOSTED_DEFAULT_COST } from "steelengine/plugin-sdk/provider-setup";
...
/** Discovers LLM models from LM Studio and maps them to SteelEngine model definitions. */
