...
import { resolvePreferredSteelEngineTmpDir } from "steelengine/plugin-sdk/security-runtime";
import { asRecord, readStringValue } from "steelengine/plugin-sdk/string-coerce-runtime";
...
function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }) {
  const tmpDir = opts.tmpDir ?? resolvePreferredSteelEngineTmpDir();
  if (!opts.tmpDir) {
