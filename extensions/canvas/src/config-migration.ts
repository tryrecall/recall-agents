...
import { asOptionalRecord as readRecord } from "steelengine/plugin-sdk/string-coerce-runtime";
...
export function migrateLegacyCanvasHostConfig(config: SteelEngineConfig): {
  ...
  const next = { ...config, plugins } as SteelEngineConfig & { canvasHost?: unknown };
