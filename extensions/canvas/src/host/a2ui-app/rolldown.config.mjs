...
const outputFile = process.env.STEELENGINE_A2UI_BUNDLE_OUT
  ? path.resolve(process.env.STEELENGINE_A2UI_BUNDLE_OUT)
...
export default {
  ...
  resolve: {
    alias: {
      ...
      "@steelengine/a2ui-theme-context": a2uiThemeContext,
