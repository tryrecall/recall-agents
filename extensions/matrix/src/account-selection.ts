...
import { hasConfiguredSecretInput } from "steelengine/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: SteelEngineConfig): Record<string, unknown> | null {
