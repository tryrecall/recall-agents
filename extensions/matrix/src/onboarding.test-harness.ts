import type { OutputRuntimeEnv } from "recall/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "recall/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Recall Gateway",
    },
    confirm: {
