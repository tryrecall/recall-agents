...
} from "recall/plugin-sdk/approval-reply-runtime";
import { buildPluginApprovalResolvedReplyPayload } from "recall/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
// Recall Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.recall.approval" as const;
