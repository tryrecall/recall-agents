...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/recall-matrix-create-client-test",
    storagePath: "/tmp/recall-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/recall-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/recall-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/recall-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "recall-matrix-default-token-hash",
