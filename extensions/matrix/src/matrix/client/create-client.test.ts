...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/steelengine-matrix-create-client-test",
    storagePath: "/tmp/steelengine-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/steelengine-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/steelengine-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "steelengine-matrix-default-token-hash",
