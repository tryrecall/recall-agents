...
import type { PreparedInboundReply } from "steelengine/plugin-sdk/channel-inbound";
import { finalizeInboundContext as finalizeCoreInboundContext } from "steelengine/plugin-sdk/reply-runtime";
...
export function createMatrixHandlerTestHarness(
  ...
  }) as typeof import("steelengine/plugin-sdk/reply-runtime").dispatchInboundMessageWithBufferedDispatcher;
