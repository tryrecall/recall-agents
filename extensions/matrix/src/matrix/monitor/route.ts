import { resolveConfiguredAcpBindingRecord } from "recall/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "recall/plugin-sdk/session-binding-runtime";
