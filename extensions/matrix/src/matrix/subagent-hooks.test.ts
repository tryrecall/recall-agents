import type { RecallPluginApi as MatrixEntryPluginApi } from "recall/plugin-sdk/channel-entry-contract";
import {
...
vi.mock("recall/plugin-sdk/conversation-binding-runtime", () => ({
