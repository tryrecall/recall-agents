...
function ensureZalouserPluginEnabled(cfg: SteelEngineConfig): SteelEngineConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("steelengine directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("steelengine directory groups list --channel zalouser"),
            }),
