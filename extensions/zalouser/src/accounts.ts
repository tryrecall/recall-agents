...
function mergeZalouserAccountConfig(cfg: SteelEngineConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: SteelEngineConfig; accountId?: string | null }) {
