...
function mergeZalouserAccountConfig(cfg: RecallConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: RecallConfig; accountId?: string | null }) {
