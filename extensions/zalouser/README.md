# @steelengine/zalouser

SteelEngine extension for Zalo Personal Account messaging via native `zca-js` integration.
...
```bash
steelengine channels login --channel zalouser
steelengine channels login --channel zalouser --account work
...
- Login not persisted: `steelengine channels logout --channel zalouser && steelengine channels login --channel zalouser`
- Probe status: `steelengine channels status --probe`
