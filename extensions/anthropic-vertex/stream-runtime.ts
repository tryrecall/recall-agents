 ...
 * SteelEngine stream options for the shared Anthropic Messages transport.
 */
...
/**
 * Create a StreamFn that routes through SteelEngine's generic model stream with an
