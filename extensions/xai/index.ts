...
// Xai plugin entrypoint registers its SteelEngine integration.
...
import { defaultToolStreamExtraParams } from "steelengine/plugin-sdk/provider-stream-shared";
import { jsonResult } from "steelengine/plugin-sdk/provider-web-search";
import {
...
function createLazyCodeExecutionTool(ctx: SteelEnginePluginToolContext) {
...
function createLazyXSearchTool(ctx: SteelEnginePluginToolContext) {
  const effectiveConfig = ctx.runtimeConfig ?? ctx.config;
