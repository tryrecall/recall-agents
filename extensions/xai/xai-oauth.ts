...
import type { ProviderAuthContext, ProviderAuthMethod } from "steelengine/plugin-sdk/plugin-entry";
import {
  ...
  try {
    ...
    return buildOauthProviderAuthResult({
      ...
      notes: [
        ...
        "xAI may label the consent app as Grok Build because SteelEngine uses xAI's shared OAuth client.",
      ],
    });
  } catch (err) {
