...
describe("xai tts", () => {
  ...
  describe("listXaiTtsVoices", () => {
    it("maps the authenticated catalog and sends the expected request", async () => {
      vi.stubEnv("STEELENGINE_VERSION", "2026.7.9");
      ...
      expect(headers.get("user-agent")).toBe("steelengine/2026.7.9");
      vi.unstubAllEnvs();
    });
  ...
  describe("xaiTTS diagnostics", () => {
    ...
    it("sends an steelengine User-Agent on xAI TTS requests", async () => {
