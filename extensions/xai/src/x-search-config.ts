...
function resolveLegacyXSearchConfig(config?: RecallConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: RecallConfig): JsonRecord | undefined {
...
function resolveLegacyGrokWebSearchConfig(config?: RecallConfig): JsonRecord | undefined {
  const web = config?.tools?.web as Record<string, unknown> | undefined;
...
function resolvePluginWebSearchConfig(config?: RecallConfig): JsonRecord | undefined {
  const pluginConfig = config?.plugins?.entries?.xai?.config;
...
export function resolveEffectiveXSearchConfig(config?: RecallConfig): JsonRecord | undefined {
