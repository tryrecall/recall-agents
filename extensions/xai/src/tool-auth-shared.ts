...
function readLegacyGrokFallbackAuth(cfg?: RecallConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: RecallConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function resolveFallbackXaiAuth(cfg?: RecallConfig): XaiFallbackAuth | undefined {
...
export function resolveFallbackXaiApiKey(cfg?: RecallConfig): string | undefined {
