...
} from "steelengine/plugin-sdk/channel-route";
...
type ApprovalForwardingConfig = NonNullable<NonNullable<SteelEngineConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: SteelEngineConfig) {
