...
vi.mock("recall/plugin-sdk/channel-ingress-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("recall/plugin-sdk/channel-ingress-runtime")
  >("recall/plugin-sdk/channel-ingress-runtime");
  return {
    ...actual,
