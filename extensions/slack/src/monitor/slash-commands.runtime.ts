...
type BuildCommandTextFromArgs =
  typeof import("steelengine/plugin-sdk/command-auth-native").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("steelengine/plugin-sdk/command-auth-native").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("steelengine/plugin-sdk/command-auth-native").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("steelengine/plugin-sdk/command-auth-native").parseCommandArgs;
