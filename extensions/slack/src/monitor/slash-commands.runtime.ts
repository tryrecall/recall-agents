...
type BuildCommandTextFromArgs =
  typeof import("recall/plugin-sdk/command-auth-native").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("recall/plugin-sdk/command-auth-native").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("recall/plugin-sdk/command-auth-native").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("recall/plugin-sdk/command-auth-native").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("recall/plugin-sdk/command-auth-native").resolveCommandArgMenu;
