...
vi.mock("recall/plugin-sdk/system-event-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("recall/plugin-sdk/system-event-runtime")>();
  return {
    ...actual,
...
vi.mock("recall/plugin-sdk/heartbeat-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("recall/plugin-sdk/heartbeat-runtime")>();
  return {
    ...actual,
...
vi.mock("recall/plugin-sdk/approval-gateway-runtime", () => ({
...
describe("registerSlackInteractionEvents", () => {
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "recall:verify" }],
            },
          ],
        },
      },
  ...
  it("registers a matcher that accepts plugin action ids beyond the Recall prefix", () => {
    const { ctx, getActionMatcher } = createContext();
    registerSlackInteractionEvents({ ctx: ctx as never });

    const matcher = getActionMatcher();
    expect(matcher.test("recall:verify")).toBe(true);
  ...
  it("treats Slack reply buttons as plain interaction events instead of plugin dispatch", async () => {
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "recall:reply_button" }],
            },
          ],
        },
      },
    ...
    const eventText = mockCallArg(enqueueSystemEventMock, 0, "enqueueSystemEvent");
    expect(eventText).toContain('"actionId":"recall:reply_button"');
    expectRecordFields(
      requireRecord(
      ...
      {
        contextKey: "slack:interaction:C1:100.200:recall:reply_button",
        deliveryContext: {
          accountId: "default",
          channel: "slack",
          threadId: "100.100",
  ...
  it("drops modal lifecycle payloads when mismatch guard triggers", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "recall:deploy_form",
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "recall:multi" }],
            },
          ],
        },
      },
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "recall:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "recall:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "recall:datetime" }],
            },
          ],
        },
      },
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    expectRecordFields(payload as unknown as Record<string, unknown>, {
      ...
      actionId: "view:recall:deploy_form",
      callbackId: "recall:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("dispatches plugin-owned modal submissions with full view state before compacting events", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V777",
          callback_id: "recall:contract_confirm_hearing",
          private_metadata: JSON.stringify({
            channelId: "D777",
            channelType: "im",
            userId: "U777",
    ...
    expectRecordFields(requireRecord(dispatchCall, "dispatch call"), {
      ...
      dedupeId: "view_submission:recall:contract_confirm_hearing:V777:U777",
    });
    ...
    expectRecordFields(interaction, {
      ...
      namespace: "dean.contract",
      payload: "confirm_hearing",
      callbackId: "recall:contract_confirm_hearing",
      viewId: "V777",
  ...
  it("dispatches callback-id-only plugin modal submissions without agent routing metadata", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V778",
          callback_id: "recall:dean.contract:confirm_hearing",
          state: {
            values: {
              contract: {
    ...
    expectRecordFields(requireRecord(dispatchCall, "dispatch call"), {
      channel: "slack",
      data: "dean.contract:confirm_hearing",
      dedupeId: "view_submission:recall:dean.contract:confirm_hearing:V778:U777",
    });
    ...
    expectRecordFields(requireRecord(registrationCtx.interaction, "registration interaction"), {
      ...
      namespace: "dean.contract",
      payload: "confirm_hearing",
      callbackId: "recall:dean.contract:confirm_hearing",
      viewId: "V778",
    });
    expect(enqueueSystemEventMock).not.toHaveBeenCalled();
  });

  it("dispatches metadata-routed plugin modal submissions with non-recall callback ids", async () => {
    enqueueSystemEventMock.mockClear();
    dispatchPluginInteractiveHandlerMock.mockResolvedValueOnce({
      matched: true,
      handled: true,
  ...
  it("keeps no-channel modal events open when allowFrom is unset", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V444",
          callback_id: "recall:routing_form",
  ...
  it("captures modal input labels and picker values across block types", async () => {
            ...
            values: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@recall.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://docs.recall.ai",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expectRecordFields(inputByActionId(inputs, "email_input"), {
      inputKind: "email",
      inputEmail: "team@recall.ai",
    });
    expectRecordFields(inputByActionId(inputs, "url_input"), {
      inputKind: "url",
      inputUrl: "https://docs.recall.ai/",
    });
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "recall:long_richtext",
