...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<SteelEngineConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<SteelEngineConfig["channels"]>["slack"]>>,
): SteelEngineConfig {
  return {
    channels: {
      slack: {
