...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<RecallConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<RecallConfig["channels"]>["slack"]>>,
): RecallConfig {
  return {
    channels: {
      slack: {
