...
import { buildApprovalPresentationFromActionDescriptors } from "steelengine/plugin-sdk/approval-reply-runtime";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<SteelEngineConfig["channels"]>["slack"]>["execApprovals"]
>;
