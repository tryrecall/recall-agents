...
import { normalizeSecretInputString, type SecretInput } from "steelengine/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: SteelEngineConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: SteelEngineConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: SteelEngineConfig): string {
