...
function getNostrConfig(cfg: SteelEngineConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: SteelEngineConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: SteelEngineConfig): string {
