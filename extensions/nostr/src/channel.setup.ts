...
function getNostrConfig(cfg: RecallConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: RecallConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: RecallConfig): string {
