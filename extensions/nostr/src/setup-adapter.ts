...
import { patchTopLevelChannelConfigSection, splitSetupEntries } from "steelengine/plugin-sdk/setup";
...
export function createNostrSetupAdapter(params: {
  resolveAccountId: (cfg: SteelEngineConfig, accountId?: string | null) => string;
