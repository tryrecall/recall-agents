// Nostr plugin entrypoint registers its SteelEngine integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "steelengine/plugin-sdk/channel-entry-contract";
import type { SteelEngineConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as SteelEngineConfig;
