...
import { stringEnum } from "recall/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, RecallPluginApi, RecallPluginToolContext } from "../api.js";
...
function buildArtifactContext(
  context: RecallPluginToolContext | undefined,
