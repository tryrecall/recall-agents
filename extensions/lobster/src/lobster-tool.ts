...
type BoundTaskFlow = ReturnType<
  NonNullable<SteelEnginePluginApi["runtime"]>["tasks"]["managedFlows"]["bindSession"]
>;
...
export function createLobsterTool(api: SteelEnginePluginApi, options?: LobsterToolOptions) {
