...
import { createConditionalWarningCollector } from "steelengine/plugin-sdk/channel-policy";
...
const resolveSmsDmPolicy = createScopedDmSecurityResolver<ResolvedSmsAccount>({
  ...
  approveHint: "steelengine pairing approve sms <code>",
...
export const smsPlugin: ChannelPlugin<ResolvedSmsAccount, SmsProbe> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      idLabel: "phoneNumber",
      message: "SteelEngine: your SMS access has been approved.",
