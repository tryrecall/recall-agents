...
1. Download the runtime for your OS (extracts into `~/.recall/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.recall/tools/sherpa-onnx-tts/models`)

Update `~/.recall/recall.json`:
