---
name: healthcheck
description: "Audit/harden Recall hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Recall host healthcheck
...
- Never claim Recall manages OS firewall, SSH, or updates.
...
- Recall gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `recall security audit --deep`.
