---
name: healthcheck
description: "Audit/harden SteelEngine hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# SteelEngine host healthcheck
...
- Never claim SteelEngine manages OS firewall, SSH, or updates.
...
- SteelEngine gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `steelengine security audit --deep`.
