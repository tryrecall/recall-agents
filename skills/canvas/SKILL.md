---
name: canvas
description: "Present HTML on connected Recall node canvases, navigate/eval/snapshot, and debug canvas host URLs."
metadata: { "recall": { "emoji": "🖼️" } }
---
...
Active config: `$RECALL_CONFIG_PATH` or `~/.tryrecall/recall-agents.json`.
