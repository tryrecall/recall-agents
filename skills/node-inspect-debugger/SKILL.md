...
metadata: { "steelengine": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- SteelEngine CLI path: `node --inspect-brk steelengine.mjs ...`
- SteelEngine test path: `STEELENGINE_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
