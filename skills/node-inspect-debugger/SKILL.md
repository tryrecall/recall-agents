...
metadata: { "recall": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- Recall CLI path: `node --inspect-brk recall.mjs ...`
- Recall test path: `RECALL_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
