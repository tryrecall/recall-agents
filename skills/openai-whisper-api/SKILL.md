...
Set `OPENAI_API_KEY`, or configure it in the active SteelEngine config file (`$STEELENGINE_CONFIG_PATH`, default `~/.steelengine/steelengine.json`). Optionally set `OPENAI_BASE_URL`:
