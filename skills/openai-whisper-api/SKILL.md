...
Set `OPENAI_API_KEY`, or configure it in the active Recall config file (`$RECALL_CONFIG_PATH`, default `~/.tryrecall/recall-agents.json`). Optionally set `OPENAI_BASE_URL`:
